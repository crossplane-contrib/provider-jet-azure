...
package dnszonevirtualnetworklink
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-jet-azure/apis/private/v1alpha1"
)

// Setup adds a controller that reconciles DnsZoneVirtualNetworkLink managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	name := managed.ControllerName(v1alpha1.DnsZoneVirtualNetworkLink_GroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.DnsZoneVirtualNetworkLink_GroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.DnsZoneVirtualNetworkLink{}).
		Complete(r)
}
