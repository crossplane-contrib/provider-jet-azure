...
import (
	...
	v1alpha1 "github.com/ulucinar/provider-tf-azure/apis/ip/v1alpha1"
...
func Setup(mgr ctrl.Manager, l logging.Logger, _ workqueue.RateLimiter) error {
	return terraform.SetupController(mgr, l, &v1alpha1.IpGroup{}, v1alpha1.IpGroupGroupVersionKind, clients.ProviderConfigBuilder)
}
