...
package databaseextendedauditingpolicy
...
// Setup adds a controller that reconciles DatabaseExtendedAuditingPolicy managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	name := managed.ControllerName(v1alpha1.DatabaseExtendedAuditingPolicyGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.DatabaseExtendedAuditingPolicyGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.DatabaseExtendedAuditingPolicy{}).
		Complete(r)
}
