...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-azure/apis/netapp/v1alpha1"
)

// Setup adds a controller that reconciles NetappSnapshot managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, concurrency int) error {
	name := managed.ControllerName(v1alpha1.NetappSnapshotGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.NetappSnapshotGroupVersionKind),
