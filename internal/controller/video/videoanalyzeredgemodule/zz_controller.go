...
func Setup(mgr ctrl.Manager, l logging.Logger, _ workqueue.RateLimiter) error {
	return terraform.SetupController(mgr, l, &v1alpha1.VideoAnalyzerEdgeModule{}, v1alpha1.VideoAnalyzerEdgeModuleGroupVersionKind, clients.ProviderConfigBuilder)
}
