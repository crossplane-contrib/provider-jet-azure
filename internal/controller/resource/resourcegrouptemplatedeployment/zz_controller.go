...
func Setup(mgr ctrl.Manager, l logging.Logger, _ workqueue.RateLimiter) error {
	return terraform.SetupController(mgr, l, &v1alpha1.ResourceGroupTemplateDeployment{}, v1alpha1.ResourceGroupTemplateDeploymentGroupVersionKind, clients.ProviderConfigBuilder)
}
