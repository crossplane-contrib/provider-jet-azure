...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-azure/apis/blueprint/v1alpha1"
)

// Setup adds a controller that reconciles BlueprintAssignment managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, concurrency int) error {
	name := managed.ControllerName(v1alpha1.BlueprintAssignmentGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.BlueprintAssignmentGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.BlueprintAssignment{}).
		Complete(r)
}
