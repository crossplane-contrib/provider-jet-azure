...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-azure/apis/mariadb/v1alpha1"
)

// Setup adds a controller that reconciles MariadbVirtualNetworkRule managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, concurrency int) error {
	name := managed.ControllerName(v1alpha1.MariadbVirtualNetworkRuleGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.MariadbVirtualNetworkRuleGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.MariadbVirtualNetworkRule{}).
		Complete(r)
}
