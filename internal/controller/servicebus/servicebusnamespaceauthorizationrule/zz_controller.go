...
// Setup adds a controller that reconciles ServicebusNamespaceAuthorizationRule managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, concurrency int) error {
	name := managed.ControllerName(v1alpha1.ServicebusNamespaceAuthorizationRuleGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.ServicebusNamespaceAuthorizationRuleGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.ServicebusNamespaceAuthorizationRule{}).
		Complete(r)
}
