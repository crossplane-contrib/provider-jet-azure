...
func Setup(mgr ctrl.Manager, l logging.Logger, _ workqueue.RateLimiter) error {
	return terraform.SetupController(mgr, l, &v1alpha1.VirtualMachineDataDiskAttachment{}, v1alpha1.VirtualMachineDataDiskAttachmentGroupVersionKind, clients.ProviderConfigBuilder)
}
