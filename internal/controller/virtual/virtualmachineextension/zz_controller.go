...
func Setup(mgr ctrl.Manager, l logging.Logger, _ workqueue.RateLimiter) error {
	return terraform.SetupController(mgr, l, &v1alpha1.VirtualMachineExtension{}, v1alpha1.VirtualMachineExtensionGroupVersionKind, clients.ProviderConfigBuilder)
}
