...
import (
	...
	v1alpha1 "github.com/ulucinar/provider-tf-azure/apis/image/v1alpha1"
...
func Setup(mgr ctrl.Manager, l logging.Logger, _ workqueue.RateLimiter) error {
	return terraform.SetupController(mgr, l, &v1alpha1.Image{}, v1alpha1.ImageGroupVersionKind, clients.ProviderConfigBuilder)
}
