...
// Setup adds a controller that reconciles KustoIothubDataConnection managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter) error {
	name := managed.ControllerName(v1alpha1.KustoIothubDataConnectionGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.KustoIothubDataConnectionGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.KustoIothubDataConnection{}).
		Complete(r)
}
