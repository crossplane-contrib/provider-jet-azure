...
func Setup(mgr ctrl.Manager, l logging.Logger, _ workqueue.RateLimiter) error {
	return terraform.SetupController(mgr, l, &v1alpha1.KustoClusterCustomerManagedKey{}, v1alpha1.KustoClusterCustomerManagedKeyGroupVersionKind, clients.ProviderConfigBuilder)
}
