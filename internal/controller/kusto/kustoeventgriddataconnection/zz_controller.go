...
// Setup adds a controller that reconciles KustoEventgridDataConnection managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter) error {
	name := managed.ControllerName(v1alpha1.KustoEventgridDataConnectionGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.KustoEventgridDataConnectionGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.KustoEventgridDataConnection{}).
		Complete(r)
}
