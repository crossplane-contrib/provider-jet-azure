...
// Setup adds a controller that reconciles StreamAnalyticsOutputBlob managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, concurrency int) error {
	name := managed.ControllerName(v1alpha1.StreamAnalyticsOutputBlobGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.StreamAnalyticsOutputBlobGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.StreamAnalyticsOutputBlob{}).
		Complete(r)
}
