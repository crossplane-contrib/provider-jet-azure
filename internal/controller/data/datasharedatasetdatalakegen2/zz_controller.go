...
// Setup adds a controller that reconciles DataShareDatasetDataLakeGen2 managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, concurrency int) error {
	name := managed.ControllerName(v1alpha1.DataShareDatasetDataLakeGen2GroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.DataShareDatasetDataLakeGen2GroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.DataShareDatasetDataLakeGen2{}).
		Complete(r)
}
