...
func SetResourceConfigurations() {
	...
	config.Store.SetForResource("azurerm_storage_share", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_data_lake_gen2_path", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_object_replication", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_sync_cloud_endpoint", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_data_lake_gen2_filesystem", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_share_file", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_management_policy", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_share_directory", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_account_customer_managed_key", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_blob_inventory_policy", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_sync", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_table_entity", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_queue", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_encryption_scope", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_account_network_rules", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
	...
	config.Store.SetForResource("azurerm_storage_table", config.Resource{
		ExternalName: config.ExternalName{
			DisableNameInitializer: true,
		},
		References: config.References{
