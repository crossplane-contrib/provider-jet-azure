...
var (
	ApplicationDefinitionKind             = "ApplicationDefinition"
	ApplicationDefinitionGroupKind        = schema.GroupKind{Group: Group, Kind: ApplicationDefinitionKind}.String()
	ApplicationDefinitionKindAPIVersion   = ApplicationDefinitionKind + "." + GroupVersion.String()
	ApplicationDefinitionGroupVersionKind = GroupVersion.WithKind(ApplicationDefinitionKind)
)
