...
// GetTerraformResourceIDField returns Terraform identifier field for this ApplicationDefinition
func (tr *ApplicationDefinition) GetTerraformResourceIDField() string {
	return "id"
}
