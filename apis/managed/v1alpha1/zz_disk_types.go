...
var (
	DiskKind             = "Disk"
	DiskGroupKind        = schema.GroupKind{Group: Group, Kind: DiskKind}.String()
	DiskKindAPIVersion   = DiskKind + "." + GroupVersion.String()
	DiskGroupVersionKind = GroupVersion.WithKind(DiskKind)
)
