...
// GetTerraformResourceIdField returns Terraform identifier field for this ManagedApplication
func (tr *ManagedApplication) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ManagedApplication
func (tr *ManagedApplication) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ManagedApplication
func (tr *ManagedApplication) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ManagedApplication
func (tr *ManagedApplication) GetParameters() ([]byte, error) {
...
// LateInitialize this ManagedApplication using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagedApplication) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ManagedApplicationParameters{}
