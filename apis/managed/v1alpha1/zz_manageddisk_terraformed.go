...
// GetTerraformResourceIdField returns Terraform identifier field for this ManagedDisk
func (tr *ManagedDisk) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ManagedDisk
func (tr *ManagedDisk) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ManagedDisk
func (tr *ManagedDisk) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ManagedDisk
func (tr *ManagedDisk) GetParameters() ([]byte, error) {
...
func (tr *ManagedDisk) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ManagedDiskParameters{}
