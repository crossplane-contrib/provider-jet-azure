...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServiceEnvironment
func (tr *AppServiceEnvironment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServiceEnvironment
func (tr *AppServiceEnvironment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServiceEnvironment
func (tr *AppServiceEnvironment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServiceEnvironment
func (tr *AppServiceEnvironment) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this AppServiceEnvironment
func (tr *AppServiceEnvironment) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this AppServiceEnvironment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AppServiceEnvironment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceEnvironmentParameters{}
