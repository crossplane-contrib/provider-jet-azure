...
var (
	ServiceHybridConnectionKind             = "ServiceHybridConnection"
	ServiceHybridConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceHybridConnectionKind}.String()
	ServiceHybridConnectionKindAPIVersion   = ServiceHybridConnectionKind + "." + GroupVersion.String()
	ServiceHybridConnectionGroupVersionKind = GroupVersion.WithKind(ServiceHybridConnectionKind)
)
