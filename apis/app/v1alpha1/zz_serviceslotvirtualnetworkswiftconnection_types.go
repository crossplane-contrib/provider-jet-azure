...
var (
	ServiceSlotVirtualNetworkSwiftConnectionKind             = "ServiceSlotVirtualNetworkSwiftConnection"
	ServiceSlotVirtualNetworkSwiftConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceSlotVirtualNetworkSwiftConnectionKind}.String()
	ServiceSlotVirtualNetworkSwiftConnectionKindAPIVersion   = ServiceSlotVirtualNetworkSwiftConnectionKind + "." + GroupVersion.String()
	ServiceSlotVirtualNetworkSwiftConnectionGroupVersionKind = GroupVersion.WithKind(ServiceSlotVirtualNetworkSwiftConnectionKind)
)
