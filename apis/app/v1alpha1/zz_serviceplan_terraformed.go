...
// GetTerraformResourceIDField returns Terraform identifier field for this ServicePlan
func (tr *ServicePlan) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *ServicePlan) GetObservation() (map[string]interface{}, error) {
...
func (tr *ServicePlan) SetObservation(obs map[string]interface{}) error {
...
func (tr *ServicePlan) GetParameters() (map[string]interface{}, error) {
...
func (tr *ServicePlan) SetParameters(params map[string]interface{}) error {
