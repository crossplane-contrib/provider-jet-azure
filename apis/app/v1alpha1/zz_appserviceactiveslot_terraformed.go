...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServiceActiveSlot
func (tr *AppServiceActiveSlot) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServiceActiveSlot
func (tr *AppServiceActiveSlot) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServiceActiveSlot
func (tr *AppServiceActiveSlot) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServiceActiveSlot
func (tr *AppServiceActiveSlot) GetParameters() ([]byte, error) {
...
func (tr *AppServiceActiveSlot) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceActiveSlotParameters{}
