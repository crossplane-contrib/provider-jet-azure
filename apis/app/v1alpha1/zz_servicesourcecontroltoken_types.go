...
var (
	ServiceSourceControlTokenKind             = "ServiceSourceControlToken"
	ServiceSourceControlTokenGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceSourceControlTokenKind}.String()
	ServiceSourceControlTokenKindAPIVersion   = ServiceSourceControlTokenKind + "." + GroupVersion.String()
	ServiceSourceControlTokenGroupVersionKind = GroupVersion.WithKind(ServiceSourceControlTokenKind)
)
