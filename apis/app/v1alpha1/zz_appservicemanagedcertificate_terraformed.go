...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServiceManagedCertificate
func (tr *AppServiceManagedCertificate) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServiceManagedCertificate
func (tr *AppServiceManagedCertificate) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServiceManagedCertificate
func (tr *AppServiceManagedCertificate) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServiceManagedCertificate
func (tr *AppServiceManagedCertificate) GetParameters() ([]byte, error) {
...
func (tr *AppServiceManagedCertificate) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceManagedCertificateParameters{}
