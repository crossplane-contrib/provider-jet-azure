...
var (
	ServiceManagedCertificateKind             = "ServiceManagedCertificate"
	ServiceManagedCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceManagedCertificateKind}.String()
	ServiceManagedCertificateKindAPIVersion   = ServiceManagedCertificateKind + "." + GroupVersion.String()
	ServiceManagedCertificateGroupVersionKind = GroupVersion.WithKind(ServiceManagedCertificateKind)
)
