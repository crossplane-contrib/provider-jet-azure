...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServiceHybridConnection
func (tr *AppServiceHybridConnection) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServiceHybridConnection
func (tr *AppServiceHybridConnection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServiceHybridConnection
func (tr *AppServiceHybridConnection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServiceHybridConnection
func (tr *AppServiceHybridConnection) GetParameters() ([]byte, error) {
...
func (tr *AppServiceHybridConnection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceHybridConnectionParameters{}
