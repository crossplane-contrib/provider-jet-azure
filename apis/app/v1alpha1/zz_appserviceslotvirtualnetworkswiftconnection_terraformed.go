...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServiceSlotVirtualNetworkSwiftConnection
func (tr *AppServiceSlotVirtualNetworkSwiftConnection) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServiceSlotVirtualNetworkSwiftConnection
func (tr *AppServiceSlotVirtualNetworkSwiftConnection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServiceSlotVirtualNetworkSwiftConnection
func (tr *AppServiceSlotVirtualNetworkSwiftConnection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServiceSlotVirtualNetworkSwiftConnection
func (tr *AppServiceSlotVirtualNetworkSwiftConnection) GetParameters() ([]byte, error) {
...
func (tr *AppServiceSlotVirtualNetworkSwiftConnection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceSlotVirtualNetworkSwiftConnectionParameters{}
