...
var (
	ServiceEnvironmentV3Kind             = "ServiceEnvironmentV3"
	ServiceEnvironmentV3GroupKind        = schema.GroupKind{Group: Group, Kind: ServiceEnvironmentV3Kind}.String()
	ServiceEnvironmentV3KindAPIVersion   = ServiceEnvironmentV3Kind + "." + GroupVersion.String()
	ServiceEnvironmentV3GroupVersionKind = GroupVersion.WithKind(ServiceEnvironmentV3Kind)
)
