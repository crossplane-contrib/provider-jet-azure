...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServiceCertificateOrder
func (tr *AppServiceCertificateOrder) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServiceCertificateOrder
func (tr *AppServiceCertificateOrder) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServiceCertificateOrder
func (tr *AppServiceCertificateOrder) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServiceCertificateOrder
func (tr *AppServiceCertificateOrder) GetParameters() ([]byte, error) {
...
func (tr *AppServiceCertificateOrder) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceCertificateOrderParameters{}
