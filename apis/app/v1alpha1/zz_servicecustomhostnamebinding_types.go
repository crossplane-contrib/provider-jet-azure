...
var (
	ServiceCustomHostnameBindingKind             = "ServiceCustomHostnameBinding"
	ServiceCustomHostnameBindingGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceCustomHostnameBindingKind}.String()
	ServiceCustomHostnameBindingKindAPIVersion   = ServiceCustomHostnameBindingKind + "." + GroupVersion.String()
	ServiceCustomHostnameBindingGroupVersionKind = GroupVersion.WithKind(ServiceCustomHostnameBindingKind)
)
