...
var (
	ServiceVirtualNetworkSwiftConnectionKind             = "ServiceVirtualNetworkSwiftConnection"
	ServiceVirtualNetworkSwiftConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceVirtualNetworkSwiftConnectionKind}.String()
	ServiceVirtualNetworkSwiftConnectionKindAPIVersion   = ServiceVirtualNetworkSwiftConnectionKind + "." + GroupVersion.String()
	ServiceVirtualNetworkSwiftConnectionGroupVersionKind = GroupVersion.WithKind(ServiceVirtualNetworkSwiftConnectionKind)
)
