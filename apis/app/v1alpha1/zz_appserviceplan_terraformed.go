...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServicePlan
func (tr *AppServicePlan) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServicePlan
func (tr *AppServicePlan) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServicePlan
func (tr *AppServicePlan) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServicePlan
func (tr *AppServicePlan) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this AppServicePlan
func (tr *AppServicePlan) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this AppServicePlan using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AppServicePlan) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServicePlanParameters{}
