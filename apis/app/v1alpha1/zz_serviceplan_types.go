...
var (
	...
	ServicePlanGroupKind        = schema.GroupKind{Group: Group, Kind: ServicePlanKind}.String()
	ServicePlanKindAPIVersion   = ServicePlanKind + "." + GroupVersion.String()
	ServicePlanGroupVersionKind = GroupVersion.WithKind(ServicePlanKind)
)
