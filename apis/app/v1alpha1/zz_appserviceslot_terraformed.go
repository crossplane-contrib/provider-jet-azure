...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServiceSlot
func (tr *AppServiceSlot) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServiceSlot
func (tr *AppServiceSlot) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServiceSlot
func (tr *AppServiceSlot) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServiceSlot
func (tr *AppServiceSlot) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this AppServiceSlot
func (tr *AppServiceSlot) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this AppServiceSlot using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AppServiceSlot) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceSlotParameters{}
