...
var (
	ServiceSlotKind             = "ServiceSlot"
	ServiceSlotGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceSlotKind}.String()
	ServiceSlotKindAPIVersion   = ServiceSlotKind + "." + GroupVersion.String()
	ServiceSlotGroupVersionKind = GroupVersion.WithKind(ServiceSlotKind)
)
