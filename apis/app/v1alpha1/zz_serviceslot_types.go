...
type ServiceSlotAuthSettingsParameters struct {
...
type ServiceSlotConnectionStringObservation struct {
}

type ServiceSlotConnectionStringParameters struct {
...
type ServiceSlotIdentityObservation struct {
	PrincipalID *string `json:"principalId,omitempty" tf:"principal_id,omitempty"`

	TenantID *string `json:"tenantId,omitempty" tf:"tenant_id,omitempty"`
}

type ServiceSlotIdentityParameters struct {
...
type ServiceSlotLogsObservation struct {
}

type ServiceSlotLogsParameters struct {
...
type ServiceSlotObservation struct {
	DefaultSiteHostname *string `json:"defaultSiteHostname,omitempty" tf:"default_site_hostname,omitempty"`

	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	SiteCredential []ServiceSlotSiteCredentialObservation `json:"siteCredential,omitempty" tf:"site_credential,omitempty"`
}

type ServiceSlotParameters struct {
	...
	// +kubebuilder:validation:Optional
	AuthSettings []ServiceSlotAuthSettingsParameters `json:"authSettings,omitempty" tf:"auth_settings,omitempty"`

	// +kubebuilder:validation:Optional
	ClientAffinityEnabled *bool `json:"clientAffinityEnabled,omitempty" tf:"client_affinity_enabled,omitempty"`

	// +kubebuilder:validation:Optional
	ConnectionString []ServiceSlotConnectionStringParameters `json:"connectionString,omitempty" tf:"connection_string,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Identity []ServiceSlotIdentityParameters `json:"identity,omitempty" tf:"identity,omitempty"`

	// +kubebuilder:validation:Required
	Location *string `json:"location" tf:"location,omitempty"`

	// +kubebuilder:validation:Optional
	Logs []ServiceSlotLogsParameters `json:"logs,omitempty" tf:"logs,omitempty"`
	...
	// +kubebuilder:validation:Optional
	SiteConfig []ServiceSlotSiteConfigParameters `json:"siteConfig,omitempty" tf:"site_config,omitempty"`

	// +kubebuilder:validation:Optional
	Tags map[string]*string `json:"tags,omitempty" tf:"tags,omitempty"`
}

type ServiceSlotSiteConfigObservation struct {
}

type ServiceSlotSiteConfigParameters struct {
...
type ServiceSlotSiteCredentialObservation struct {
	Username *string `json:"username,omitempty" tf:"username,omitempty"`
}

type ServiceSlotSiteCredentialParameters struct {
}
...
// ServiceSlotSpec defines the desired state of ServiceSlot
type ServiceSlotSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ServiceSlotParameters `json:"forProvider"`
}

// ServiceSlotStatus defines the observed state of ServiceSlot.
type ServiceSlotStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ServiceSlotObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// ServiceSlot is the Schema for the ServiceSlots API
...
type ServiceSlot struct {
	...
	Spec              ServiceSlotSpec   `json:"spec"`
	Status            ServiceSlotStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ServiceSlotList contains a list of ServiceSlots
type ServiceSlotList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ServiceSlot `json:"items"`
}

// Repository type metadata.
var (
	ServiceSlot_Kind             = "ServiceSlot"
	ServiceSlot_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ServiceSlot_Kind}.String()
	ServiceSlot_KindAPIVersion   = ServiceSlot_Kind + "." + CRDGroupVersion.String()
	ServiceSlot_GroupVersionKind = CRDGroupVersion.WithKind(ServiceSlot_Kind)
)

func init() {
	SchemeBuilder.Register(&ServiceSlot{}, &ServiceSlotList{})
}
