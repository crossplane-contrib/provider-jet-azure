...
var (
	ConfigurationKeyKind             = "ConfigurationKey"
	ConfigurationKeyGroupKind        = schema.GroupKind{Group: Group, Kind: ConfigurationKeyKind}.String()
	ConfigurationKeyKindAPIVersion   = ConfigurationKeyKind + "." + GroupVersion.String()
	ConfigurationKeyGroupVersionKind = GroupVersion.WithKind(ConfigurationKeyKind)
)
