...
// GetTerraformResourceIDField returns Terraform identifier field for this ServiceEnvironment
func (tr *ServiceEnvironment) GetTerraformResourceIDField() string {
	return "id"
}
