...
// GetTerraformResourceIdField returns Terraform identifier field for this AppServiceCertificateBinding
func (tr *AppServiceCertificateBinding) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppServiceCertificateBinding
func (tr *AppServiceCertificateBinding) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppServiceCertificateBinding
func (tr *AppServiceCertificateBinding) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppServiceCertificateBinding
func (tr *AppServiceCertificateBinding) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this AppServiceCertificateBinding
func (tr *AppServiceCertificateBinding) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this AppServiceCertificateBinding using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AppServiceCertificateBinding) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceCertificateBindingParameters{}
