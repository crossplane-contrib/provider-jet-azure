...
// GetTerraformResourceIdField returns Terraform identifier field for this AppService
func (tr *AppService) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AppService
func (tr *AppService) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AppService
func (tr *AppService) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AppService
func (tr *AppService) GetParameters() ([]byte, error) {
...
func (tr *AppService) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AppServiceParameters{}
