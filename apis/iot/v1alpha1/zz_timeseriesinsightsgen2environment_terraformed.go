...
// GetTerraformResourceIDField returns Terraform identifier field for this TimeSeriesInsightsGen2Environment
func (tr *TimeSeriesInsightsGen2Environment) GetTerraformResourceIDField() string {
	return "id"
}
