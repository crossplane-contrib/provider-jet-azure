...
// TimeSeriesInsightsAccessPolicy is the Schema for the TimeSeriesInsightsAccessPolicys API
...
var (
	TimeSeriesInsightsAccessPolicyKind             = "TimeSeriesInsightsAccessPolicy"
	TimeSeriesInsightsAccessPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TimeSeriesInsightsAccessPolicyKind}.String()
	TimeSeriesInsightsAccessPolicyKindAPIVersion   = TimeSeriesInsightsAccessPolicyKind + "." + GroupVersion.String()
	TimeSeriesInsightsAccessPolicyGroupVersionKind = GroupVersion.WithKind(TimeSeriesInsightsAccessPolicyKind)
)

func init() {
	SchemeBuilder.Register(&TimeSeriesInsightsAccessPolicy{}, &TimeSeriesInsightsAccessPolicyList{})
}
