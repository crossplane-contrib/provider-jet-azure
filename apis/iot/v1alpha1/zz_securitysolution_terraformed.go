...
// GetTerraformResourceIDField returns Terraform identifier field for this SecuritySolution
func (tr *SecuritySolution) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this SecuritySolution using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SecuritySolution) LateInitialize(attrs []byte) (bool, error) {
	params := &SecuritySolutionParameters{}
