...
// GetTerraformResourceIdField returns Terraform identifier field for this IotSecurityDeviceGroup
func (tr *IotSecurityDeviceGroup) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IotSecurityDeviceGroup
func (tr *IotSecurityDeviceGroup) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IotSecurityDeviceGroup
func (tr *IotSecurityDeviceGroup) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IotSecurityDeviceGroup
func (tr *IotSecurityDeviceGroup) GetParameters() ([]byte, error) {
...
func (tr *IotSecurityDeviceGroup) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IotSecurityDeviceGroupParameters{}
