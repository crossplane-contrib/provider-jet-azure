...
// SecurityDeviceGroup is the Schema for the SecurityDeviceGroups API
...
var (
	SecurityDeviceGroupKind             = "SecurityDeviceGroup"
	SecurityDeviceGroupGroupKind        = schema.GroupKind{Group: Group, Kind: SecurityDeviceGroupKind}.String()
	SecurityDeviceGroupKindAPIVersion   = SecurityDeviceGroupKind + "." + GroupVersion.String()
	SecurityDeviceGroupGroupVersionKind = GroupVersion.WithKind(SecurityDeviceGroupKind)
)

func init() {
	SchemeBuilder.Register(&SecurityDeviceGroup{}, &SecurityDeviceGroupList{})
}
