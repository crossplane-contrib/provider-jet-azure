...
// GetTerraformResourceIDField returns Terraform identifier field for this TimeSeriesInsightsReferenceDataSet
func (tr *TimeSeriesInsightsReferenceDataSet) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this TimeSeriesInsightsReferenceDataSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TimeSeriesInsightsReferenceDataSet) LateInitialize(attrs []byte) (bool, error) {
	params := &TimeSeriesInsightsReferenceDataSetParameters{}
