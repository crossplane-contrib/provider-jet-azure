...
var (
	TimeSeriesInsightsReferenceDataSetKind             = "TimeSeriesInsightsReferenceDataSet"
	TimeSeriesInsightsReferenceDataSetGroupKind        = schema.GroupKind{Group: Group, Kind: TimeSeriesInsightsReferenceDataSetKind}.String()
	TimeSeriesInsightsReferenceDataSetKindAPIVersion   = TimeSeriesInsightsReferenceDataSetKind + "." + GroupVersion.String()
	TimeSeriesInsightsReferenceDataSetGroupVersionKind = GroupVersion.WithKind(TimeSeriesInsightsReferenceDataSetKind)
)
