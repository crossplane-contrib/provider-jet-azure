...
// GetTerraformResourceIDField returns Terraform identifier field for this TimeSeriesInsightsEventSourceIothub
func (tr *TimeSeriesInsightsEventSourceIothub) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this TimeSeriesInsightsEventSourceIothub using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TimeSeriesInsightsEventSourceIothub) LateInitialize(attrs []byte) (bool, error) {
	params := &TimeSeriesInsightsEventSourceIothubParameters{}
