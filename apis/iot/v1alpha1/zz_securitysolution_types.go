...
var (
	SecuritySolutionKind             = "SecuritySolution"
	SecuritySolutionGroupKind        = schema.GroupKind{Group: Group, Kind: SecuritySolutionKind}.String()
	SecuritySolutionKindAPIVersion   = SecuritySolutionKind + "." + GroupVersion.String()
	SecuritySolutionGroupVersionKind = GroupVersion.WithKind(SecuritySolutionKind)
)
