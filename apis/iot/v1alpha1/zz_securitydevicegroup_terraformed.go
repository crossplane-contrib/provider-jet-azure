...
// GetTerraformResourceIDField returns Terraform identifier field for this SecurityDeviceGroup
func (tr *SecurityDeviceGroup) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this SecurityDeviceGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SecurityDeviceGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &SecurityDeviceGroupParameters{}
