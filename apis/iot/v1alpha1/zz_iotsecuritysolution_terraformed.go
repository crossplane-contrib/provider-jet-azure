...
// GetTerraformResourceIdField returns Terraform identifier field for this IotSecuritySolution
func (tr *IotSecuritySolution) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IotSecuritySolution
func (tr *IotSecuritySolution) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IotSecuritySolution
func (tr *IotSecuritySolution) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IotSecuritySolution
func (tr *IotSecuritySolution) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this IotSecuritySolution
func (tr *IotSecuritySolution) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this IotSecuritySolution using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IotSecuritySolution) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IotSecuritySolutionParameters{}
