...
var (
	TimeSeriesInsightsEventSourceIothubKind             = "TimeSeriesInsightsEventSourceIothub"
	TimeSeriesInsightsEventSourceIothubGroupKind        = schema.GroupKind{Group: Group, Kind: TimeSeriesInsightsEventSourceIothubKind}.String()
	TimeSeriesInsightsEventSourceIothubKindAPIVersion   = TimeSeriesInsightsEventSourceIothubKind + "." + GroupVersion.String()
	TimeSeriesInsightsEventSourceIothubGroupVersionKind = GroupVersion.WithKind(TimeSeriesInsightsEventSourceIothubKind)
)
