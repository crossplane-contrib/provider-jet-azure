...
// TimeSeriesInsightsGen2Environment is the Schema for the TimeSeriesInsightsGen2Environments API
...
var (
	TimeSeriesInsightsGen2EnvironmentKind             = "TimeSeriesInsightsGen2Environment"
	TimeSeriesInsightsGen2EnvironmentGroupKind        = schema.GroupKind{Group: Group, Kind: TimeSeriesInsightsGen2EnvironmentKind}.String()
	TimeSeriesInsightsGen2EnvironmentKindAPIVersion   = TimeSeriesInsightsGen2EnvironmentKind + "." + GroupVersion.String()
	TimeSeriesInsightsGen2EnvironmentGroupVersionKind = GroupVersion.WithKind(TimeSeriesInsightsGen2EnvironmentKind)
)

func init() {
	SchemeBuilder.Register(&TimeSeriesInsightsGen2Environment{}, &TimeSeriesInsightsGen2EnvironmentList{})
}
