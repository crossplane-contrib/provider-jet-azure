...
// GetTerraformResourceIDField returns Terraform identifier field for this TimeSeriesInsightsAccessPolicy
func (tr *TimeSeriesInsightsAccessPolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this TimeSeriesInsightsAccessPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TimeSeriesInsightsAccessPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &TimeSeriesInsightsAccessPolicyParameters{}
