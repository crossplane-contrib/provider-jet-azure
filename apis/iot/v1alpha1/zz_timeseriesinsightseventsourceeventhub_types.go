...
// TimeSeriesInsightsEventSourceEventHub is the Schema for the TimeSeriesInsightsEventSourceEventHubs API
...
func init() {
	SchemeBuilder.Register(&TimeSeriesInsightsEventSourceEventHub{}, &TimeSeriesInsightsEventSourceEventHubList{})
}
