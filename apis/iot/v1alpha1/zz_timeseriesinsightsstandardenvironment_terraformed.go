...
// GetID returns ID of underlying Terraform resource of this TimeSeriesInsightsStandardEnvironment
func (tr *TimeSeriesInsightsStandardEnvironment) GetID() string {
