...
// GetTerraformResourceIDField returns Terraform identifier field for this TimeSeriesInsightsStandardEnvironment
func (tr *TimeSeriesInsightsStandardEnvironment) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this TimeSeriesInsightsStandardEnvironment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TimeSeriesInsightsStandardEnvironment) LateInitialize(attrs []byte) (bool, error) {
	params := &TimeSeriesInsightsStandardEnvironmentParameters{}
