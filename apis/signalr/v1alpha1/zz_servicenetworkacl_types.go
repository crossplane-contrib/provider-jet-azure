...
var (
	ServiceNetworkAclKind             = "ServiceNetworkAcl"
	ServiceNetworkAclGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceNetworkAclKind}.String()
	ServiceNetworkAclKindAPIVersion   = ServiceNetworkAclKind + "." + GroupVersion.String()
	ServiceNetworkAclGroupVersionKind = GroupVersion.WithKind(ServiceNetworkAclKind)
)
