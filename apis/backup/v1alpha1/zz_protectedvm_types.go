...
var (
	ProtectedVmKind             = "ProtectedVm"
	ProtectedVmGroupKind        = schema.GroupKind{Group: Group, Kind: ProtectedVmKind}.String()
	ProtectedVmKindAPIVersion   = ProtectedVmKind + "." + GroupVersion.String()
	ProtectedVmGroupVersionKind = GroupVersion.WithKind(ProtectedVmKind)
)
