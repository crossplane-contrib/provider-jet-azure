...
// GetTerraformResourceIdField returns Terraform identifier field for this BackupPolicyVm
func (tr *BackupPolicyVm) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BackupPolicyVm
func (tr *BackupPolicyVm) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BackupPolicyVm
func (tr *BackupPolicyVm) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BackupPolicyVm
func (tr *BackupPolicyVm) GetParameters() ([]byte, error) {
...
func (tr *BackupPolicyVm) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BackupPolicyVmParameters{}
