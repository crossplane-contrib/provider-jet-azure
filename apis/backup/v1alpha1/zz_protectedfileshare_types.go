...
var (
	ProtectedFileShareKind             = "ProtectedFileShare"
	ProtectedFileShareGroupKind        = schema.GroupKind{Group: Group, Kind: ProtectedFileShareKind}.String()
	ProtectedFileShareKindAPIVersion   = ProtectedFileShareKind + "." + GroupVersion.String()
	ProtectedFileShareGroupVersionKind = GroupVersion.WithKind(ProtectedFileShareKind)
)
