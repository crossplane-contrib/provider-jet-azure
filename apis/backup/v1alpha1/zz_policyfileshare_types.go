...
var (
	PolicyFileShareKind             = "PolicyFileShare"
	PolicyFileShareGroupKind        = schema.GroupKind{Group: Group, Kind: PolicyFileShareKind}.String()
	PolicyFileShareKindAPIVersion   = PolicyFileShareKind + "." + GroupVersion.String()
	PolicyFileShareGroupVersionKind = GroupVersion.WithKind(PolicyFileShareKind)
)
