...
// GetTerraformResourceIDField returns Terraform identifier field for this ContainerStorageAccount
func (tr *ContainerStorageAccount) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ContainerStorageAccount using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ContainerStorageAccount) LateInitialize(attrs []byte) (bool, error) {
	params := &ContainerStorageAccountParameters{}
