...
// GetTerraformResourceIDField returns Terraform identifier field for this ProtectedFileShare
func (tr *ProtectedFileShare) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ProtectedFileShare using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ProtectedFileShare) LateInitialize(attrs []byte) (bool, error) {
	params := &ProtectedFileShareParameters{}
