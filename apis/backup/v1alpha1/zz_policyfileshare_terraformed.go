...
// GetTerraformResourceIDField returns Terraform identifier field for this PolicyFileShare
func (tr *PolicyFileShare) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this PolicyFileShare using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PolicyFileShare) LateInitialize(attrs []byte) (bool, error) {
	params := &PolicyFileShareParameters{}
