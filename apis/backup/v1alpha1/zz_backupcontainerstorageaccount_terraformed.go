...
func (tr *BackupContainerStorageAccount) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BackupContainerStorageAccount
func (tr *BackupContainerStorageAccount) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BackupContainerStorageAccount
func (tr *BackupContainerStorageAccount) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this BackupContainerStorageAccount
func (tr *BackupContainerStorageAccount) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this BackupContainerStorageAccount using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BackupContainerStorageAccount) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BackupContainerStorageAccountParameters{}
