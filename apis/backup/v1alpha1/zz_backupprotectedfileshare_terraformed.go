...
// GetTerraformResourceIdField returns Terraform identifier field for this BackupProtectedFileShare
func (tr *BackupProtectedFileShare) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BackupProtectedFileShare
func (tr *BackupProtectedFileShare) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BackupProtectedFileShare
func (tr *BackupProtectedFileShare) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BackupProtectedFileShare
func (tr *BackupProtectedFileShare) GetParameters() ([]byte, error) {
...
func (tr *BackupProtectedFileShare) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BackupProtectedFileShareParameters{}
