...
// GetTerraformResourceIdField returns Terraform identifier field for this BackupPolicyFileShare
func (tr *BackupPolicyFileShare) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BackupPolicyFileShare
func (tr *BackupPolicyFileShare) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BackupPolicyFileShare
func (tr *BackupPolicyFileShare) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BackupPolicyFileShare
func (tr *BackupPolicyFileShare) GetParameters() ([]byte, error) {
...
func (tr *BackupPolicyFileShare) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BackupPolicyFileShareParameters{}
