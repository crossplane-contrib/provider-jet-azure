...
// GetTerraformResourceIDField returns Terraform identifier field for this ProtectedVm
func (tr *ProtectedVm) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ProtectedVm using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ProtectedVm) LateInitialize(attrs []byte) (bool, error) {
	params := &ProtectedVmParameters{}
