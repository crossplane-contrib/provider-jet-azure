...
// GetTerraformResourceIDField returns Terraform identifier field for this PolicyVm
func (tr *PolicyVm) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this PolicyVm using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PolicyVm) LateInitialize(attrs []byte) (bool, error) {
	params := &PolicyVmParameters{}
