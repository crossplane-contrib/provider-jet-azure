...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsDatasourceWindowsPerformanceCounter
func (tr *AnalyticsDatasourceWindowsPerformanceCounter) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsDatasourceWindowsPerformanceCounter using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsDatasourceWindowsPerformanceCounter) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsDatasourceWindowsPerformanceCounterParameters{}
