...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsLinkedService
func (tr *AnalyticsLinkedService) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsLinkedService using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsLinkedService) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsLinkedServiceParameters{}
