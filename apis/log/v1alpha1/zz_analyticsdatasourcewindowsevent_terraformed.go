...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsDatasourceWindowsEvent
func (tr *AnalyticsDatasourceWindowsEvent) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsDatasourceWindowsEvent using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsDatasourceWindowsEvent) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsDatasourceWindowsEventParameters{}
