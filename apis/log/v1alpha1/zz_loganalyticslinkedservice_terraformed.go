...
// GetTerraformResourceIdField returns Terraform identifier field for this LogAnalyticsLinkedService
func (tr *LogAnalyticsLinkedService) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LogAnalyticsLinkedService
func (tr *LogAnalyticsLinkedService) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LogAnalyticsLinkedService
func (tr *LogAnalyticsLinkedService) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LogAnalyticsLinkedService
func (tr *LogAnalyticsLinkedService) GetParameters() ([]byte, error) {
...
func (tr *LogAnalyticsLinkedService) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LogAnalyticsLinkedServiceParameters{}
