...
var (
	AnalyticsDatasourceWindowsEventKind             = "AnalyticsDatasourceWindowsEvent"
	AnalyticsDatasourceWindowsEventGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsDatasourceWindowsEventKind}.String()
	AnalyticsDatasourceWindowsEventKindAPIVersion   = AnalyticsDatasourceWindowsEventKind + "." + GroupVersion.String()
	AnalyticsDatasourceWindowsEventGroupVersionKind = GroupVersion.WithKind(AnalyticsDatasourceWindowsEventKind)
)
