...
func (tr *LogAnalyticsDatasourceWindowsPerformanceCounter) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LogAnalyticsDatasourceWindowsPerformanceCounterParameters{}
