...
var (
	AnalyticsClusterCustomerManagedKeyKind             = "AnalyticsClusterCustomerManagedKey"
	AnalyticsClusterCustomerManagedKeyGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsClusterCustomerManagedKeyKind}.String()
	AnalyticsClusterCustomerManagedKeyKindAPIVersion   = AnalyticsClusterCustomerManagedKeyKind + "." + GroupVersion.String()
	AnalyticsClusterCustomerManagedKeyGroupVersionKind = GroupVersion.WithKind(AnalyticsClusterCustomerManagedKeyKind)
)
