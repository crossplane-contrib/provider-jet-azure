...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsDataExportRule
func (tr *AnalyticsDataExportRule) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsDataExportRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsDataExportRule) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsDataExportRuleParameters{}
