...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsLinkedStorageAccount
func (tr *AnalyticsLinkedStorageAccount) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsLinkedStorageAccount using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsLinkedStorageAccount) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsLinkedStorageAccountParameters{}
