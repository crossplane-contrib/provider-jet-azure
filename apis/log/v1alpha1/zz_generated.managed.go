...
// GetCondition of this LogAnalyticsStorageInsights.
func (mg *LogAnalyticsStorageInsights) GetCondition(ct xpv1.ConditionType) xpv1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this LogAnalyticsStorageInsights.
func (mg *LogAnalyticsStorageInsights) GetDeletionPolicy() xpv1.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}

// GetProviderConfigReference of this LogAnalyticsStorageInsights.
func (mg *LogAnalyticsStorageInsights) GetProviderConfigReference() *xpv1.Reference {
	return mg.Spec.ProviderConfigReference
}

/*
GetProviderReference of this LogAnalyticsStorageInsights.
Deprecated: Use GetProviderConfigReference.
*/
func (mg *LogAnalyticsStorageInsights) GetProviderReference() *xpv1.Reference {
	return mg.Spec.ProviderReference
}

// GetWriteConnectionSecretToReference of this LogAnalyticsStorageInsights.
func (mg *LogAnalyticsStorageInsights) GetWriteConnectionSecretToReference() *xpv1.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}

// SetConditions of this LogAnalyticsStorageInsights.
func (mg *LogAnalyticsStorageInsights) SetConditions(c ...xpv1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this LogAnalyticsStorageInsights.
func (mg *LogAnalyticsStorageInsights) SetDeletionPolicy(r xpv1.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}

// SetProviderConfigReference of this LogAnalyticsStorageInsights.
func (mg *LogAnalyticsStorageInsights) SetProviderConfigReference(r *xpv1.Reference) {
	mg.Spec.ProviderConfigReference = r
}

/*
SetProviderReference of this LogAnalyticsStorageInsights.
Deprecated: Use SetProviderConfigReference.
*/
func (mg *LogAnalyticsStorageInsights) SetProviderReference(r *xpv1.Reference) {
	mg.Spec.ProviderReference = r
}

// SetWriteConnectionSecretToReference of this LogAnalyticsStorageInsights.
func (mg *LogAnalyticsStorageInsights) SetWriteConnectionSecretToReference(r *xpv1.SecretReference) {
	mg.Spec.WriteConnectionSecretToReference = r
}
