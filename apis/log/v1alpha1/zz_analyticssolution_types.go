...
var (
	AnalyticsSolutionKind             = "AnalyticsSolution"
	AnalyticsSolutionGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsSolutionKind}.String()
	AnalyticsSolutionKindAPIVersion   = AnalyticsSolutionKind + "." + GroupVersion.String()
	AnalyticsSolutionGroupVersionKind = GroupVersion.WithKind(AnalyticsSolutionKind)
)
