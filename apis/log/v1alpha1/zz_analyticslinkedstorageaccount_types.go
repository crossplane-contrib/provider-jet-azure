...
var (
	AnalyticsLinkedStorageAccountKind             = "AnalyticsLinkedStorageAccount"
	AnalyticsLinkedStorageAccountGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsLinkedStorageAccountKind}.String()
	AnalyticsLinkedStorageAccountKindAPIVersion   = AnalyticsLinkedStorageAccountKind + "." + GroupVersion.String()
	AnalyticsLinkedStorageAccountGroupVersionKind = GroupVersion.WithKind(AnalyticsLinkedStorageAccountKind)
)
