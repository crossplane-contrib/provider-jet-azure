...
// GetTerraformResourceIdField returns Terraform identifier field for this LogAnalyticsLinkedStorageAccount
func (tr *LogAnalyticsLinkedStorageAccount) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LogAnalyticsLinkedStorageAccount
func (tr *LogAnalyticsLinkedStorageAccount) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LogAnalyticsLinkedStorageAccount
func (tr *LogAnalyticsLinkedStorageAccount) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LogAnalyticsLinkedStorageAccount
func (tr *LogAnalyticsLinkedStorageAccount) GetParameters() ([]byte, error) {
...
func (tr *LogAnalyticsLinkedStorageAccount) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LogAnalyticsLinkedStorageAccountParameters{}
