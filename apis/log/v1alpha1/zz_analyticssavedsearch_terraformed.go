...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsSavedSearch
func (tr *AnalyticsSavedSearch) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsSavedSearch using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsSavedSearch) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsSavedSearchParameters{}
