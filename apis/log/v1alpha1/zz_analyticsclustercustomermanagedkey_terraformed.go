...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsClusterCustomerManagedKey
func (tr *AnalyticsClusterCustomerManagedKey) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsClusterCustomerManagedKey using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsClusterCustomerManagedKey) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsClusterCustomerManagedKeyParameters{}
