...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsSolution
func (tr *AnalyticsSolution) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsSolution using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsSolution) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsSolutionParameters{}
