...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsCluster
func (tr *AnalyticsCluster) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsCluster using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsCluster) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsClusterParameters{}
