...
var (
	AnalyticsLinkedServiceKind             = "AnalyticsLinkedService"
	AnalyticsLinkedServiceGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsLinkedServiceKind}.String()
	AnalyticsLinkedServiceKindAPIVersion   = AnalyticsLinkedServiceKind + "." + GroupVersion.String()
	AnalyticsLinkedServiceGroupVersionKind = GroupVersion.WithKind(AnalyticsLinkedServiceKind)
)
