...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubEndpointStorageContainer
func (tr *IothubEndpointStorageContainer) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubEndpointStorageContainer
func (tr *IothubEndpointStorageContainer) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubEndpointStorageContainer
func (tr *IothubEndpointStorageContainer) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubEndpointStorageContainer
func (tr *IothubEndpointStorageContainer) GetParameters() ([]byte, error) {
...
func (tr *IothubEndpointStorageContainer) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubEndpointStorageContainerParameters{}
