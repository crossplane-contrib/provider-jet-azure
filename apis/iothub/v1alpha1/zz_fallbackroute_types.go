...
type FallbackRouteSpec struct {
	...
	ForProvider     FallbackRouteParameters `json:"forProvider"`
}

// FallbackRouteStatus defines the observed state of FallbackRoute.
type FallbackRouteStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        FallbackRouteObservation `json:"atProvider,omitempty"`
}
...
var (
	FallbackRouteKind             = "FallbackRoute"
	FallbackRouteGroupKind        = schema.GroupKind{Group: Group, Kind: FallbackRouteKind}.String()
	FallbackRouteKindAPIVersion   = FallbackRouteKind + "." + GroupVersion.String()
	FallbackRouteGroupVersionKind = GroupVersion.WithKind(FallbackRouteKind)
)
