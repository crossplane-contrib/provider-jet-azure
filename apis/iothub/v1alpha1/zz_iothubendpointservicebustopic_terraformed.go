...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubEndpointServicebusTopic
func (tr *IothubEndpointServicebusTopic) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubEndpointServicebusTopic
func (tr *IothubEndpointServicebusTopic) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubEndpointServicebusTopic
func (tr *IothubEndpointServicebusTopic) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubEndpointServicebusTopic
func (tr *IothubEndpointServicebusTopic) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this IothubEndpointServicebusTopic
func (tr *IothubEndpointServicebusTopic) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this IothubEndpointServicebusTopic using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IothubEndpointServicebusTopic) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubEndpointServicebusTopicParameters{}
