...
var (
	SharedAccessPolicyKind             = "SharedAccessPolicy"
	SharedAccessPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: SharedAccessPolicyKind}.String()
	SharedAccessPolicyKindAPIVersion   = SharedAccessPolicyKind + "." + GroupVersion.String()
	SharedAccessPolicyGroupVersionKind = GroupVersion.WithKind(SharedAccessPolicyKind)
)
