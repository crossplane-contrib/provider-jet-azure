...
var (
	EndpointServicebusQueueKind             = "EndpointServicebusQueue"
	EndpointServicebusQueueGroupKind        = schema.GroupKind{Group: Group, Kind: EndpointServicebusQueueKind}.String()
	EndpointServicebusQueueKindAPIVersion   = EndpointServicebusQueueKind + "." + GroupVersion.String()
	EndpointServicebusQueueGroupVersionKind = GroupVersion.WithKind(EndpointServicebusQueueKind)
)
