...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubEnrichment
func (tr *IothubEnrichment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubEnrichment
func (tr *IothubEnrichment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubEnrichment
func (tr *IothubEnrichment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubEnrichment
func (tr *IothubEnrichment) GetParameters() ([]byte, error) {
...
func (tr *IothubEnrichment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubEnrichmentParameters{}
