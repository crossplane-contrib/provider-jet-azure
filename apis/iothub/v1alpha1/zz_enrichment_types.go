...
var (
	...
	EnrichmentGroupKind        = schema.GroupKind{Group: Group, Kind: EnrichmentKind}.String()
	EnrichmentKindAPIVersion   = EnrichmentKind + "." + GroupVersion.String()
	EnrichmentGroupVersionKind = GroupVersion.WithKind(EnrichmentKind)
)
