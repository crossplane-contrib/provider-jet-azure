...
// GetTerraformResourceIdField returns Terraform identifier field for this Iothub
func (tr *Iothub) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this Iothub
func (tr *Iothub) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this Iothub
func (tr *Iothub) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this Iothub
func (tr *Iothub) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this Iothub
func (tr *Iothub) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this Iothub using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Iothub) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubParameters{}
