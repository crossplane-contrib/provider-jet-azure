...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubEndpointEventhub
func (tr *IothubEndpointEventhub) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubEndpointEventhub
func (tr *IothubEndpointEventhub) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubEndpointEventhub
func (tr *IothubEndpointEventhub) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubEndpointEventhub
func (tr *IothubEndpointEventhub) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this IothubEndpointEventhub
func (tr *IothubEndpointEventhub) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this IothubEndpointEventhub using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IothubEndpointEventhub) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubEndpointEventhubParameters{}
