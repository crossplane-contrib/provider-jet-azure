...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubDpsCertificate
func (tr *IothubDpsCertificate) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubDpsCertificate
func (tr *IothubDpsCertificate) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubDpsCertificate
func (tr *IothubDpsCertificate) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubDpsCertificate
func (tr *IothubDpsCertificate) GetParameters() ([]byte, error) {
...
func (tr *IothubDpsCertificate) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubDpsCertificateParameters{}
