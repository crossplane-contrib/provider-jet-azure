...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubDps
func (tr *IothubDps) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubDps
func (tr *IothubDps) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubDps
func (tr *IothubDps) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubDps
func (tr *IothubDps) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this IothubDps
func (tr *IothubDps) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this IothubDps using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IothubDps) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubDpsParameters{}
