...
var (
	EndpointStorageContainerKind             = "EndpointStorageContainer"
	EndpointStorageContainerGroupKind        = schema.GroupKind{Group: Group, Kind: EndpointStorageContainerKind}.String()
	EndpointStorageContainerKindAPIVersion   = EndpointStorageContainerKind + "." + GroupVersion.String()
	EndpointStorageContainerGroupVersionKind = GroupVersion.WithKind(EndpointStorageContainerKind)
)
