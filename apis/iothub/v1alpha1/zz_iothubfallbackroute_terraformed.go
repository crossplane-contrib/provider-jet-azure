...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubFallbackRoute
func (tr *IothubFallbackRoute) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubFallbackRoute
func (tr *IothubFallbackRoute) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubFallbackRoute
func (tr *IothubFallbackRoute) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubFallbackRoute
func (tr *IothubFallbackRoute) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this IothubFallbackRoute
func (tr *IothubFallbackRoute) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this IothubFallbackRoute using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IothubFallbackRoute) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubFallbackRouteParameters{}
