...
var (
	EndpointEventhubKind             = "EndpointEventhub"
	EndpointEventhubGroupKind        = schema.GroupKind{Group: Group, Kind: EndpointEventhubKind}.String()
	EndpointEventhubKindAPIVersion   = EndpointEventhubKind + "." + GroupVersion.String()
	EndpointEventhubGroupVersionKind = GroupVersion.WithKind(EndpointEventhubKind)
)
