...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubRoute
func (tr *IothubRoute) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubRoute
func (tr *IothubRoute) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubRoute
func (tr *IothubRoute) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubRoute
func (tr *IothubRoute) GetParameters() ([]byte, error) {
...
func (tr *IothubRoute) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubRouteParameters{}
