...
// GetTerraformResourceIdField returns Terraform identifier field for this IothubConsumerGroup
func (tr *IothubConsumerGroup) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IothubConsumerGroup
func (tr *IothubConsumerGroup) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IothubConsumerGroup
func (tr *IothubConsumerGroup) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IothubConsumerGroup
func (tr *IothubConsumerGroup) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this IothubConsumerGroup
func (tr *IothubConsumerGroup) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this IothubConsumerGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IothubConsumerGroup) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IothubConsumerGroupParameters{}
