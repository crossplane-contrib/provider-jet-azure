...
// GetTerraformResourceIDField returns Terraform identifier field for this ServicesVault
func (tr *ServicesVault) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ServicesVault using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ServicesVault) LateInitialize(attrs []byte) (bool, error) {
	params := &ServicesVaultParameters{}
