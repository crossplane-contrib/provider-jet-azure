...
func (tr *GlobalVMShutdownSchedule) GetObservation() (map[string]interface{}, error) {
...
func (tr *GlobalVMShutdownSchedule) SetObservation(obs map[string]interface{}) error {
...
func (tr *GlobalVMShutdownSchedule) GetParameters() (map[string]interface{}, error) {
...
func (tr *GlobalVMShutdownSchedule) SetParameters(params map[string]interface{}) error {
...
func (tr *Lab) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *Lab) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
func (tr *Lab) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *Lab) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
