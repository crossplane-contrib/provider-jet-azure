...
// GetTerraformResourceIDField returns Terraform identifier field for this NamespaceAuthorizationRule
func (tr *NamespaceAuthorizationRule) GetTerraformResourceIDField() string {
	return "id"
}
