...
// GetTerraformResourceIDField returns Terraform identifier field for this QueueAuthorizationRule
func (tr *QueueAuthorizationRule) GetTerraformResourceIDField() string {
	return "id"
}
