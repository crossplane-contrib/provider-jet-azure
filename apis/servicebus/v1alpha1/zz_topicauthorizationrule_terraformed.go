...
// GetTerraformResourceIDField returns Terraform identifier field for this TopicAuthorizationRule
func (tr *TopicAuthorizationRule) GetTerraformResourceIDField() string {
	return "id"
}
