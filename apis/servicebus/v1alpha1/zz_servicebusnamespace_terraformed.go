...
func (tr *ServicebusNamespace) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ServicebusNamespace
func (tr *ServicebusNamespace) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ServicebusNamespace
func (tr *ServicebusNamespace) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ServicebusNamespace
func (tr *ServicebusNamespace) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ServicebusNamespace using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ServicebusNamespace) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ServicebusNamespaceParameters{}
