...
var (
	TopicAuthorizationRuleKind             = "TopicAuthorizationRule"
	TopicAuthorizationRuleGroupKind        = schema.GroupKind{Group: Group, Kind: TopicAuthorizationRuleKind}.String()
	TopicAuthorizationRuleKindAPIVersion   = TopicAuthorizationRuleKind + "." + GroupVersion.String()
	TopicAuthorizationRuleGroupVersionKind = GroupVersion.WithKind(TopicAuthorizationRuleKind)
)
