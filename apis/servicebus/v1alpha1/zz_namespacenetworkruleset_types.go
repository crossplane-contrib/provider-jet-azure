...
var (
	NamespaceNetworkRuleSetKind             = "NamespaceNetworkRuleSet"
	NamespaceNetworkRuleSetGroupKind        = schema.GroupKind{Group: Group, Kind: NamespaceNetworkRuleSetKind}.String()
	NamespaceNetworkRuleSetKindAPIVersion   = NamespaceNetworkRuleSetKind + "." + GroupVersion.String()
	NamespaceNetworkRuleSetGroupVersionKind = GroupVersion.WithKind(NamespaceNetworkRuleSetKind)
)
