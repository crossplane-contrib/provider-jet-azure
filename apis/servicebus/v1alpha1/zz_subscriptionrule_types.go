...
var (
	SubscriptionRuleKind             = "SubscriptionRule"
	SubscriptionRuleGroupKind        = schema.GroupKind{Group: Group, Kind: SubscriptionRuleKind}.String()
	SubscriptionRuleKindAPIVersion   = SubscriptionRuleKind + "." + GroupVersion.String()
	SubscriptionRuleGroupVersionKind = GroupVersion.WithKind(SubscriptionRuleKind)
)
