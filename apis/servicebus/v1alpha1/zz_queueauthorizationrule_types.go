...
var (
	QueueAuthorizationRuleKind             = "QueueAuthorizationRule"
	QueueAuthorizationRuleGroupKind        = schema.GroupKind{Group: Group, Kind: QueueAuthorizationRuleKind}.String()
	QueueAuthorizationRuleKindAPIVersion   = QueueAuthorizationRuleKind + "." + GroupVersion.String()
	QueueAuthorizationRuleGroupVersionKind = GroupVersion.WithKind(QueueAuthorizationRuleKind)
)
