...
// GetTerraformResourceIDField returns Terraform identifier field for this NamespaceNetworkRuleSet
func (tr *NamespaceNetworkRuleSet) GetTerraformResourceIDField() string {
	return "id"
}
