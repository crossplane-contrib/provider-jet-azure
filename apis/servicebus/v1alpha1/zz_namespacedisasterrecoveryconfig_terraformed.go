...
// GetTerraformResourceIDField returns Terraform identifier field for this NamespaceDisasterRecoveryConfig
func (tr *NamespaceDisasterRecoveryConfig) GetTerraformResourceIDField() string {
	return "id"
}
