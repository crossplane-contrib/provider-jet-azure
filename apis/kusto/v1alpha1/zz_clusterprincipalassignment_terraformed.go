...
// GetTerraformResourceIDField returns Terraform identifier field for this ClusterPrincipalAssignment
func (tr *ClusterPrincipalAssignment) GetTerraformResourceIDField() string {
	return "id"
}
