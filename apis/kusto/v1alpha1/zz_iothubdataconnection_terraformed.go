...
// GetTerraformResourceIDField returns Terraform identifier field for this IothubDataConnection
func (tr *IothubDataConnection) GetTerraformResourceIDField() string {
	return "id"
}
