...
// GetTerraformResourceIDField returns Terraform identifier field for this EventgridDataConnection
func (tr *EventgridDataConnection) GetTerraformResourceIDField() string {
	return "id"
}
