...
// GetTerraformResourceIDField returns Terraform identifier field for this DatabasePrincipalAssignment
func (tr *DatabasePrincipalAssignment) GetTerraformResourceIDField() string {
	return "id"
}
