...
var (
	ClusterCustomerManagedKeyKind             = "ClusterCustomerManagedKey"
	ClusterCustomerManagedKeyGroupKind        = schema.GroupKind{Group: Group, Kind: ClusterCustomerManagedKeyKind}.String()
	ClusterCustomerManagedKeyKindAPIVersion   = ClusterCustomerManagedKeyKind + "." + GroupVersion.String()
	ClusterCustomerManagedKeyGroupVersionKind = GroupVersion.WithKind(ClusterCustomerManagedKeyKind)
)
