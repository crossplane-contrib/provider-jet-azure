...
var (
	DatabasePrincipalAssignmentKind             = "DatabasePrincipalAssignment"
	DatabasePrincipalAssignmentGroupKind        = schema.GroupKind{Group: Group, Kind: DatabasePrincipalAssignmentKind}.String()
	DatabasePrincipalAssignmentKindAPIVersion   = DatabasePrincipalAssignmentKind + "." + GroupVersion.String()
	DatabasePrincipalAssignmentGroupVersionKind = GroupVersion.WithKind(DatabasePrincipalAssignmentKind)
)
