...
var (
	IothubDataConnectionKind             = "IothubDataConnection"
	IothubDataConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: IothubDataConnectionKind}.String()
	IothubDataConnectionKindAPIVersion   = IothubDataConnectionKind + "." + GroupVersion.String()
	IothubDataConnectionGroupVersionKind = GroupVersion.WithKind(IothubDataConnectionKind)
)
