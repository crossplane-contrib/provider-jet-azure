...
// GetTerraformResourceIDField returns Terraform identifier field for this EventhubDataConnection
func (tr *EventhubDataConnection) GetTerraformResourceIDField() string {
	return "id"
}
