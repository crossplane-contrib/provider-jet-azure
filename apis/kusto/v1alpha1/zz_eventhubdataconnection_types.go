...
var (
	EventhubDataConnectionKind             = "EventhubDataConnection"
	EventhubDataConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: EventhubDataConnectionKind}.String()
	EventhubDataConnectionKindAPIVersion   = EventhubDataConnectionKind + "." + GroupVersion.String()
	EventhubDataConnectionGroupVersionKind = GroupVersion.WithKind(EventhubDataConnectionKind)
)
