...
var (
	EventgridDataConnectionKind             = "EventgridDataConnection"
	EventgridDataConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: EventgridDataConnectionKind}.String()
	EventgridDataConnectionKindAPIVersion   = EventgridDataConnectionKind + "." + GroupVersion.String()
	EventgridDataConnectionGroupVersionKind = GroupVersion.WithKind(EventgridDataConnectionKind)
)
