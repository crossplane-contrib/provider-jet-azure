...
func (in *ScriptParameters) DeepCopyInto(out *ScriptParameters) {
	*out = *in
	if in.ContinueOnErrorsEnabled != nil {
		in, out := &in.ContinueOnErrorsEnabled, &out.ContinueOnErrorsEnabled
		*out = new(bool)
		**out = **in
	}
	...
	if in.ForceAnUpdateWhenValueChanged != nil {
		in, out := &in.ForceAnUpdateWhenValueChanged, &out.ForceAnUpdateWhenValueChanged
		*out = new(string)
		**out = **in
	}
	if in.Name != nil {
