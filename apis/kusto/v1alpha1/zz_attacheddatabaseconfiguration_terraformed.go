...
// GetTerraformResourceIDField returns Terraform identifier field for this AttachedDatabaseConfiguration
func (tr *AttachedDatabaseConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
