...
var (
	ClusterPrincipalAssignmentKind             = "ClusterPrincipalAssignment"
	ClusterPrincipalAssignmentGroupKind        = schema.GroupKind{Group: Group, Kind: ClusterPrincipalAssignmentKind}.String()
	ClusterPrincipalAssignmentKindAPIVersion   = ClusterPrincipalAssignmentKind + "." + GroupVersion.String()
	ClusterPrincipalAssignmentGroupVersionKind = GroupVersion.WithKind(ClusterPrincipalAssignmentKind)
)
