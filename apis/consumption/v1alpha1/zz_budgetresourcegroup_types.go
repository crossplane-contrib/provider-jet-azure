...
var (
	BudgetResourceGroupKind             = "BudgetResourceGroup"
	BudgetResourceGroupGroupKind        = schema.GroupKind{Group: Group, Kind: BudgetResourceGroupKind}.String()
	BudgetResourceGroupKindAPIVersion   = BudgetResourceGroupKind + "." + GroupVersion.String()
	BudgetResourceGroupGroupVersionKind = GroupVersion.WithKind(BudgetResourceGroupKind)
)
