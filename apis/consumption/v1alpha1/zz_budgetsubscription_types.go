...
var (
	BudgetSubscriptionKind             = "BudgetSubscription"
	BudgetSubscriptionGroupKind        = schema.GroupKind{Group: Group, Kind: BudgetSubscriptionKind}.String()
	BudgetSubscriptionKindAPIVersion   = BudgetSubscriptionKind + "." + GroupVersion.String()
	BudgetSubscriptionGroupVersionKind = GroupVersion.WithKind(BudgetSubscriptionKind)
)
