...
// GetTerraformResourceIDField returns Terraform identifier field for this BudgetResourceGroup
func (tr *BudgetResourceGroup) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *BudgetResourceGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &BudgetResourceGroupParameters{}
