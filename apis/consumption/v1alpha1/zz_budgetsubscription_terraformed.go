...
// GetTerraformResourceIDField returns Terraform identifier field for this BudgetSubscription
func (tr *BudgetSubscription) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *BudgetSubscription) LateInitialize(attrs []byte) (bool, error) {
	params := &BudgetSubscriptionParameters{}
