...
var (
	ManagerEndpointKind             = "ManagerEndpoint"
	ManagerEndpointGroupKind        = schema.GroupKind{Group: Group, Kind: ManagerEndpointKind}.String()
	ManagerEndpointKindAPIVersion   = ManagerEndpointKind + "." + GroupVersion.String()
	ManagerEndpointGroupVersionKind = GroupVersion.WithKind(ManagerEndpointKind)
)
