...
// GetTerraformResourceIdField returns Terraform identifier field for this TrafficManagerEndpoint
func (tr *TrafficManagerEndpoint) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this TrafficManagerEndpoint
func (tr *TrafficManagerEndpoint) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this TrafficManagerEndpoint
func (tr *TrafficManagerEndpoint) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this TrafficManagerEndpoint
func (tr *TrafficManagerEndpoint) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this TrafficManagerEndpoint
func (tr *TrafficManagerEndpoint) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this TrafficManagerEndpoint using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TrafficManagerEndpoint) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &TrafficManagerEndpointParameters{}
