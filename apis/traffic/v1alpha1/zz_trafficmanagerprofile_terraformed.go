...
// GetTerraformResourceIdField returns Terraform identifier field for this TrafficManagerProfile
func (tr *TrafficManagerProfile) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this TrafficManagerProfile
func (tr *TrafficManagerProfile) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this TrafficManagerProfile
func (tr *TrafficManagerProfile) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this TrafficManagerProfile
func (tr *TrafficManagerProfile) GetParameters() ([]byte, error) {
...
func (tr *TrafficManagerProfile) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &TrafficManagerProfileParameters{}
