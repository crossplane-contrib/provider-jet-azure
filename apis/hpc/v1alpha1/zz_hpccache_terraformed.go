...
// GetTerraformResourceIdField returns Terraform identifier field for this HpcCache
func (tr *HpcCache) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this HpcCache
func (tr *HpcCache) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this HpcCache
func (tr *HpcCache) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this HpcCache
func (tr *HpcCache) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this HpcCache
func (tr *HpcCache) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this HpcCache using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HpcCache) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &HpcCacheParameters{}
