...
// GetTerraformResourceIDField returns Terraform identifier field for this CacheBlobNfsTarget
func (tr *CacheBlobNfsTarget) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CacheBlobNfsTarget using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CacheBlobNfsTarget) LateInitialize(attrs []byte) (bool, error) {
	params := &CacheBlobNfsTargetParameters{}
