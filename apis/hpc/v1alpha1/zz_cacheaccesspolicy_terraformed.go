...
// GetTerraformResourceIDField returns Terraform identifier field for this CacheAccessPolicy
func (tr *CacheAccessPolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CacheAccessPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CacheAccessPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &CacheAccessPolicyParameters{}
