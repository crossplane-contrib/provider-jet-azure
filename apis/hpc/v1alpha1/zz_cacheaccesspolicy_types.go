...
var (
	CacheAccessPolicyKind             = "CacheAccessPolicy"
	CacheAccessPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: CacheAccessPolicyKind}.String()
	CacheAccessPolicyKindAPIVersion   = CacheAccessPolicyKind + "." + GroupVersion.String()
	CacheAccessPolicyGroupVersionKind = GroupVersion.WithKind(CacheAccessPolicyKind)
)
