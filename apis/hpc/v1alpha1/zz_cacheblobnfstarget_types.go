...
var (
	CacheBlobNfsTargetKind             = "CacheBlobNfsTarget"
	CacheBlobNfsTargetGroupKind        = schema.GroupKind{Group: Group, Kind: CacheBlobNfsTargetKind}.String()
	CacheBlobNfsTargetKindAPIVersion   = CacheBlobNfsTargetKind + "." + GroupVersion.String()
	CacheBlobNfsTargetGroupVersionKind = GroupVersion.WithKind(CacheBlobNfsTargetKind)
)
