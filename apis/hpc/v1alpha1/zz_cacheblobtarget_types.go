...
var (
	CacheBlobTargetKind             = "CacheBlobTarget"
	CacheBlobTargetGroupKind        = schema.GroupKind{Group: Group, Kind: CacheBlobTargetKind}.String()
	CacheBlobTargetKindAPIVersion   = CacheBlobTargetKind + "." + GroupVersion.String()
	CacheBlobTargetGroupVersionKind = GroupVersion.WithKind(CacheBlobTargetKind)
)
