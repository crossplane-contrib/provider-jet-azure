...
// GetTerraformResourceIDField returns Terraform identifier field for this CacheNfsTarget
func (tr *CacheNfsTarget) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CacheNfsTarget using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CacheNfsTarget) LateInitialize(attrs []byte) (bool, error) {
	params := &CacheNfsTargetParameters{}
