...
// GetTerraformResourceIDField returns Terraform identifier field for this CacheBlobTarget
func (tr *CacheBlobTarget) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CacheBlobTarget using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CacheBlobTarget) LateInitialize(attrs []byte) (bool, error) {
	params := &CacheBlobTargetParameters{}
