...
// GetTerraformResourceIdField returns Terraform identifier field for this HpcCacheBlobNfsTarget
func (tr *HpcCacheBlobNfsTarget) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this HpcCacheBlobNfsTarget
func (tr *HpcCacheBlobNfsTarget) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this HpcCacheBlobNfsTarget
func (tr *HpcCacheBlobNfsTarget) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this HpcCacheBlobNfsTarget
func (tr *HpcCacheBlobNfsTarget) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this HpcCacheBlobNfsTarget
func (tr *HpcCacheBlobNfsTarget) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this HpcCacheBlobNfsTarget using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HpcCacheBlobNfsTarget) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &HpcCacheBlobNfsTargetParameters{}
