...
var (
	EdgeOrderKind             = "EdgeOrder"
	EdgeOrderGroupKind        = schema.GroupKind{Group: Group, Kind: EdgeOrderKind}.String()
	EdgeOrderKindAPIVersion   = EdgeOrderKind + "." + GroupVersion.String()
	EdgeOrderGroupVersionKind = GroupVersion.WithKind(EdgeOrderKind)
)
