...
var (
	EdgeDeviceKind             = "EdgeDevice"
	EdgeDeviceGroupKind        = schema.GroupKind{Group: Group, Kind: EdgeDeviceKind}.String()
	EdgeDeviceKindAPIVersion   = EdgeDeviceKind + "." + GroupVersion.String()
	EdgeDeviceGroupVersionKind = GroupVersion.WithKind(EdgeDeviceKind)
)
