...
func (tr *CosmosdbAccount) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this CosmosdbAccount
func (tr *CosmosdbAccount) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this CosmosdbAccount
func (tr *CosmosdbAccount) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this CosmosdbAccount
func (tr *CosmosdbAccount) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this CosmosdbAccount using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CosmosdbAccount) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &CosmosdbAccountParameters{}
