...
var (
	EmbeddedKind             = "Embedded"
	EmbeddedGroupKind        = schema.GroupKind{Group: Group, Kind: EmbeddedKind}.String()
	EmbeddedKindAPIVersion   = EmbeddedKind + "." + GroupVersion.String()
	EmbeddedGroupVersionKind = GroupVersion.WithKind(EmbeddedKind)
)
