...
func (tr *PowerbiEmbedded) GetObservation() (map[string]interface{}, error) {
...
func (tr *PowerbiEmbedded) SetObservation(obs map[string]interface{}) error {
...
func (tr *PowerbiEmbedded) GetParameters() (map[string]interface{}, error) {
...
func (tr *PowerbiEmbedded) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this PowerbiEmbedded using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PowerbiEmbedded) LateInitialize(attrs []byte) (bool, error) {
	params := &PowerbiEmbeddedParameters{}
