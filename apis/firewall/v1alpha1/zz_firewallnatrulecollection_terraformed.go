...
// GetTerraformResourceIdField returns Terraform identifier field for this FirewallNatRuleCollection
func (tr *FirewallNatRuleCollection) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this FirewallNatRuleCollection
func (tr *FirewallNatRuleCollection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this FirewallNatRuleCollection
func (tr *FirewallNatRuleCollection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this FirewallNatRuleCollection
func (tr *FirewallNatRuleCollection) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this FirewallNatRuleCollection
func (tr *FirewallNatRuleCollection) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this FirewallNatRuleCollection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FirewallNatRuleCollection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &FirewallNatRuleCollectionParameters{}
