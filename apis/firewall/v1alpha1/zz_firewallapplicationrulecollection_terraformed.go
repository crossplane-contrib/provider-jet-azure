...
// GetTerraformResourceIdField returns Terraform identifier field for this FirewallApplicationRuleCollection
func (tr *FirewallApplicationRuleCollection) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this FirewallApplicationRuleCollection
func (tr *FirewallApplicationRuleCollection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this FirewallApplicationRuleCollection
func (tr *FirewallApplicationRuleCollection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this FirewallApplicationRuleCollection
func (tr *FirewallApplicationRuleCollection) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this FirewallApplicationRuleCollection
func (tr *FirewallApplicationRuleCollection) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this FirewallApplicationRuleCollection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FirewallApplicationRuleCollection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &FirewallApplicationRuleCollectionParameters{}
