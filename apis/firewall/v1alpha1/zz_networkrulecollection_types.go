...
var (
	NetworkRuleCollectionKind             = "NetworkRuleCollection"
	NetworkRuleCollectionGroupKind        = schema.GroupKind{Group: Group, Kind: NetworkRuleCollectionKind}.String()
	NetworkRuleCollectionKindAPIVersion   = NetworkRuleCollectionKind + "." + GroupVersion.String()
	NetworkRuleCollectionGroupVersionKind = GroupVersion.WithKind(NetworkRuleCollectionKind)
)
