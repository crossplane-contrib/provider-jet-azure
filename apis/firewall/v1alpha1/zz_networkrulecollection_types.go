...
// NetworkRuleCollectionSpec defines the desired state of NetworkRuleCollection
type NetworkRuleCollectionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     NetworkRuleCollectionParameters `json:"forProvider"`
}

// NetworkRuleCollectionStatus defines the observed state of NetworkRuleCollection.
type NetworkRuleCollectionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        NetworkRuleCollectionObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// NetworkRuleCollection is the Schema for the NetworkRuleCollections API
...
type NetworkRuleCollection struct {
	...
	Spec              NetworkRuleCollectionSpec   `json:"spec"`
	Status            NetworkRuleCollectionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// NetworkRuleCollectionList contains a list of NetworkRuleCollections
type NetworkRuleCollectionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []NetworkRuleCollection `json:"items"`
}

// Repository type metadata.
var (
	NetworkRuleCollection_Kind             = "NetworkRuleCollection"
	NetworkRuleCollection_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: NetworkRuleCollection_Kind}.String()
	NetworkRuleCollection_KindAPIVersion   = NetworkRuleCollection_Kind + "." + CRDGroupVersion.String()
	NetworkRuleCollection_GroupVersionKind = CRDGroupVersion.WithKind(NetworkRuleCollection_Kind)
)

func init() {
	SchemeBuilder.Register(&NetworkRuleCollection{}, &NetworkRuleCollectionList{})
}
