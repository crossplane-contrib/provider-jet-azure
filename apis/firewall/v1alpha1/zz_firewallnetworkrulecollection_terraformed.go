...
// GetTerraformResourceIdField returns Terraform identifier field for this FirewallNetworkRuleCollection
func (tr *FirewallNetworkRuleCollection) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this FirewallNetworkRuleCollection
func (tr *FirewallNetworkRuleCollection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this FirewallNetworkRuleCollection
func (tr *FirewallNetworkRuleCollection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this FirewallNetworkRuleCollection
func (tr *FirewallNetworkRuleCollection) GetParameters() ([]byte, error) {
...
func (tr *FirewallNetworkRuleCollection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &FirewallNetworkRuleCollectionParameters{}
