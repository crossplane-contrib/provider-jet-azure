...
var (
	NatRuleCollectionKind             = "NatRuleCollection"
	NatRuleCollectionGroupKind        = schema.GroupKind{Group: Group, Kind: NatRuleCollectionKind}.String()
	NatRuleCollectionKindAPIVersion   = NatRuleCollectionKind + "." + GroupVersion.String()
	NatRuleCollectionGroupVersionKind = GroupVersion.WithKind(NatRuleCollectionKind)
)
