...
var (
	PolicyRuleCollectionGroupKind             = "PolicyRuleCollectionGroup"
	PolicyRuleCollectionGroupGroupKind        = schema.GroupKind{Group: Group, Kind: PolicyRuleCollectionGroupKind}.String()
	PolicyRuleCollectionGroupKindAPIVersion   = PolicyRuleCollectionGroupKind + "." + GroupVersion.String()
	PolicyRuleCollectionGroupGroupVersionKind = GroupVersion.WithKind(PolicyRuleCollectionGroupKind)
)
