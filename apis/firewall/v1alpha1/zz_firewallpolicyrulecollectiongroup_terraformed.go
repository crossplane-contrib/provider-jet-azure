...
// GetTerraformResourceIdField returns Terraform identifier field for this FirewallPolicyRuleCollectionGroup
func (tr *FirewallPolicyRuleCollectionGroup) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this FirewallPolicyRuleCollectionGroup
func (tr *FirewallPolicyRuleCollectionGroup) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this FirewallPolicyRuleCollectionGroup
func (tr *FirewallPolicyRuleCollectionGroup) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this FirewallPolicyRuleCollectionGroup
func (tr *FirewallPolicyRuleCollectionGroup) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this FirewallPolicyRuleCollectionGroup
func (tr *FirewallPolicyRuleCollectionGroup) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this FirewallPolicyRuleCollectionGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FirewallPolicyRuleCollectionGroup) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &FirewallPolicyRuleCollectionGroupParameters{}
