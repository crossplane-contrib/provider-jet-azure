...
var (
	FactoryLinkedServiceAzureFunctionKind             = "FactoryLinkedServiceAzureFunction"
	FactoryLinkedServiceAzureFunctionGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceAzureFunctionKind}.String()
	FactoryLinkedServiceAzureFunctionKindAPIVersion   = FactoryLinkedServiceAzureFunctionKind + "." + GroupVersion.String()
	FactoryLinkedServiceAzureFunctionGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceAzureFunctionKind)
)
