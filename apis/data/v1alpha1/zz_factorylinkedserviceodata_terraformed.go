...
// GetTerraformResourceIDField returns Terraform identifier field for this FactoryLinkedServiceOdata
func (tr *FactoryLinkedServiceOdata) GetTerraformResourceIDField() string {
	return "id"
}
