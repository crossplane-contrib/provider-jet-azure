...
var (
	FactoryDatasetBinary_Kind             = "FactoryDatasetBinary"
	FactoryDatasetBinary_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: FactoryDatasetBinary_Kind}.String()
	FactoryDatasetBinary_KindAPIVersion   = FactoryDatasetBinary_Kind + "." + CRDGroupVersion.String()
	FactoryDatasetBinary_GroupVersionKind = CRDGroupVersion.WithKind(FactoryDatasetBinary_Kind)
)
