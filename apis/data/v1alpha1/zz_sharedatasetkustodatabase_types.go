...
var (
	ShareDatasetKustoDatabaseKind             = "ShareDatasetKustoDatabase"
	ShareDatasetKustoDatabaseGroupKind        = schema.GroupKind{Group: Group, Kind: ShareDatasetKustoDatabaseKind}.String()
	ShareDatasetKustoDatabaseKindAPIVersion   = ShareDatasetKustoDatabaseKind + "." + GroupVersion.String()
	ShareDatasetKustoDatabaseGroupVersionKind = GroupVersion.WithKind(ShareDatasetKustoDatabaseKind)
)
