...
var (
	FactoryLinkedServiceAzureTableStorageKind             = "FactoryLinkedServiceAzureTableStorage"
	FactoryLinkedServiceAzureTableStorageGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceAzureTableStorageKind}.String()
	FactoryLinkedServiceAzureTableStorageKindAPIVersion   = FactoryLinkedServiceAzureTableStorageKind + "." + GroupVersion.String()
	FactoryLinkedServiceAzureTableStorageGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceAzureTableStorageKind)
)
