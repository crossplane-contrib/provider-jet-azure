...
var (
	LakeAnalyticsFirewallRuleKind             = "LakeAnalyticsFirewallRule"
	LakeAnalyticsFirewallRuleGroupKind        = schema.GroupKind{Group: Group, Kind: LakeAnalyticsFirewallRuleKind}.String()
	LakeAnalyticsFirewallRuleKindAPIVersion   = LakeAnalyticsFirewallRuleKind + "." + GroupVersion.String()
	LakeAnalyticsFirewallRuleGroupVersionKind = GroupVersion.WithKind(LakeAnalyticsFirewallRuleKind)
)
