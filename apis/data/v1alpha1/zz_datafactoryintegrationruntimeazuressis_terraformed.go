...
func (tr *DataFactoryIntegrationRuntimeAzureSsis) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DataFactoryIntegrationRuntimeAzureSsis
func (tr *DataFactoryIntegrationRuntimeAzureSsis) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DataFactoryIntegrationRuntimeAzureSsis
func (tr *DataFactoryIntegrationRuntimeAzureSsis) GetParameters() ([]byte, error) {
...
func (tr *DataFactoryIntegrationRuntimeAzureSsis) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DataFactoryIntegrationRuntimeAzureSsisParameters{}
