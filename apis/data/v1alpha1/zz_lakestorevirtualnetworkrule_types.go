...
var (
	LakeStoreVirtualNetworkRuleKind             = "LakeStoreVirtualNetworkRule"
	LakeStoreVirtualNetworkRuleGroupKind        = schema.GroupKind{Group: Group, Kind: LakeStoreVirtualNetworkRuleKind}.String()
	LakeStoreVirtualNetworkRuleKindAPIVersion   = LakeStoreVirtualNetworkRuleKind + "." + GroupVersion.String()
	LakeStoreVirtualNetworkRuleGroupVersionKind = GroupVersion.WithKind(LakeStoreVirtualNetworkRuleKind)
)
