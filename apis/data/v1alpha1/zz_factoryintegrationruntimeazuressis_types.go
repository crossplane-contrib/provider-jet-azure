...
var (
	FactoryIntegrationRuntimeAzureSsis_Kind             = "FactoryIntegrationRuntimeAzureSsis"
	FactoryIntegrationRuntimeAzureSsis_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: FactoryIntegrationRuntimeAzureSsis_Kind}.String()
	FactoryIntegrationRuntimeAzureSsis_KindAPIVersion   = FactoryIntegrationRuntimeAzureSsis_Kind + "." + CRDGroupVersion.String()
	FactoryIntegrationRuntimeAzureSsis_GroupVersionKind = CRDGroupVersion.WithKind(FactoryIntegrationRuntimeAzureSsis_Kind)
)
