...
var (
	FactoryLinkedServiceAzureSearchKind             = "FactoryLinkedServiceAzureSearch"
	FactoryLinkedServiceAzureSearchGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceAzureSearchKind}.String()
	FactoryLinkedServiceAzureSearchKindAPIVersion   = FactoryLinkedServiceAzureSearchKind + "." + GroupVersion.String()
	FactoryLinkedServiceAzureSearchGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceAzureSearchKind)
)
