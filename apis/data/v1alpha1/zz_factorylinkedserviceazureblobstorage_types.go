...
var (
	FactoryLinkedServiceAzureBlobStorageKind             = "FactoryLinkedServiceAzureBlobStorage"
	FactoryLinkedServiceAzureBlobStorageGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceAzureBlobStorageKind}.String()
	FactoryLinkedServiceAzureBlobStorageKindAPIVersion   = FactoryLinkedServiceAzureBlobStorageKind + "." + GroupVersion.String()
	FactoryLinkedServiceAzureBlobStorageGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceAzureBlobStorageKind)
)
