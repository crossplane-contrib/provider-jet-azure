...
var (
	FactoryLinkedServiceMysqlKind             = "FactoryLinkedServiceMysql"
	FactoryLinkedServiceMysqlGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceMysqlKind}.String()
	FactoryLinkedServiceMysqlKindAPIVersion   = FactoryLinkedServiceMysqlKind + "." + GroupVersion.String()
	FactoryLinkedServiceMysqlGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceMysqlKind)
)
