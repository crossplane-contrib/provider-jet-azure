...
var (
	ProtectionBackupInstancePostgresqlKind             = "ProtectionBackupInstancePostgresql"
	ProtectionBackupInstancePostgresqlGroupKind        = schema.GroupKind{Group: Group, Kind: ProtectionBackupInstancePostgresqlKind}.String()
	ProtectionBackupInstancePostgresqlKindAPIVersion   = ProtectionBackupInstancePostgresqlKind + "." + GroupVersion.String()
	ProtectionBackupInstancePostgresqlGroupVersionKind = GroupVersion.WithKind(ProtectionBackupInstancePostgresqlKind)
)
