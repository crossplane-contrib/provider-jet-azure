...
var (
	FactoryTriggerBlobEventKind             = "FactoryTriggerBlobEvent"
	FactoryTriggerBlobEventGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryTriggerBlobEventKind}.String()
	FactoryTriggerBlobEventKindAPIVersion   = FactoryTriggerBlobEventKind + "." + GroupVersion.String()
	FactoryTriggerBlobEventGroupVersionKind = GroupVersion.WithKind(FactoryTriggerBlobEventKind)
)
