...
var (
	LakeStoreFirewallRuleKind             = "LakeStoreFirewallRule"
	LakeStoreFirewallRuleGroupKind        = schema.GroupKind{Group: Group, Kind: LakeStoreFirewallRuleKind}.String()
	LakeStoreFirewallRuleKindAPIVersion   = LakeStoreFirewallRuleKind + "." + GroupVersion.String()
	LakeStoreFirewallRuleGroupVersionKind = GroupVersion.WithKind(LakeStoreFirewallRuleKind)
)
