...
var (
	FactoryKind             = "Factory"
	FactoryGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryKind}.String()
	FactoryKindAPIVersion   = FactoryKind + "." + GroupVersion.String()
	FactoryGroupVersionKind = GroupVersion.WithKind(FactoryKind)
)
