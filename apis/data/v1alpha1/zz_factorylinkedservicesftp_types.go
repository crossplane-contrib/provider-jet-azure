...
var (
	FactoryLinkedServiceSftpKind             = "FactoryLinkedServiceSftp"
	FactoryLinkedServiceSftpGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceSftpKind}.String()
	FactoryLinkedServiceSftpKindAPIVersion   = FactoryLinkedServiceSftpKind + "." + GroupVersion.String()
	FactoryLinkedServiceSftpGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceSftpKind)
)
