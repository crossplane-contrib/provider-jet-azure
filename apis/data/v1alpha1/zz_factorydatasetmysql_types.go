...
var (
	FactoryDatasetMysqlKind             = "FactoryDatasetMysql"
	FactoryDatasetMysqlGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryDatasetMysqlKind}.String()
	FactoryDatasetMysqlKindAPIVersion   = FactoryDatasetMysqlKind + "." + GroupVersion.String()
	FactoryDatasetMysqlGroupVersionKind = GroupVersion.WithKind(FactoryDatasetMysqlKind)
)
