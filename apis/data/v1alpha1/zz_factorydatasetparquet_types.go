...
var (
	FactoryDatasetParquetKind             = "FactoryDatasetParquet"
	FactoryDatasetParquetGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryDatasetParquetKind}.String()
	FactoryDatasetParquetKindAPIVersion   = FactoryDatasetParquetKind + "." + GroupVersion.String()
	FactoryDatasetParquetGroupVersionKind = GroupVersion.WithKind(FactoryDatasetParquetKind)
)
