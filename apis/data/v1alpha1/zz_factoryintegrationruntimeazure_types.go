...
var (
	FactoryIntegrationRuntimeAzureKind             = "FactoryIntegrationRuntimeAzure"
	FactoryIntegrationRuntimeAzureGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryIntegrationRuntimeAzureKind}.String()
	FactoryIntegrationRuntimeAzureKindAPIVersion   = FactoryIntegrationRuntimeAzureKind + "." + GroupVersion.String()
	FactoryIntegrationRuntimeAzureGroupVersionKind = GroupVersion.WithKind(FactoryIntegrationRuntimeAzureKind)
)
