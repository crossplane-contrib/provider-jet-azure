...
var (
	FactoryDataFlowKind             = "FactoryDataFlow"
	FactoryDataFlowGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryDataFlowKind}.String()
	FactoryDataFlowKindAPIVersion   = FactoryDataFlowKind + "." + GroupVersion.String()
	FactoryDataFlowGroupVersionKind = GroupVersion.WithKind(FactoryDataFlowKind)
)
