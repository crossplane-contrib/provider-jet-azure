...
var (
	ProtectionBackupPolicyBlobStorageKind             = "ProtectionBackupPolicyBlobStorage"
	ProtectionBackupPolicyBlobStorageGroupKind        = schema.GroupKind{Group: Group, Kind: ProtectionBackupPolicyBlobStorageKind}.String()
	ProtectionBackupPolicyBlobStorageKindAPIVersion   = ProtectionBackupPolicyBlobStorageKind + "." + GroupVersion.String()
	ProtectionBackupPolicyBlobStorageGroupVersionKind = GroupVersion.WithKind(ProtectionBackupPolicyBlobStorageKind)
)
