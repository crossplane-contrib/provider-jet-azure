...
var (
	ShareDatasetKustoClusterKind             = "ShareDatasetKustoCluster"
	ShareDatasetKustoClusterGroupKind        = schema.GroupKind{Group: Group, Kind: ShareDatasetKustoClusterKind}.String()
	ShareDatasetKustoClusterKindAPIVersion   = ShareDatasetKustoClusterKind + "." + GroupVersion.String()
	ShareDatasetKustoClusterGroupVersionKind = GroupVersion.WithKind(ShareDatasetKustoClusterKind)
)
