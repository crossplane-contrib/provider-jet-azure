...
// GetConnectionDetailsMapping for this DataFactoryLinkedServiceAzureBlobStorage
func (tr *DataFactoryLinkedServiceAzureBlobStorage) GetConnectionDetailsMapping() map[string]string {
...
func (tr *DataFactoryLinkedServiceAzureBlobStorage) GetObservation() (map[string]interface{}, error) {
...
func (tr *DataFactoryLinkedServiceAzureBlobStorage) SetObservation(obs map[string]interface{}) error {
...
func (tr *DataFactoryLinkedServiceAzureBlobStorage) GetParameters() (map[string]interface{}, error) {
...
func (tr *DataFactoryLinkedServiceAzureBlobStorage) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this DataFactoryLinkedServiceAzureBlobStorage using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DataFactoryLinkedServiceAzureBlobStorage) LateInitialize(attrs []byte) (bool, error) {
	params := &DataFactoryLinkedServiceAzureBlobStorageParameters{}
...
func (tr *DataFactoryLinkedServiceAzureBlobStorage) GetTerraformSchemaVersion() int {
	return 0
}
