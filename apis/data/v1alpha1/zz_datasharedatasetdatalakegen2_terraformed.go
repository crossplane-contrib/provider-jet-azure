...
func (tr *DataShareDatasetDataLakeGen2) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DataShareDatasetDataLakeGen2
func (tr *DataShareDatasetDataLakeGen2) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DataShareDatasetDataLakeGen2
func (tr *DataShareDatasetDataLakeGen2) GetParameters() ([]byte, error) {
...
func (tr *DataShareDatasetDataLakeGen2) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DataShareDatasetDataLakeGen2Parameters{}
