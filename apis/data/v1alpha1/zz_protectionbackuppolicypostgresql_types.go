...
var (
	ProtectionBackupPolicyPostgresqlKind             = "ProtectionBackupPolicyPostgresql"
	ProtectionBackupPolicyPostgresqlGroupKind        = schema.GroupKind{Group: Group, Kind: ProtectionBackupPolicyPostgresqlKind}.String()
	ProtectionBackupPolicyPostgresqlKindAPIVersion   = ProtectionBackupPolicyPostgresqlKind + "." + GroupVersion.String()
	ProtectionBackupPolicyPostgresqlGroupVersionKind = GroupVersion.WithKind(ProtectionBackupPolicyPostgresqlKind)
)
