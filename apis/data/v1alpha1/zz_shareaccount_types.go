...
var (
	ShareAccountKind             = "ShareAccount"
	ShareAccountGroupKind        = schema.GroupKind{Group: Group, Kind: ShareAccountKind}.String()
	ShareAccountKindAPIVersion   = ShareAccountKind + "." + GroupVersion.String()
	ShareAccountGroupVersionKind = GroupVersion.WithKind(ShareAccountKind)
)
