...
var (
	FactoryLinkedServiceSynapseKind             = "FactoryLinkedServiceSynapse"
	FactoryLinkedServiceSynapseGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceSynapseKind}.String()
	FactoryLinkedServiceSynapseKindAPIVersion   = FactoryLinkedServiceSynapseKind + "." + GroupVersion.String()
	FactoryLinkedServiceSynapseGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceSynapseKind)
)
