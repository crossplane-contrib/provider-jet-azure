...
var (
	FactoryCustomDatasetKind             = "FactoryCustomDataset"
	FactoryCustomDatasetGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryCustomDatasetKind}.String()
	FactoryCustomDatasetKindAPIVersion   = FactoryCustomDatasetKind + "." + GroupVersion.String()
	FactoryCustomDatasetGroupVersionKind = GroupVersion.WithKind(FactoryCustomDatasetKind)
)
