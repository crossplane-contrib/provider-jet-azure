...
var (
	FactoryDatasetPostgresqlKind             = "FactoryDatasetPostgresql"
	FactoryDatasetPostgresqlGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryDatasetPostgresqlKind}.String()
	FactoryDatasetPostgresqlKindAPIVersion   = FactoryDatasetPostgresqlKind + "." + GroupVersion.String()
	FactoryDatasetPostgresqlGroupVersionKind = GroupVersion.WithKind(FactoryDatasetPostgresqlKind)
)
