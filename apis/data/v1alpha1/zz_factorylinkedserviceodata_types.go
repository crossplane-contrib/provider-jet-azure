...
var (
	FactoryLinkedServiceOdataKind             = "FactoryLinkedServiceOdata"
	FactoryLinkedServiceOdataGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceOdataKind}.String()
	FactoryLinkedServiceOdataKindAPIVersion   = FactoryLinkedServiceOdataKind + "." + GroupVersion.String()
	FactoryLinkedServiceOdataGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceOdataKind)
)
