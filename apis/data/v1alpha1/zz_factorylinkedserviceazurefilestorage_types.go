...
var (
	FactoryLinkedServiceAzureFileStorageKind             = "FactoryLinkedServiceAzureFileStorage"
	FactoryLinkedServiceAzureFileStorageGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceAzureFileStorageKind}.String()
	FactoryLinkedServiceAzureFileStorageKindAPIVersion   = FactoryLinkedServiceAzureFileStorageKind + "." + GroupVersion.String()
	FactoryLinkedServiceAzureFileStorageGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceAzureFileStorageKind)
)
