...
// FactoryLinkedServiceCosmosDBMongoapi is the Schema for the FactoryLinkedServiceCosmosDBMongoapis API
...
func init() {
	SchemeBuilder.Register(&FactoryLinkedServiceCosmosDBMongoapi{}, &FactoryLinkedServiceCosmosDBMongoapiList{})
}
