...
var (
	FactoryTriggerCustomEventKind             = "FactoryTriggerCustomEvent"
	FactoryTriggerCustomEventGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryTriggerCustomEventKind}.String()
	FactoryTriggerCustomEventKindAPIVersion   = FactoryTriggerCustomEventKind + "." + GroupVersion.String()
	FactoryTriggerCustomEventGroupVersionKind = GroupVersion.WithKind(FactoryTriggerCustomEventKind)
)
