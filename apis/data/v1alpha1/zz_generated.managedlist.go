...
// GetItems of this DataFactoryTriggerTumblingWindowList.
func (l *DataFactoryTriggerTumblingWindowList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this DataLakeAnalyticsAccountList.
func (l *DataLakeAnalyticsAccountList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
