...
var (
	FactoryLinkedServiceDataLakeStorageGen2Kind             = "FactoryLinkedServiceDataLakeStorageGen2"
	FactoryLinkedServiceDataLakeStorageGen2GroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceDataLakeStorageGen2Kind}.String()
	FactoryLinkedServiceDataLakeStorageGen2KindAPIVersion   = FactoryLinkedServiceDataLakeStorageGen2Kind + "." + GroupVersion.String()
	FactoryLinkedServiceDataLakeStorageGen2GroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceDataLakeStorageGen2Kind)
)
