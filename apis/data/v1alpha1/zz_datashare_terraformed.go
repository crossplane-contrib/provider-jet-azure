...
// GetTerraformResourceIdField returns Terraform identifier field for this DataShare
func (tr *DataShare) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DataShare
func (tr *DataShare) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DataShare
func (tr *DataShare) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DataShare
func (tr *DataShare) GetParameters() ([]byte, error) {
