...
var (
	FactoryLinkedCustomServiceKind             = "FactoryLinkedCustomService"
	FactoryLinkedCustomServiceGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedCustomServiceKind}.String()
	FactoryLinkedCustomServiceKindAPIVersion   = FactoryLinkedCustomServiceKind + "." + GroupVersion.String()
	FactoryLinkedCustomServiceGroupVersionKind = GroupVersion.WithKind(FactoryLinkedCustomServiceKind)
)
