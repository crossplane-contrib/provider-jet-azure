...
var (
	FactoryLinkedServiceSnowflake_Kind             = "FactoryLinkedServiceSnowflake"
	FactoryLinkedServiceSnowflake_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: FactoryLinkedServiceSnowflake_Kind}.String()
	FactoryLinkedServiceSnowflake_KindAPIVersion   = FactoryLinkedServiceSnowflake_Kind + "." + CRDGroupVersion.String()
	FactoryLinkedServiceSnowflake_GroupVersionKind = CRDGroupVersion.WithKind(FactoryLinkedServiceSnowflake_Kind)
)
