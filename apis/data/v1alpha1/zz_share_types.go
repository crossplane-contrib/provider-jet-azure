...
var (
	ShareKind             = "Share"
	ShareGroupKind        = schema.GroupKind{Group: Group, Kind: ShareKind}.String()
	ShareKindAPIVersion   = ShareKind + "." + GroupVersion.String()
	ShareGroupVersionKind = GroupVersion.WithKind(ShareKind)
)
