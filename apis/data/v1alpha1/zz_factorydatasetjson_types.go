...
var (
	FactoryDatasetJsonKind             = "FactoryDatasetJson"
	FactoryDatasetJsonGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryDatasetJsonKind}.String()
	FactoryDatasetJsonKindAPIVersion   = FactoryDatasetJsonKind + "." + GroupVersion.String()
	FactoryDatasetJsonGroupVersionKind = GroupVersion.WithKind(FactoryDatasetJsonKind)
)
