...
var (
	ProtectionBackupInstanceDiskKind             = "ProtectionBackupInstanceDisk"
	ProtectionBackupInstanceDiskGroupKind        = schema.GroupKind{Group: Group, Kind: ProtectionBackupInstanceDiskKind}.String()
	ProtectionBackupInstanceDiskKindAPIVersion   = ProtectionBackupInstanceDiskKind + "." + GroupVersion.String()
	ProtectionBackupInstanceDiskGroupVersionKind = GroupVersion.WithKind(ProtectionBackupInstanceDiskKind)
)
