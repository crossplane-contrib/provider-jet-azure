...
var (
	FactoryLinkedServiceAzureDatabricksKind             = "FactoryLinkedServiceAzureDatabricks"
	FactoryLinkedServiceAzureDatabricksGroupKind        = schema.GroupKind{Group: Group, Kind: FactoryLinkedServiceAzureDatabricksKind}.String()
	FactoryLinkedServiceAzureDatabricksKindAPIVersion   = FactoryLinkedServiceAzureDatabricksKind + "." + GroupVersion.String()
	FactoryLinkedServiceAzureDatabricksGroupVersionKind = GroupVersion.WithKind(FactoryLinkedServiceAzureDatabricksKind)
)
