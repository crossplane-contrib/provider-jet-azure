...
// GetTerraformResourceIDField returns Terraform identifier field for this WorkspaceCustomerManagedKey
func (tr *WorkspaceCustomerManagedKey) GetTerraformResourceIDField() string {
	return "id"
}
