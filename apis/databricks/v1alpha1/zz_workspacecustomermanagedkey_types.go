...
// WorkspaceCustomerManagedKey is the Schema for the WorkspaceCustomerManagedKeys API
...
var (
	WorkspaceCustomerManagedKeyKind             = "WorkspaceCustomerManagedKey"
	WorkspaceCustomerManagedKeyGroupKind        = schema.GroupKind{Group: Group, Kind: WorkspaceCustomerManagedKeyKind}.String()
	WorkspaceCustomerManagedKeyKindAPIVersion   = WorkspaceCustomerManagedKeyKind + "." + GroupVersion.String()
	WorkspaceCustomerManagedKeyGroupVersionKind = GroupVersion.WithKind(WorkspaceCustomerManagedKeyKind)
)
