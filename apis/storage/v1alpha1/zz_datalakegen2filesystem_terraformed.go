...
// GetTerraformResourceIDField returns Terraform identifier field for this DataLakeGen2Filesystem
func (tr *DataLakeGen2Filesystem) GetTerraformResourceIDField() string {
	return "id"
}
