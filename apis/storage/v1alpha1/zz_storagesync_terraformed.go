...
// GetTerraformResourceIdField returns Terraform identifier field for this StorageSync
func (tr *StorageSync) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this StorageSync
func (tr *StorageSync) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this StorageSync
func (tr *StorageSync) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this StorageSync
func (tr *StorageSync) GetParameters() ([]byte, error) {
...
func (tr *StorageSync) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &StorageSyncParameters{}
