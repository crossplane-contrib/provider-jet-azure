...
var (
	EncryptionScopeKind             = "EncryptionScope"
	EncryptionScopeGroupKind        = schema.GroupKind{Group: Group, Kind: EncryptionScopeKind}.String()
	EncryptionScopeKindAPIVersion   = EncryptionScopeKind + "." + GroupVersion.String()
	EncryptionScopeGroupVersionKind = GroupVersion.WithKind(EncryptionScopeKind)
)
