...
// GetTerraformResourceIDField returns Terraform identifier field for this AccountNetworkRules
func (tr *AccountNetworkRules) GetTerraformResourceIDField() string {
	return "id"
}
