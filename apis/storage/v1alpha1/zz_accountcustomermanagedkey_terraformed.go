...
// GetTerraformResourceIDField returns Terraform identifier field for this AccountCustomerManagedKey
func (tr *AccountCustomerManagedKey) GetTerraformResourceIDField() string {
	return "id"
}
