...
// GetTerraformResourceIDField returns Terraform identifier field for this BlobInventoryPolicy
func (tr *BlobInventoryPolicy) GetTerraformResourceIDField() string {
	return "id"
}
