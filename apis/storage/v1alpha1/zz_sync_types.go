...
var (
	SyncKind             = "Sync"
	SyncGroupKind        = schema.GroupKind{Group: Group, Kind: SyncKind}.String()
	SyncKindAPIVersion   = SyncKind + "." + GroupVersion.String()
	SyncGroupVersionKind = GroupVersion.WithKind(SyncKind)
)
