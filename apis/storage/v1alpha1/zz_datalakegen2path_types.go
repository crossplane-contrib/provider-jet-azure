...
// DataLakeGen2Path is the Schema for the DataLakeGen2Paths API
...
var (
	DataLakeGen2PathKind             = "DataLakeGen2Path"
	DataLakeGen2PathGroupKind        = schema.GroupKind{Group: Group, Kind: DataLakeGen2PathKind}.String()
	DataLakeGen2PathKindAPIVersion   = DataLakeGen2PathKind + "." + GroupVersion.String()
	DataLakeGen2PathGroupVersionKind = GroupVersion.WithKind(DataLakeGen2PathKind)
)
