...
var (
	ObjectReplicationKind             = "ObjectReplication"
	ObjectReplicationGroupKind        = schema.GroupKind{Group: Group, Kind: ObjectReplicationKind}.String()
	ObjectReplicationKindAPIVersion   = ObjectReplicationKind + "." + GroupVersion.String()
	ObjectReplicationGroupVersionKind = GroupVersion.WithKind(ObjectReplicationKind)
)
