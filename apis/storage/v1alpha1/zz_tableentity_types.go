...
var (
	TableEntityKind             = "TableEntity"
	TableEntityGroupKind        = schema.GroupKind{Group: Group, Kind: TableEntityKind}.String()
	TableEntityKindAPIVersion   = TableEntityKind + "." + GroupVersion.String()
	TableEntityGroupVersionKind = GroupVersion.WithKind(TableEntityKind)
)
