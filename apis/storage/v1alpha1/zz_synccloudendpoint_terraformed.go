...
// GetTerraformResourceIDField returns Terraform identifier field for this SyncCloudEndpoint
func (tr *SyncCloudEndpoint) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this SyncCloudEndpoint using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SyncCloudEndpoint) LateInitialize(attrs []byte) (bool, error) {
	params := &SyncCloudEndpointParameters{}
