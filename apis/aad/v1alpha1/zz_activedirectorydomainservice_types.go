...
type ActiveDirectoryDomainServiceObservation struct {
	...
	InitialReplicaSet []InitialReplicaSetObservation `json:"initialReplicaSet,omitempty" tf:"initial_replica_set,omitempty"`

	ResourceID *string `json:"resourceId,omitempty" tf:"resource_id,omitempty"`

	SecureLdap []SecureLdapObservation `json:"secureLdap,omitempty" tf:"secure_ldap,omitempty"`
