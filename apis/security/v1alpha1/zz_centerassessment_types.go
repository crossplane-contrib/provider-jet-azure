...
var (
	CenterAssessmentKind             = "CenterAssessment"
	CenterAssessmentGroupKind        = schema.GroupKind{Group: Group, Kind: CenterAssessmentKind}.String()
	CenterAssessmentKindAPIVersion   = CenterAssessmentKind + "." + GroupVersion.String()
	CenterAssessmentGroupVersionKind = GroupVersion.WithKind(CenterAssessmentKind)
)
