...
var (
	CenterSettingKind             = "CenterSetting"
	CenterSettingGroupKind        = schema.GroupKind{Group: Group, Kind: CenterSettingKind}.String()
	CenterSettingKindAPIVersion   = CenterSettingKind + "." + GroupVersion.String()
	CenterSettingGroupVersionKind = GroupVersion.WithKind(CenterSettingKind)
)
