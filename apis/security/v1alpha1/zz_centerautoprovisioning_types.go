...
var (
	CenterAutoProvisioningKind             = "CenterAutoProvisioning"
	CenterAutoProvisioningGroupKind        = schema.GroupKind{Group: Group, Kind: CenterAutoProvisioningKind}.String()
	CenterAutoProvisioningKindAPIVersion   = CenterAutoProvisioningKind + "." + GroupVersion.String()
	CenterAutoProvisioningGroupVersionKind = GroupVersion.WithKind(CenterAutoProvisioningKind)
)
