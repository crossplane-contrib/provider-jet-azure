...
// GetTerraformResourceIDField returns Terraform identifier field for this CenterAssessmentMetadata
func (tr *CenterAssessmentMetadata) GetTerraformResourceIDField() string {
	return "id"
}
