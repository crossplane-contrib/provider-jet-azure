...
// GetTerraformResourceIdField returns Terraform identifier field for this SecurityCenterSetting
func (tr *SecurityCenterSetting) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SecurityCenterSetting
func (tr *SecurityCenterSetting) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SecurityCenterSetting
func (tr *SecurityCenterSetting) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SecurityCenterSetting
func (tr *SecurityCenterSetting) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SecurityCenterSetting
func (tr *SecurityCenterSetting) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SecurityCenterSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SecurityCenterSetting) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SecurityCenterSettingParameters{}
