...
// GetTerraformResourceIDField returns Terraform identifier field for this CenterWorkspace
func (tr *CenterWorkspace) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CenterWorkspace using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CenterWorkspace) LateInitialize(attrs []byte) (bool, error) {
	params := &CenterWorkspaceParameters{}
