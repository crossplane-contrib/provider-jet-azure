...
// GetTerraformResourceIDField returns Terraform identifier field for this CenterSetting
func (tr *CenterSetting) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CenterSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CenterSetting) LateInitialize(attrs []byte) (bool, error) {
	params := &CenterSettingParameters{}
