...
var (
	CenterContactKind             = "CenterContact"
	CenterContactGroupKind        = schema.GroupKind{Group: Group, Kind: CenterContactKind}.String()
	CenterContactKindAPIVersion   = CenterContactKind + "." + GroupVersion.String()
	CenterContactGroupVersionKind = GroupVersion.WithKind(CenterContactKind)
)
