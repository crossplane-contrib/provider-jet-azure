...
// GetTerraformResourceIDField returns Terraform identifier field for this CenterSubscriptionPricing
func (tr *CenterSubscriptionPricing) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CenterSubscriptionPricing using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CenterSubscriptionPricing) LateInitialize(attrs []byte) (bool, error) {
	params := &CenterSubscriptionPricingParameters{}
