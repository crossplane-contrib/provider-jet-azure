...
// GetTerraformResourceIdField returns Terraform identifier field for this SecurityCenterAssessmentPolicy
func (tr *SecurityCenterAssessmentPolicy) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SecurityCenterAssessmentPolicy
func (tr *SecurityCenterAssessmentPolicy) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SecurityCenterAssessmentPolicy
func (tr *SecurityCenterAssessmentPolicy) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SecurityCenterAssessmentPolicy
func (tr *SecurityCenterAssessmentPolicy) GetParameters() ([]byte, error) {
...
func (tr *SecurityCenterAssessmentPolicy) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SecurityCenterAssessmentPolicyParameters{}
