...
var (
	CenterSubscriptionPricingKind             = "CenterSubscriptionPricing"
	CenterSubscriptionPricingGroupKind        = schema.GroupKind{Group: Group, Kind: CenterSubscriptionPricingKind}.String()
	CenterSubscriptionPricingKindAPIVersion   = CenterSubscriptionPricingKind + "." + GroupVersion.String()
	CenterSubscriptionPricingGroupVersionKind = GroupVersion.WithKind(CenterSubscriptionPricingKind)
)
