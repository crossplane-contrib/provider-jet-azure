...
// GetTerraformResourceIdField returns Terraform identifier field for this SecurityCenterWorkspace
func (tr *SecurityCenterWorkspace) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SecurityCenterWorkspace
func (tr *SecurityCenterWorkspace) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SecurityCenterWorkspace
func (tr *SecurityCenterWorkspace) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SecurityCenterWorkspace
func (tr *SecurityCenterWorkspace) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SecurityCenterWorkspace
func (tr *SecurityCenterWorkspace) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SecurityCenterWorkspace using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SecurityCenterWorkspace) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SecurityCenterWorkspaceParameters{}
