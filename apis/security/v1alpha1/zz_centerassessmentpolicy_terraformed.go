...
// GetTerraformResourceIDField returns Terraform identifier field for this CenterAssessmentPolicy
func (tr *CenterAssessmentPolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CenterAssessmentPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CenterAssessmentPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &CenterAssessmentPolicyParameters{}
