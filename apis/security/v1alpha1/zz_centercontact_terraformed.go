...
// GetTerraformResourceIDField returns Terraform identifier field for this CenterContact
func (tr *CenterContact) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CenterContact using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CenterContact) LateInitialize(attrs []byte) (bool, error) {
	params := &CenterContactParameters{}
