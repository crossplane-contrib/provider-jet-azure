...
// GetTerraformResourceIdField returns Terraform identifier field for this SecurityCenterAutoProvisioning
func (tr *SecurityCenterAutoProvisioning) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SecurityCenterAutoProvisioning
func (tr *SecurityCenterAutoProvisioning) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SecurityCenterAutoProvisioning
func (tr *SecurityCenterAutoProvisioning) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SecurityCenterAutoProvisioning
func (tr *SecurityCenterAutoProvisioning) GetParameters() ([]byte, error) {
...
func (tr *SecurityCenterAutoProvisioning) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SecurityCenterAutoProvisioningParameters{}
