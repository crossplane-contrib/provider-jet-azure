...
var (
	CenterAssessmentPolicyKind             = "CenterAssessmentPolicy"
	CenterAssessmentPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: CenterAssessmentPolicyKind}.String()
	CenterAssessmentPolicyKindAPIVersion   = CenterAssessmentPolicyKind + "." + GroupVersion.String()
	CenterAssessmentPolicyGroupVersionKind = GroupVersion.WithKind(CenterAssessmentPolicyKind)
)
