...
// GetTerraformResourceIdField returns Terraform identifier field for this SecurityCenterAssessment
func (tr *SecurityCenterAssessment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SecurityCenterAssessment
func (tr *SecurityCenterAssessment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SecurityCenterAssessment
func (tr *SecurityCenterAssessment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SecurityCenterAssessment
func (tr *SecurityCenterAssessment) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SecurityCenterAssessment
func (tr *SecurityCenterAssessment) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SecurityCenterAssessment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SecurityCenterAssessment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SecurityCenterAssessmentParameters{}
