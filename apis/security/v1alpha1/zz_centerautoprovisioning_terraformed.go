...
// GetTerraformResourceIDField returns Terraform identifier field for this CenterAutoProvisioning
func (tr *CenterAutoProvisioning) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CenterAutoProvisioning using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CenterAutoProvisioning) LateInitialize(attrs []byte) (bool, error) {
	params := &CenterAutoProvisioningParameters{}
