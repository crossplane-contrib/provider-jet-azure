...
// GetTerraformResourceIDField returns Terraform identifier field for this GroupSubscriptionAssociation
func (tr *GroupSubscriptionAssociation) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this GroupSubscriptionAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GroupSubscriptionAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &GroupSubscriptionAssociationParameters{}
