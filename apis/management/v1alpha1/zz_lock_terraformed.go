...
// GetTerraformResourceIDField returns Terraform identifier field for this Lock
func (tr *Lock) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this Lock using its observed tfState.
