...
var (
	GroupSubscriptionAssociationKind             = "GroupSubscriptionAssociation"
	GroupSubscriptionAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: GroupSubscriptionAssociationKind}.String()
	GroupSubscriptionAssociationKindAPIVersion   = GroupSubscriptionAssociationKind + "." + GroupVersion.String()
	GroupSubscriptionAssociationGroupVersionKind = GroupVersion.WithKind(GroupSubscriptionAssociationKind)
)
