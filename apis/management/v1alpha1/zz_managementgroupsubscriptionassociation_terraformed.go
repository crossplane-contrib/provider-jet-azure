...
// GetTerraformResourceIdField returns Terraform identifier field for this ManagementGroupSubscriptionAssociation
func (tr *ManagementGroupSubscriptionAssociation) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ManagementGroupSubscriptionAssociation
func (tr *ManagementGroupSubscriptionAssociation) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ManagementGroupSubscriptionAssociation
func (tr *ManagementGroupSubscriptionAssociation) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ManagementGroupSubscriptionAssociation
func (tr *ManagementGroupSubscriptionAssociation) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ManagementGroupSubscriptionAssociation
func (tr *ManagementGroupSubscriptionAssociation) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ManagementGroupSubscriptionAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementGroupSubscriptionAssociation) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ManagementGroupSubscriptionAssociationParameters{}
