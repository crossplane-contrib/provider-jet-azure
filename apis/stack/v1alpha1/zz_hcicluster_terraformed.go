...
// GetTerraformResourceIDField returns Terraform identifier field for this HciCluster
func (tr *HciCluster) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this HciCluster using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HciCluster) LateInitialize(attrs []byte) (bool, error) {
	params := &HciClusterParameters{}
