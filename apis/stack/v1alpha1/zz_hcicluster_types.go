...
var (
	HciClusterKind             = "HciCluster"
	HciClusterGroupKind        = schema.GroupKind{Group: Group, Kind: HciClusterKind}.String()
	HciClusterKindAPIVersion   = HciClusterKind + "." + GroupVersion.String()
	HciClusterGroupVersionKind = GroupVersion.WithKind(HciClusterKind)
)
