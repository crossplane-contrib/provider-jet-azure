...
// GetTerraformResourceIdField returns Terraform identifier field for this SubnetNatGatewayAssociation
func (tr *SubnetNatGatewayAssociation) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SubnetNatGatewayAssociation
func (tr *SubnetNatGatewayAssociation) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SubnetNatGatewayAssociation
func (tr *SubnetNatGatewayAssociation) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SubnetNatGatewayAssociation
func (tr *SubnetNatGatewayAssociation) GetParameters() ([]byte, error) {
...
func (tr *SubnetNatGatewayAssociation) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SubnetNatGatewayAssociationParameters{}
