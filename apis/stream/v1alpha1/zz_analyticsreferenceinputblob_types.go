...
var (
	AnalyticsReferenceInputBlobKind             = "AnalyticsReferenceInputBlob"
	AnalyticsReferenceInputBlobGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsReferenceInputBlobKind}.String()
	AnalyticsReferenceInputBlobKindAPIVersion   = AnalyticsReferenceInputBlobKind + "." + GroupVersion.String()
	AnalyticsReferenceInputBlobGroupVersionKind = GroupVersion.WithKind(AnalyticsReferenceInputBlobKind)
)
