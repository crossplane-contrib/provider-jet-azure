...
var (
	AnalyticsStreamInputIothubKind             = "AnalyticsStreamInputIothub"
	AnalyticsStreamInputIothubGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsStreamInputIothubKind}.String()
	AnalyticsStreamInputIothubKindAPIVersion   = AnalyticsStreamInputIothubKind + "." + GroupVersion.String()
	AnalyticsStreamInputIothubGroupVersionKind = GroupVersion.WithKind(AnalyticsStreamInputIothubKind)
)
