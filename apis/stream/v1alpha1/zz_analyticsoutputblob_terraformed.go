...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsOutputBlob
func (tr *AnalyticsOutputBlob) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsOutputBlob using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsOutputBlob) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsOutputBlobParameters{}
