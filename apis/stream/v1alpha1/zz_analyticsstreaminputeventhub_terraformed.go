...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsStreamInputEventhub
func (tr *AnalyticsStreamInputEventhub) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsStreamInputEventhub using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsStreamInputEventhub) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsStreamInputEventhubParameters{}
