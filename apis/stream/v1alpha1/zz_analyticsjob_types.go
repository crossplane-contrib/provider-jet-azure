...
var (
	AnalyticsJobKind             = "AnalyticsJob"
	AnalyticsJobGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsJobKind}.String()
	AnalyticsJobKindAPIVersion   = AnalyticsJobKind + "." + GroupVersion.String()
	AnalyticsJobGroupVersionKind = GroupVersion.WithKind(AnalyticsJobKind)
)
