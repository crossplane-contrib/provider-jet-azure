...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsOutputServicebusQueue
func (tr *AnalyticsOutputServicebusQueue) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsOutputServicebusQueue using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsOutputServicebusQueue) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsOutputServicebusQueueParameters{}
