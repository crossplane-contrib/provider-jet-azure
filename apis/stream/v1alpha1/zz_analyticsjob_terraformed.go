...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsJob
func (tr *AnalyticsJob) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsJob using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsJob) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsJobParameters{}
