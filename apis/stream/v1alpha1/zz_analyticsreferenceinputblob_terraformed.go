...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsReferenceInputBlob
func (tr *AnalyticsReferenceInputBlob) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsReferenceInputBlob using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsReferenceInputBlob) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsReferenceInputBlobParameters{}
