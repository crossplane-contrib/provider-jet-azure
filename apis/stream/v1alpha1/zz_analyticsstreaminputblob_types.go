...
var (
	AnalyticsStreamInputBlobKind             = "AnalyticsStreamInputBlob"
	AnalyticsStreamInputBlobGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsStreamInputBlobKind}.String()
	AnalyticsStreamInputBlobKindAPIVersion   = AnalyticsStreamInputBlobKind + "." + GroupVersion.String()
	AnalyticsStreamInputBlobGroupVersionKind = GroupVersion.WithKind(AnalyticsStreamInputBlobKind)
)
