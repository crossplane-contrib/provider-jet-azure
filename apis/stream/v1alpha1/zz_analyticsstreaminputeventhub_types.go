...
var (
	AnalyticsStreamInputEventhubKind             = "AnalyticsStreamInputEventhub"
	AnalyticsStreamInputEventhubGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsStreamInputEventhubKind}.String()
	AnalyticsStreamInputEventhubKindAPIVersion   = AnalyticsStreamInputEventhubKind + "." + GroupVersion.String()
	AnalyticsStreamInputEventhubGroupVersionKind = GroupVersion.WithKind(AnalyticsStreamInputEventhubKind)
)
