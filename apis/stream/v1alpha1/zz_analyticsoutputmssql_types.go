...
var (
	AnalyticsOutputMssqlKind             = "AnalyticsOutputMssql"
	AnalyticsOutputMssqlGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsOutputMssqlKind}.String()
	AnalyticsOutputMssqlKindAPIVersion   = AnalyticsOutputMssqlKind + "." + GroupVersion.String()
	AnalyticsOutputMssqlGroupVersionKind = GroupVersion.WithKind(AnalyticsOutputMssqlKind)
)
