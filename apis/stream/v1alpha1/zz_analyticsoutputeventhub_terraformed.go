...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsOutputEventhub
func (tr *AnalyticsOutputEventhub) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsOutputEventhub using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsOutputEventhub) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsOutputEventhubParameters{}
