...
var (
	AnalyticsOutputServicebusQueueKind             = "AnalyticsOutputServicebusQueue"
	AnalyticsOutputServicebusQueueGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsOutputServicebusQueueKind}.String()
	AnalyticsOutputServicebusQueueKindAPIVersion   = AnalyticsOutputServicebusQueueKind + "." + GroupVersion.String()
	AnalyticsOutputServicebusQueueGroupVersionKind = GroupVersion.WithKind(AnalyticsOutputServicebusQueueKind)
)
