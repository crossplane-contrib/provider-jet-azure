...
var (
	AnalyticsFunctionJavascriptUdfKind             = "AnalyticsFunctionJavascriptUdf"
	AnalyticsFunctionJavascriptUdfGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsFunctionJavascriptUdfKind}.String()
	AnalyticsFunctionJavascriptUdfKindAPIVersion   = AnalyticsFunctionJavascriptUdfKind + "." + GroupVersion.String()
	AnalyticsFunctionJavascriptUdfGroupVersionKind = GroupVersion.WithKind(AnalyticsFunctionJavascriptUdfKind)
)
