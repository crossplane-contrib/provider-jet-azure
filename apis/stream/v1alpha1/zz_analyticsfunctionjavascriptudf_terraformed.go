...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsFunctionJavascriptUdf
func (tr *AnalyticsFunctionJavascriptUdf) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsFunctionJavascriptUdf using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsFunctionJavascriptUdf) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsFunctionJavascriptUdfParameters{}
