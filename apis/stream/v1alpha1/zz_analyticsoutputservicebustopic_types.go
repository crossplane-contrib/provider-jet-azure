...
var (
	AnalyticsOutputServicebusTopicKind             = "AnalyticsOutputServicebusTopic"
	AnalyticsOutputServicebusTopicGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyticsOutputServicebusTopicKind}.String()
	AnalyticsOutputServicebusTopicKindAPIVersion   = AnalyticsOutputServicebusTopicKind + "." + GroupVersion.String()
	AnalyticsOutputServicebusTopicGroupVersionKind = GroupVersion.WithKind(AnalyticsOutputServicebusTopicKind)
)
