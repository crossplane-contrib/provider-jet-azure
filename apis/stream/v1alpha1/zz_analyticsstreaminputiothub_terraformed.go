...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsStreamInputIothub
func (tr *AnalyticsStreamInputIothub) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsStreamInputIothub using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsStreamInputIothub) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsStreamInputIothubParameters{}
