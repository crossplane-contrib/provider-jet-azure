...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsOutputMssql
func (tr *AnalyticsOutputMssql) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsOutputMssql using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsOutputMssql) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsOutputMssqlParameters{}
