...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsStreamInputBlob
func (tr *AnalyticsStreamInputBlob) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyticsStreamInputBlob using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyticsStreamInputBlob) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyticsStreamInputBlobParameters{}
