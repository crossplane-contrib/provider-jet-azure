...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyticsOutputServicebusTopic
func (tr *AnalyticsOutputServicebusTopic) GetTerraformResourceIDField() string {
	return "id"
}
