...
// GetTerraformResourceIdField returns Terraform identifier field for this LinuxVirtualMachine
func (tr *LinuxVirtualMachine) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LinuxVirtualMachine
func (tr *LinuxVirtualMachine) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LinuxVirtualMachine
func (tr *LinuxVirtualMachine) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LinuxVirtualMachine
func (tr *LinuxVirtualMachine) GetParameters() ([]byte, error) {
...
func (tr *LinuxVirtualMachine) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LinuxVirtualMachineParameters{}
