...
func (tr *LinuxVirtualMachineScaleSet) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LinuxVirtualMachineScaleSet
func (tr *LinuxVirtualMachineScaleSet) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LinuxVirtualMachineScaleSet
func (tr *LinuxVirtualMachineScaleSet) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this LinuxVirtualMachineScaleSet
func (tr *LinuxVirtualMachineScaleSet) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this LinuxVirtualMachineScaleSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LinuxVirtualMachineScaleSet) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LinuxVirtualMachineScaleSetParameters{}
