...
var (
	Access_Kind             = "Access"
	Access_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Access_Kind}.String()
	Access_KindAPIVersion   = Access_Kind + "." + CRDGroupVersion.String()
	Access_GroupVersionKind = CRDGroupVersion.WithKind(Access_Kind)
)
