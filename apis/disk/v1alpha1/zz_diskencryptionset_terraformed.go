...
// GetTerraformResourceIdField returns Terraform identifier field for this DiskEncryptionSet
func (tr *DiskEncryptionSet) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DiskEncryptionSet
func (tr *DiskEncryptionSet) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DiskEncryptionSet
func (tr *DiskEncryptionSet) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DiskEncryptionSet
func (tr *DiskEncryptionSet) GetParameters() ([]byte, error) {
...
func (tr *DiskEncryptionSet) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DiskEncryptionSetParameters{}
