...
var (
	EncryptionSet_Kind             = "EncryptionSet"
	EncryptionSet_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EncryptionSet_Kind}.String()
	EncryptionSet_KindAPIVersion   = EncryptionSet_Kind + "." + CRDGroupVersion.String()
	EncryptionSet_GroupVersionKind = CRDGroupVersion.WithKind(EncryptionSet_Kind)
)
