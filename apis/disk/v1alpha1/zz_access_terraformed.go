...
// GetTerraformResourceIDField returns Terraform identifier field for this Access
func (tr *Access) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this Access using its observed tfState.
