...
// GetTerraformResourceIDField returns Terraform identifier field for this EncryptionSet
func (tr *EncryptionSet) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this EncryptionSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EncryptionSet) LateInitialize(attrs []byte) (bool, error) {
	params := &EncryptionSetParameters{}
