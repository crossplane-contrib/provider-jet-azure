...
var (
	RegistryScopeMapKind             = "RegistryScopeMap"
	RegistryScopeMapGroupKind        = schema.GroupKind{Group: Group, Kind: RegistryScopeMapKind}.String()
	RegistryScopeMapKindAPIVersion   = RegistryScopeMapKind + "." + GroupVersion.String()
	RegistryScopeMapGroupVersionKind = GroupVersion.WithKind(RegistryScopeMapKind)
)
