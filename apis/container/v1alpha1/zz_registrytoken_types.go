...
var (
	RegistryTokenKind             = "RegistryToken"
	RegistryTokenGroupKind        = schema.GroupKind{Group: Group, Kind: RegistryTokenKind}.String()
	RegistryTokenKindAPIVersion   = RegistryTokenKind + "." + GroupVersion.String()
	RegistryTokenGroupVersionKind = GroupVersion.WithKind(RegistryTokenKind)
)
