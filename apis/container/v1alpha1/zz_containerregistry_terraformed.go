...
// GetTerraformResourceIDField returns Terraform identifier field for this ContainerRegistry
func (tr *ContainerRegistry) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *ContainerRegistry) GetObservation() (map[string]interface{}, error) {
...
func (tr *ContainerRegistry) SetObservation(obs map[string]interface{}) error {
...
func (tr *ContainerRegistry) GetParameters() (map[string]interface{}, error) {
...
func (tr *ContainerRegistry) SetParameters(params map[string]interface{}) error {
