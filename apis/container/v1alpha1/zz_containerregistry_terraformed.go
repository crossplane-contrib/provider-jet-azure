...
func (tr *ContainerRegistry) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ContainerRegistry
func (tr *ContainerRegistry) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ContainerRegistry
func (tr *ContainerRegistry) GetParameters() ([]byte, error) {
...
func (tr *ContainerRegistry) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ContainerRegistryParameters{}
