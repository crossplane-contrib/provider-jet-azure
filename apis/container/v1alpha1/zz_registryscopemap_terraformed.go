...
// GetTerraformResourceIDField returns Terraform identifier field for this RegistryScopeMap
func (tr *RegistryScopeMap) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RegistryScopeMap using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RegistryScopeMap) LateInitialize(attrs []byte) (bool, error) {
	params := &RegistryScopeMapParameters{}
