...
// GetTerraformResourceIdField returns Terraform identifier field for this HealthcareService
func (tr *HealthcareService) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this HealthcareService
func (tr *HealthcareService) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this HealthcareService
func (tr *HealthcareService) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this HealthcareService
func (tr *HealthcareService) GetParameters() ([]byte, error) {
...
func (tr *HealthcareService) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &HealthcareServiceParameters{}
