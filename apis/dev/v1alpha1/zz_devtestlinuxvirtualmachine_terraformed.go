...
// GetConnectionDetailsMapping for this DevTestLinuxVirtualMachine
func (tr *DevTestLinuxVirtualMachine) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"password": "spec.forProvider.passwordSecretRef"}
}

// GetObservation of this DevTestLinuxVirtualMachine
func (tr *DevTestLinuxVirtualMachine) GetObservation() (map[string]interface{}, error) {
...
func (tr *DevTestLinuxVirtualMachine) SetObservation(obs map[string]interface{}) error {
...
func (tr *DevTestLinuxVirtualMachine) GetParameters() (map[string]interface{}, error) {
...
func (tr *DevTestLinuxVirtualMachine) SetParameters(params map[string]interface{}) error {
...
func (tr *DevTestLinuxVirtualMachine) LateInitialize(attrs []byte) (bool, error) {
	params := &DevTestLinuxVirtualMachineParameters{}
...
func (tr *DevTestLinuxVirtualMachine) GetTerraformSchemaVersion() int {
	return 0
}
