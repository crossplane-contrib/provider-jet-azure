...
var (
	TestGlobalVmShutdownScheduleKind             = "TestGlobalVmShutdownSchedule"
	TestGlobalVmShutdownScheduleGroupKind        = schema.GroupKind{Group: Group, Kind: TestGlobalVmShutdownScheduleKind}.String()
	TestGlobalVmShutdownScheduleKindAPIVersion   = TestGlobalVmShutdownScheduleKind + "." + GroupVersion.String()
	TestGlobalVmShutdownScheduleGroupVersionKind = GroupVersion.WithKind(TestGlobalVmShutdownScheduleKind)
)
