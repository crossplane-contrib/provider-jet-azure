...
var (
	TestScheduleKind             = "TestSchedule"
	TestScheduleGroupKind        = schema.GroupKind{Group: Group, Kind: TestScheduleKind}.String()
	TestScheduleKindAPIVersion   = TestScheduleKind + "." + GroupVersion.String()
	TestScheduleGroupVersionKind = GroupVersion.WithKind(TestScheduleKind)
)
