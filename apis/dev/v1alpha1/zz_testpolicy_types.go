...
var (
	TestPolicyKind             = "TestPolicy"
	TestPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TestPolicyKind}.String()
	TestPolicyKindAPIVersion   = TestPolicyKind + "." + GroupVersion.String()
	TestPolicyGroupVersionKind = GroupVersion.WithKind(TestPolicyKind)
)
