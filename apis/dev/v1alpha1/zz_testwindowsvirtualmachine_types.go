...
var (
	TestWindowsVirtualMachineKind             = "TestWindowsVirtualMachine"
	TestWindowsVirtualMachineGroupKind        = schema.GroupKind{Group: Group, Kind: TestWindowsVirtualMachineKind}.String()
	TestWindowsVirtualMachineKindAPIVersion   = TestWindowsVirtualMachineKind + "." + GroupVersion.String()
	TestWindowsVirtualMachineGroupVersionKind = GroupVersion.WithKind(TestWindowsVirtualMachineKind)
)
