...
var (
	DirectoryDomainServiceKind             = "DirectoryDomainService"
	DirectoryDomainServiceGroupKind        = schema.GroupKind{Group: Group, Kind: DirectoryDomainServiceKind}.String()
	DirectoryDomainServiceKindAPIVersion   = DirectoryDomainServiceKind + "." + GroupVersion.String()
	DirectoryDomainServiceGroupVersionKind = GroupVersion.WithKind(DirectoryDomainServiceKind)
)
