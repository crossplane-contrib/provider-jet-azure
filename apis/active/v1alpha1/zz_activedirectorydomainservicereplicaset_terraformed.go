...
// GetTerraformResourceIdField returns Terraform identifier field for this ActiveDirectoryDomainServiceReplicaSet
func (tr *ActiveDirectoryDomainServiceReplicaSet) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ActiveDirectoryDomainServiceReplicaSet
func (tr *ActiveDirectoryDomainServiceReplicaSet) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ActiveDirectoryDomainServiceReplicaSet
func (tr *ActiveDirectoryDomainServiceReplicaSet) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ActiveDirectoryDomainServiceReplicaSet
func (tr *ActiveDirectoryDomainServiceReplicaSet) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ActiveDirectoryDomainServiceReplicaSet
func (tr *ActiveDirectoryDomainServiceReplicaSet) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ActiveDirectoryDomainServiceReplicaSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ActiveDirectoryDomainServiceReplicaSet) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ActiveDirectoryDomainServiceReplicaSetParameters{}
