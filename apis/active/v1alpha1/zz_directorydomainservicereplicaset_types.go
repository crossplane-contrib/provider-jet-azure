...
var (
	DirectoryDomainServiceReplicaSetKind             = "DirectoryDomainServiceReplicaSet"
	DirectoryDomainServiceReplicaSetGroupKind        = schema.GroupKind{Group: Group, Kind: DirectoryDomainServiceReplicaSetKind}.String()
	DirectoryDomainServiceReplicaSetKindAPIVersion   = DirectoryDomainServiceReplicaSetKind + "." + GroupVersion.String()
	DirectoryDomainServiceReplicaSetGroupVersionKind = GroupVersion.WithKind(DirectoryDomainServiceReplicaSetKind)
)
