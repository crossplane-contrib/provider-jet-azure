...
// GetTerraformResourceIDField returns Terraform identifier field for this DirectoryDomainServiceReplicaSet
func (tr *DirectoryDomainServiceReplicaSet) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this DirectoryDomainServiceReplicaSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DirectoryDomainServiceReplicaSet) LateInitialize(attrs []byte) (bool, error) {
	params := &DirectoryDomainServiceReplicaSetParameters{}
