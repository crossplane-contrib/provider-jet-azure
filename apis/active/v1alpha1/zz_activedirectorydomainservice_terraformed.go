...
// GetTerraformResourceIdField returns Terraform identifier field for this ActiveDirectoryDomainService
func (tr *ActiveDirectoryDomainService) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ActiveDirectoryDomainService
func (tr *ActiveDirectoryDomainService) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ActiveDirectoryDomainService
func (tr *ActiveDirectoryDomainService) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ActiveDirectoryDomainService
func (tr *ActiveDirectoryDomainService) GetParameters() ([]byte, error) {
...
// LateInitialize this ActiveDirectoryDomainService using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ActiveDirectoryDomainService) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ActiveDirectoryDomainServiceParameters{}
