...
func (in *AddonProfileObservation) DeepCopyInto(out *AddonProfileObservation) {
	*out = *in
	if in.HTTPApplicationRouting != nil {
		...
		*out = make([]HTTPApplicationRoutingObservation, len(*in))
		for i := range *in {
...
func (in *AddonProfileParameters) DeepCopyInto(out *AddonProfileParameters) {
	*out = *in
	...
	if in.OpenServiceMesh != nil {
		in, out := &in.OpenServiceMesh, &out.OpenServiceMesh
		*out = make([]OpenServiceMeshParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KubernetesClusterObservation) DeepCopyInto(out *KubernetesClusterObservation) {
	*out = *in
	if in.AddonProfile != nil {
		...
		*out = make([]AddonProfileObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenServiceMeshObservation) DeepCopyInto(out *OpenServiceMeshObservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenServiceMeshObservation.
func (in *OpenServiceMeshObservation) DeepCopy() *OpenServiceMeshObservation {
	if in == nil {
		return nil
	}
	out := new(OpenServiceMeshObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenServiceMeshParameters) DeepCopyInto(out *OpenServiceMeshParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenServiceMeshParameters.
func (in *OpenServiceMeshParameters) DeepCopy() *OpenServiceMeshParameters {
	if in == nil {
		return nil
	}
	out := new(OpenServiceMeshParameters)
	in.DeepCopyInto(out)
	return out
}
