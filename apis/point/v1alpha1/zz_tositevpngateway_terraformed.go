...
// GetTerraformResourceIDField returns Terraform identifier field for this ToSiteVpnGateway
func (tr *ToSiteVpnGateway) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ToSiteVpnGateway using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ToSiteVpnGateway) LateInitialize(attrs []byte) (bool, error) {
	params := &ToSiteVpnGatewayParameters{}
