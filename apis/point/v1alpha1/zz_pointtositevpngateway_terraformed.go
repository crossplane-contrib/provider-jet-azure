...
// GetTerraformResourceIdField returns Terraform identifier field for this PointToSiteVpnGateway
func (tr *PointToSiteVpnGateway) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PointToSiteVpnGateway
func (tr *PointToSiteVpnGateway) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PointToSiteVpnGateway
func (tr *PointToSiteVpnGateway) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PointToSiteVpnGateway
func (tr *PointToSiteVpnGateway) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PointToSiteVpnGateway
func (tr *PointToSiteVpnGateway) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PointToSiteVpnGateway using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PointToSiteVpnGateway) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PointToSiteVpnGatewayParameters{}
