...
var (
	ToSiteVpnGatewayKind             = "ToSiteVpnGateway"
	ToSiteVpnGatewayGroupKind        = schema.GroupKind{Group: Group, Kind: ToSiteVpnGatewayKind}.String()
	ToSiteVpnGatewayKindAPIVersion   = ToSiteVpnGatewayKind + "." + GroupVersion.String()
	ToSiteVpnGatewayGroupVersionKind = GroupVersion.WithKind(ToSiteVpnGatewayKind)
)
