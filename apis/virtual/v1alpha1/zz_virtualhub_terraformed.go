...
// GetTerraformResourceIdField returns Terraform identifier field for this VirtualHub
func (tr *VirtualHub) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this VirtualHub
func (tr *VirtualHub) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this VirtualHub
func (tr *VirtualHub) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this VirtualHub
func (tr *VirtualHub) GetParameters() ([]byte, error) {
...
func (tr *VirtualHub) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VirtualHubParameters{}
