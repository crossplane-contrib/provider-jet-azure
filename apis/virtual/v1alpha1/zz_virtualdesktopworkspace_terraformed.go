...
func (tr *VirtualDesktopWorkspace) GetObservation() (map[string]interface{}, error) {
...
func (tr *VirtualDesktopWorkspace) SetObservation(obs map[string]interface{}) error {
...
func (tr *VirtualDesktopWorkspace) GetParameters() (map[string]interface{}, error) {
...
func (tr *VirtualDesktopWorkspace) SetParameters(params map[string]interface{}) error {
