...
func (tr *VirtualHubConnection) GetObservation() (map[string]interface{}, error) {
...
func (tr *VirtualHubConnection) SetObservation(obs map[string]interface{}) error {
...
func (tr *VirtualHubConnection) GetParameters() (map[string]interface{}, error) {
...
func (tr *VirtualHubConnection) SetParameters(params map[string]interface{}) error {
...
func (tr *VirtualHubConnection) LateInitialize(attrs []byte) (bool, error) {
	params := &VirtualHubConnectionParameters{}
