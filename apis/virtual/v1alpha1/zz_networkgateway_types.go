...
var (
	NetworkGatewayKind             = "NetworkGateway"
	NetworkGatewayGroupKind        = schema.GroupKind{Group: Group, Kind: NetworkGatewayKind}.String()
	NetworkGatewayKindAPIVersion   = NetworkGatewayKind + "." + GroupVersion.String()
	NetworkGatewayGroupVersionKind = GroupVersion.WithKind(NetworkGatewayKind)
)
