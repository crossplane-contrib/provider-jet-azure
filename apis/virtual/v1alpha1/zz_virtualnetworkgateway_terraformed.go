...
// GetTerraformResourceIdField returns Terraform identifier field for this VirtualNetworkGateway
func (tr *VirtualNetworkGateway) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this VirtualNetworkGateway
func (tr *VirtualNetworkGateway) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this VirtualNetworkGateway
func (tr *VirtualNetworkGateway) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this VirtualNetworkGateway
func (tr *VirtualNetworkGateway) GetParameters() ([]byte, error) {
...
func (tr *VirtualNetworkGateway) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VirtualNetworkGatewayParameters{}
