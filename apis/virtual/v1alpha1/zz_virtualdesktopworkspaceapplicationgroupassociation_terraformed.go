...
func (tr *VirtualDesktopWorkspaceApplicationGroupAssociation) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VirtualDesktopWorkspaceApplicationGroupAssociationParameters{}
