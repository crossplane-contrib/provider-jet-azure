...
func (tr *VirtualDesktopWorkspaceApplicationGroupAssociation) GetObservation() (map[string]interface{}, error) {
...
func (tr *VirtualDesktopWorkspaceApplicationGroupAssociation) SetObservation(obs map[string]interface{}) error {
...
func (tr *VirtualDesktopWorkspaceApplicationGroupAssociation) GetParameters() (map[string]interface{}, error) {
...
func (tr *VirtualDesktopWorkspaceApplicationGroupAssociation) SetParameters(params map[string]interface{}) error {
