...
// GetTerraformResourceIdField returns Terraform identifier field for this VirtualMachineScaleSet
func (tr *VirtualMachineScaleSet) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this VirtualMachineScaleSet
func (tr *VirtualMachineScaleSet) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this VirtualMachineScaleSet
func (tr *VirtualMachineScaleSet) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this VirtualMachineScaleSet
func (tr *VirtualMachineScaleSet) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this VirtualMachineScaleSet
func (tr *VirtualMachineScaleSet) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this VirtualMachineScaleSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VirtualMachineScaleSet) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VirtualMachineScaleSetParameters{}
