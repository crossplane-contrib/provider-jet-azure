...
// Wan is the Schema for the Wans API
...
var (
	WanKind             = "Wan"
	WanGroupKind        = schema.GroupKind{Group: Group, Kind: WanKind}.String()
	WanKindAPIVersion   = WanKind + "." + GroupVersion.String()
	WanGroupVersionKind = GroupVersion.WithKind(WanKind)
)
