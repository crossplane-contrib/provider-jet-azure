...
// GetTerraformResourceIdField returns Terraform identifier field for this VirtualDesktopApplication
func (tr *VirtualDesktopApplication) GetTerraformResourceIdField() string {
	return "id"
}
...
func (tr *VirtualDesktopApplication) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VirtualDesktopApplicationParameters{}
