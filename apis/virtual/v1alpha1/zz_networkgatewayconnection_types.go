...
type NetworkGatewayConnectionObservation struct {
}

type NetworkGatewayConnectionParameters struct {
...
// NetworkGatewayConnectionSpec defines the desired state of NetworkGatewayConnection
type NetworkGatewayConnectionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     NetworkGatewayConnectionParameters `json:"forProvider"`
}

// NetworkGatewayConnectionStatus defines the observed state of NetworkGatewayConnection.
type NetworkGatewayConnectionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        NetworkGatewayConnectionObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// NetworkGatewayConnection is the Schema for the NetworkGatewayConnections API
...
type NetworkGatewayConnection struct {
	...
	Spec              NetworkGatewayConnectionSpec   `json:"spec"`
	Status            NetworkGatewayConnectionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// NetworkGatewayConnectionList contains a list of NetworkGatewayConnections
type NetworkGatewayConnectionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []NetworkGatewayConnection `json:"items"`
}

// Repository type metadata.
var (
	NetworkGatewayConnectionKind             = "NetworkGatewayConnection"
	NetworkGatewayConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: NetworkGatewayConnectionKind}.String()
	NetworkGatewayConnectionKindAPIVersion   = NetworkGatewayConnectionKind + "." + GroupVersion.String()
	NetworkGatewayConnectionGroupVersionKind = GroupVersion.WithKind(NetworkGatewayConnectionKind)
)

func init() {
	SchemeBuilder.Register(&NetworkGatewayConnection{}, &NetworkGatewayConnectionList{})
}
