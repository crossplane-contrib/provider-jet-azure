...
func (tr *Dashboard) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this Dashboard
func (tr *Dashboard) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this Dashboard
func (tr *Dashboard) GetParameters() ([]byte, error) {
...
func (tr *Dashboard) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DashboardParameters{}
