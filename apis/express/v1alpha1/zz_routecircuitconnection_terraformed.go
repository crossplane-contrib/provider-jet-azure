...
// GetTerraformResourceIDField returns Terraform identifier field for this RouteCircuitConnection
func (tr *RouteCircuitConnection) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RouteCircuitConnection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RouteCircuitConnection) LateInitialize(attrs []byte) (bool, error) {
	params := &RouteCircuitConnectionParameters{}
