...
var (
	RouteCircuitPeeringKind             = "RouteCircuitPeering"
	RouteCircuitPeeringGroupKind        = schema.GroupKind{Group: Group, Kind: RouteCircuitPeeringKind}.String()
	RouteCircuitPeeringKindAPIVersion   = RouteCircuitPeeringKind + "." + GroupVersion.String()
	RouteCircuitPeeringGroupVersionKind = GroupVersion.WithKind(RouteCircuitPeeringKind)
)
