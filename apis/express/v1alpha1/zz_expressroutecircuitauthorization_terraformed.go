...
// GetTerraformResourceIdField returns Terraform identifier field for this ExpressRouteCircuitAuthorization
func (tr *ExpressRouteCircuitAuthorization) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ExpressRouteCircuitAuthorization
func (tr *ExpressRouteCircuitAuthorization) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ExpressRouteCircuitAuthorization
func (tr *ExpressRouteCircuitAuthorization) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ExpressRouteCircuitAuthorization
func (tr *ExpressRouteCircuitAuthorization) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ExpressRouteCircuitAuthorization
func (tr *ExpressRouteCircuitAuthorization) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ExpressRouteCircuitAuthorization using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ExpressRouteCircuitAuthorization) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ExpressRouteCircuitAuthorizationParameters{}
