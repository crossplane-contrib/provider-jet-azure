...
// GetTerraformResourceIDField returns Terraform identifier field for this RouteConnection
func (tr *RouteConnection) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RouteConnection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RouteConnection) LateInitialize(attrs []byte) (bool, error) {
	params := &RouteConnectionParameters{}
