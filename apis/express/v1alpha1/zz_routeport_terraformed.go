...
// GetTerraformResourceIDField returns Terraform identifier field for this RoutePort
func (tr *RoutePort) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RoutePort using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RoutePort) LateInitialize(attrs []byte) (bool, error) {
	params := &RoutePortParameters{}
