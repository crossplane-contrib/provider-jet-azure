...
// GetTerraformResourceIdField returns Terraform identifier field for this ExpressRoutePort
func (tr *ExpressRoutePort) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ExpressRoutePort
func (tr *ExpressRoutePort) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ExpressRoutePort
func (tr *ExpressRoutePort) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ExpressRoutePort
func (tr *ExpressRoutePort) GetParameters() ([]byte, error) {
...
func (tr *ExpressRoutePort) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ExpressRoutePortParameters{}
