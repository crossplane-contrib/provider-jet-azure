...
// GetTerraformResourceIdField returns Terraform identifier field for this ExpressRouteCircuit
func (tr *ExpressRouteCircuit) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ExpressRouteCircuit
func (tr *ExpressRouteCircuit) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ExpressRouteCircuit
func (tr *ExpressRouteCircuit) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ExpressRouteCircuit
func (tr *ExpressRouteCircuit) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ExpressRouteCircuit
func (tr *ExpressRouteCircuit) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ExpressRouteCircuit using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ExpressRouteCircuit) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ExpressRouteCircuitParameters{}
