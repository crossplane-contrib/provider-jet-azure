...
// GetTerraformResourceIdField returns Terraform identifier field for this ExpressRouteCircuitPeering
func (tr *ExpressRouteCircuitPeering) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ExpressRouteCircuitPeering
func (tr *ExpressRouteCircuitPeering) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ExpressRouteCircuitPeering
func (tr *ExpressRouteCircuitPeering) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ExpressRouteCircuitPeering
func (tr *ExpressRouteCircuitPeering) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ExpressRouteCircuitPeering
func (tr *ExpressRouteCircuitPeering) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ExpressRouteCircuitPeering using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ExpressRouteCircuitPeering) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ExpressRouteCircuitPeeringParameters{}
