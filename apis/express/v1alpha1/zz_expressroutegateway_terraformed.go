...
// GetTerraformResourceIdField returns Terraform identifier field for this ExpressRouteGateway
func (tr *ExpressRouteGateway) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ExpressRouteGateway
func (tr *ExpressRouteGateway) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ExpressRouteGateway
func (tr *ExpressRouteGateway) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ExpressRouteGateway
func (tr *ExpressRouteGateway) GetParameters() ([]byte, error) {
...
func (tr *ExpressRouteGateway) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ExpressRouteGatewayParameters{}
