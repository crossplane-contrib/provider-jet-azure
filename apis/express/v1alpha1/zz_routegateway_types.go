...
var (
	RouteGatewayKind             = "RouteGateway"
	RouteGatewayGroupKind        = schema.GroupKind{Group: Group, Kind: RouteGatewayKind}.String()
	RouteGatewayKindAPIVersion   = RouteGatewayKind + "." + GroupVersion.String()
	RouteGatewayGroupVersionKind = GroupVersion.WithKind(RouteGatewayKind)
)
