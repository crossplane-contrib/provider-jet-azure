...
// GetTerraformResourceIDField returns Terraform identifier field for this RouteCircuit
func (tr *RouteCircuit) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RouteCircuit using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RouteCircuit) LateInitialize(attrs []byte) (bool, error) {
	params := &RouteCircuitParameters{}
