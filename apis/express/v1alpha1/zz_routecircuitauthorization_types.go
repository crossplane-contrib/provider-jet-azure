...
var (
	RouteCircuitAuthorizationKind             = "RouteCircuitAuthorization"
	RouteCircuitAuthorizationGroupKind        = schema.GroupKind{Group: Group, Kind: RouteCircuitAuthorizationKind}.String()
	RouteCircuitAuthorizationKindAPIVersion   = RouteCircuitAuthorizationKind + "." + GroupVersion.String()
	RouteCircuitAuthorizationGroupVersionKind = GroupVersion.WithKind(RouteCircuitAuthorizationKind)
)
