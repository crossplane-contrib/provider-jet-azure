...
// GetTerraformResourceIDField returns Terraform identifier field for this RouteCircuitPeering
func (tr *RouteCircuitPeering) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RouteCircuitPeering using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RouteCircuitPeering) LateInitialize(attrs []byte) (bool, error) {
	params := &RouteCircuitPeeringParameters{}
