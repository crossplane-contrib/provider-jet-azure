...
// GetTerraformResourceIDField returns Terraform identifier field for this RouteGateway
func (tr *RouteGateway) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RouteGateway using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RouteGateway) LateInitialize(attrs []byte) (bool, error) {
	params := &RouteGatewayParameters{}
