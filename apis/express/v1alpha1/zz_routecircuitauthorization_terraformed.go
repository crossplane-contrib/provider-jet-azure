...
// GetTerraformResourceIDField returns Terraform identifier field for this RouteCircuitAuthorization
func (tr *RouteCircuitAuthorization) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RouteCircuitAuthorization using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RouteCircuitAuthorization) LateInitialize(attrs []byte) (bool, error) {
	params := &RouteCircuitAuthorizationParameters{}
