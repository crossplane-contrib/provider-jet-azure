...
var (
	RouteConnectionKind             = "RouteConnection"
	RouteConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: RouteConnectionKind}.String()
	RouteConnectionKindAPIVersion   = RouteConnectionKind + "." + GroupVersion.String()
	RouteConnectionGroupVersionKind = GroupVersion.WithKind(RouteConnectionKind)
)
