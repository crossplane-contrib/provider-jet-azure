...
// GetTerraformResourceIdField returns Terraform identifier field for this ExpressRouteConnection
func (tr *ExpressRouteConnection) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ExpressRouteConnection
func (tr *ExpressRouteConnection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ExpressRouteConnection
func (tr *ExpressRouteConnection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ExpressRouteConnection
func (tr *ExpressRouteConnection) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ExpressRouteConnection
func (tr *ExpressRouteConnection) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ExpressRouteConnection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ExpressRouteConnection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ExpressRouteConnectionParameters{}
