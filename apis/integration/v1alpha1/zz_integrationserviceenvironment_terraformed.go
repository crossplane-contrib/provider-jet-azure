...
// GetTerraformResourceIdField returns Terraform identifier field for this IntegrationServiceEnvironment
func (tr *IntegrationServiceEnvironment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this IntegrationServiceEnvironment
func (tr *IntegrationServiceEnvironment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IntegrationServiceEnvironment
func (tr *IntegrationServiceEnvironment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IntegrationServiceEnvironment
func (tr *IntegrationServiceEnvironment) GetParameters() ([]byte, error) {
...
func (tr *IntegrationServiceEnvironment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IntegrationServiceEnvironmentParameters{}
