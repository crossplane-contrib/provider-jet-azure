...
var (
	...
	AgreementGroupKind        = schema.GroupKind{Group: Group, Kind: AgreementKind}.String()
	AgreementKindAPIVersion   = AgreementKind + "." + GroupVersion.String()
	AgreementGroupVersionKind = GroupVersion.WithKind(AgreementKind)
)
