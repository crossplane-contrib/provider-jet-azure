...
// GetTerraformResourceIDField returns Terraform identifier field for this Agreement
func (tr *Agreement) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this Agreement using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Agreement) LateInitialize(attrs []byte) (bool, error) {
	params := &AgreementParameters{}
