...
// GetTerraformResourceIDField returns Terraform identifier field for this MarketplaceAgreement
func (tr *MarketplaceAgreement) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *MarketplaceAgreement) GetObservation() (map[string]interface{}, error) {
...
func (tr *MarketplaceAgreement) SetObservation(obs map[string]interface{}) error {
...
func (tr *MarketplaceAgreement) GetParameters() (map[string]interface{}, error) {
...
func (tr *MarketplaceAgreement) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this MarketplaceAgreement using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MarketplaceAgreement) LateInitialize(attrs []byte) (bool, error) {
	params := &MarketplaceAgreementParameters{}
