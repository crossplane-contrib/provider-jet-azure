...
func (tr *MarketplaceAgreement) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MarketplaceAgreement
func (tr *MarketplaceAgreement) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MarketplaceAgreement
func (tr *MarketplaceAgreement) GetParameters() ([]byte, error) {
...
func (tr *MarketplaceAgreement) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MarketplaceAgreementParameters{}
