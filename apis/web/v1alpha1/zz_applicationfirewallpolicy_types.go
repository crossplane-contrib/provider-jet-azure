...
var (
	ApplicationFirewallPolicyKind             = "ApplicationFirewallPolicy"
	ApplicationFirewallPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ApplicationFirewallPolicyKind}.String()
	ApplicationFirewallPolicyKindAPIVersion   = ApplicationFirewallPolicyKind + "." + GroupVersion.String()
	ApplicationFirewallPolicyGroupVersionKind = GroupVersion.WithKind(ApplicationFirewallPolicyKind)
)
