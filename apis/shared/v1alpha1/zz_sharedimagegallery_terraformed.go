...
// GetTerraformResourceIdField returns Terraform identifier field for this SharedImageGallery
func (tr *SharedImageGallery) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SharedImageGallery
func (tr *SharedImageGallery) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SharedImageGallery
func (tr *SharedImageGallery) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SharedImageGallery
func (tr *SharedImageGallery) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SharedImageGallery
func (tr *SharedImageGallery) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SharedImageGallery using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SharedImageGallery) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SharedImageGalleryParameters{}
