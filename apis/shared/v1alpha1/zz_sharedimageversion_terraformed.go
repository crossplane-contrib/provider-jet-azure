...
// GetTerraformResourceIdField returns Terraform identifier field for this SharedImageVersion
func (tr *SharedImageVersion) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SharedImageVersion
func (tr *SharedImageVersion) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SharedImageVersion
func (tr *SharedImageVersion) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SharedImageVersion
func (tr *SharedImageVersion) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SharedImageVersion
func (tr *SharedImageVersion) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SharedImageVersion using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SharedImageVersion) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SharedImageVersionParameters{}
