...
var (
	ImageGalleryKind             = "ImageGallery"
	ImageGalleryGroupKind        = schema.GroupKind{Group: Group, Kind: ImageGalleryKind}.String()
	ImageGalleryKindAPIVersion   = ImageGalleryKind + "." + GroupVersion.String()
	ImageGalleryGroupVersionKind = GroupVersion.WithKind(ImageGalleryKind)
)
