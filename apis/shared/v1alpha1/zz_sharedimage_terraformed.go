...
// GetTerraformResourceIdField returns Terraform identifier field for this SharedImage
func (tr *SharedImage) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SharedImage
func (tr *SharedImage) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SharedImage
func (tr *SharedImage) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SharedImage
func (tr *SharedImage) GetParameters() ([]byte, error) {
...
func (tr *SharedImage) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SharedImageParameters{}
