...
// GetTerraformResourceIdField returns Terraform identifier field for this Subscription
func (tr *Subscription) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this Subscription
func (tr *Subscription) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this Subscription
func (tr *Subscription) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this Subscription
func (tr *Subscription) GetParameters() ([]byte, error) {
...
func (tr *Subscription) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SubscriptionParameters{}
