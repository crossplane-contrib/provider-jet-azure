...
// GetTerraformResourceIDField returns Terraform identifier field for this ServicesServer
func (tr *ServicesServer) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ServicesServer using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ServicesServer) LateInitialize(attrs []byte) (bool, error) {
	params := &ServicesServerParameters{}
