...
// GetTerraformResourceIDField returns Terraform identifier field for this TxtRecord
func (tr *TxtRecord) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this TxtRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TxtRecord) LateInitialize(attrs []byte) (bool, error) {
	params := &TxtRecordParameters{}
