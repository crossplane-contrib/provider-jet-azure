...
// GetTerraformResourceIdField returns Terraform identifier field for this DnsNsRecord
func (tr *DnsNsRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DnsNsRecord
func (tr *DnsNsRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DnsNsRecord
func (tr *DnsNsRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DnsNsRecord
func (tr *DnsNsRecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this DnsNsRecord
func (tr *DnsNsRecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this DnsNsRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DnsNsRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DnsNsRecordParameters{}
