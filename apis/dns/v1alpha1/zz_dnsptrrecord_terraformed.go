...
// GetTerraformResourceIdField returns Terraform identifier field for this DnsPtrRecord
func (tr *DnsPtrRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DnsPtrRecord
func (tr *DnsPtrRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DnsPtrRecord
func (tr *DnsPtrRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DnsPtrRecord
func (tr *DnsPtrRecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this DnsPtrRecord
func (tr *DnsPtrRecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this DnsPtrRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DnsPtrRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DnsPtrRecordParameters{}
