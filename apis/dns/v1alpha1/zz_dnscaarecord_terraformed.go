...
// GetTerraformResourceIdField returns Terraform identifier field for this DnsCaaRecord
func (tr *DnsCaaRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DnsCaaRecord
func (tr *DnsCaaRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DnsCaaRecord
func (tr *DnsCaaRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DnsCaaRecord
func (tr *DnsCaaRecord) GetParameters() ([]byte, error) {
...
func (tr *DnsCaaRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DnsCaaRecordParameters{}
