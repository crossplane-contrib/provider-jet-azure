...
// GetTerraformResourceIDField returns Terraform identifier field for this AaaaRecord
func (tr *AaaaRecord) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AaaaRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AaaaRecord) LateInitialize(attrs []byte) (bool, error) {
	params := &AaaaRecordParameters{}
