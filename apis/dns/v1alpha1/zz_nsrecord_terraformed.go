...
// GetTerraformResourceIDField returns Terraform identifier field for this NsRecord
func (tr *NsRecord) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this NsRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *NsRecord) LateInitialize(attrs []byte) (bool, error) {
	params := &NsRecordParameters{}
