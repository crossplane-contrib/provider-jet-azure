...
var (
	NsRecordKind             = "NsRecord"
	NsRecordGroupKind        = schema.GroupKind{Group: Group, Kind: NsRecordKind}.String()
	NsRecordKindAPIVersion   = NsRecordKind + "." + GroupVersion.String()
	NsRecordGroupVersionKind = GroupVersion.WithKind(NsRecordKind)
)
