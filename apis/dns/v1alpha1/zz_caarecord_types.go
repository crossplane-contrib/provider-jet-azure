...
var (
	CaaRecordKind             = "CaaRecord"
	CaaRecordGroupKind        = schema.GroupKind{Group: Group, Kind: CaaRecordKind}.String()
	CaaRecordKindAPIVersion   = CaaRecordKind + "." + GroupVersion.String()
	CaaRecordGroupVersionKind = GroupVersion.WithKind(CaaRecordKind)
)
