...
// GetTerraformResourceIdField returns Terraform identifier field for this DnsCnameRecord
func (tr *DnsCnameRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DnsCnameRecord
func (tr *DnsCnameRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DnsCnameRecord
func (tr *DnsCnameRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DnsCnameRecord
func (tr *DnsCnameRecord) GetParameters() ([]byte, error) {
...
func (tr *DnsCnameRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DnsCnameRecordParameters{}
