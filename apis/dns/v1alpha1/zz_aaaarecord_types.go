...
var (
	AaaaRecordKind             = "AaaaRecord"
	AaaaRecordGroupKind        = schema.GroupKind{Group: Group, Kind: AaaaRecordKind}.String()
	AaaaRecordKindAPIVersion   = AaaaRecordKind + "." + GroupVersion.String()
	AaaaRecordGroupVersionKind = GroupVersion.WithKind(AaaaRecordKind)
)
