...
// GetTerraformResourceIDField returns Terraform identifier field for this SrvRecord
func (tr *SrvRecord) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this SrvRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SrvRecord) LateInitialize(attrs []byte) (bool, error) {
	params := &SrvRecordParameters{}
