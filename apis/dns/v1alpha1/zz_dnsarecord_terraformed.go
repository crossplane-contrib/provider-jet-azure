...
// GetTerraformResourceIdField returns Terraform identifier field for this DnsARecord
func (tr *DnsARecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DnsARecord
func (tr *DnsARecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DnsARecord
func (tr *DnsARecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DnsARecord
func (tr *DnsARecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this DnsARecord
func (tr *DnsARecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this DnsARecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DnsARecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DnsARecordParameters{}
