...
var (
	TxtRecordKind             = "TxtRecord"
	TxtRecordGroupKind        = schema.GroupKind{Group: Group, Kind: TxtRecordKind}.String()
	TxtRecordKindAPIVersion   = TxtRecordKind + "." + GroupVersion.String()
	TxtRecordGroupVersionKind = GroupVersion.WithKind(TxtRecordKind)
)
