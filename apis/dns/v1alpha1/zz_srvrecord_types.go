...
var (
	SrvRecordKind             = "SrvRecord"
	SrvRecordGroupKind        = schema.GroupKind{Group: Group, Kind: SrvRecordKind}.String()
	SrvRecordKindAPIVersion   = SrvRecordKind + "." + GroupVersion.String()
	SrvRecordGroupVersionKind = GroupVersion.WithKind(SrvRecordKind)
)
