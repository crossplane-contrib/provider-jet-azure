...
var (
	CnameRecordKind             = "CnameRecord"
	CnameRecordGroupKind        = schema.GroupKind{Group: Group, Kind: CnameRecordKind}.String()
	CnameRecordKindAPIVersion   = CnameRecordKind + "." + GroupVersion.String()
	CnameRecordGroupVersionKind = GroupVersion.WithKind(CnameRecordKind)
)
