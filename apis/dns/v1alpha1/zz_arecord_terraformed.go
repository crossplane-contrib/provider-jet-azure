...
// GetTerraformResourceIDField returns Terraform identifier field for this ARecord
func (tr *ARecord) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ARecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ARecord) LateInitialize(attrs []byte) (bool, error) {
	params := &ARecordParameters{}
