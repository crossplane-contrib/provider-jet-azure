...
// GetTerraformResourceIDField returns Terraform identifier field for this CaaRecord
func (tr *CaaRecord) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CaaRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CaaRecord) LateInitialize(attrs []byte) (bool, error) {
	params := &CaaRecordParameters{}
