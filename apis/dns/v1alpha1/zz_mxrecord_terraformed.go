...
// GetTerraformResourceIDField returns Terraform identifier field for this MxRecord
func (tr *MxRecord) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this MxRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MxRecord) LateInitialize(attrs []byte) (bool, error) {
	params := &MxRecordParameters{}
