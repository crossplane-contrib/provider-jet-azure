...
// GetTerraformResourceIdField returns Terraform identifier field for this DnsAaaaRecord
func (tr *DnsAaaaRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DnsAaaaRecord
func (tr *DnsAaaaRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DnsAaaaRecord
func (tr *DnsAaaaRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DnsAaaaRecord
func (tr *DnsAaaaRecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this DnsAaaaRecord
func (tr *DnsAaaaRecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this DnsAaaaRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DnsAaaaRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DnsAaaaRecordParameters{}
