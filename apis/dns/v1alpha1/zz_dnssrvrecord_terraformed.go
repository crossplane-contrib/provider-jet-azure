...
// GetTerraformResourceIdField returns Terraform identifier field for this DnsSrvRecord
func (tr *DnsSrvRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DnsSrvRecord
func (tr *DnsSrvRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DnsSrvRecord
func (tr *DnsSrvRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DnsSrvRecord
func (tr *DnsSrvRecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this DnsSrvRecord
func (tr *DnsSrvRecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this DnsSrvRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DnsSrvRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DnsSrvRecordParameters{}
