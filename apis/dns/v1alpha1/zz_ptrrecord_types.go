...
var (
	PtrRecordKind             = "PtrRecord"
	PtrRecordGroupKind        = schema.GroupKind{Group: Group, Kind: PtrRecordKind}.String()
	PtrRecordKindAPIVersion   = PtrRecordKind + "." + GroupVersion.String()
	PtrRecordGroupVersionKind = GroupVersion.WithKind(PtrRecordKind)
)
