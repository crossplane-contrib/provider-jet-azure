...
// LateInitialize this EndpointEventGrid using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EndpointEventGrid) LateInitialize(attrs []byte) (bool, error) {
	params := &EndpointEventGridParameters{}
...
// LateInitialize this EndpointEventHub using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EndpointEventHub) LateInitialize(attrs []byte) (bool, error) {
	params := &EndpointEventHubParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// LateInitialize this EndpointServiceBus using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EndpointServiceBus) LateInitialize(attrs []byte) (bool, error) {
	params := &EndpointServiceBusParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
