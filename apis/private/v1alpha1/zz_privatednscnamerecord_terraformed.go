...
// GetTerraformResourceIdField returns Terraform identifier field for this PrivateDnsCnameRecord
func (tr *PrivateDnsCnameRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PrivateDnsCnameRecord
func (tr *PrivateDnsCnameRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateDnsCnameRecord
func (tr *PrivateDnsCnameRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateDnsCnameRecord
func (tr *PrivateDnsCnameRecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PrivateDnsCnameRecord
func (tr *PrivateDnsCnameRecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PrivateDnsCnameRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PrivateDnsCnameRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateDnsCnameRecordParameters{}
