...
var (
	DnsZoneVirtualNetworkLinkKind             = "DnsZoneVirtualNetworkLink"
	DnsZoneVirtualNetworkLinkGroupKind        = schema.GroupKind{Group: Group, Kind: DnsZoneVirtualNetworkLinkKind}.String()
	DnsZoneVirtualNetworkLinkKindAPIVersion   = DnsZoneVirtualNetworkLinkKind + "." + GroupVersion.String()
	DnsZoneVirtualNetworkLinkGroupVersionKind = GroupVersion.WithKind(DnsZoneVirtualNetworkLinkKind)
)
