...
var (
	LinkServiceKind             = "LinkService"
	LinkServiceGroupKind        = schema.GroupKind{Group: Group, Kind: LinkServiceKind}.String()
	LinkServiceKindAPIVersion   = LinkServiceKind + "." + GroupVersion.String()
	LinkServiceGroupVersionKind = GroupVersion.WithKind(LinkServiceKind)
)
