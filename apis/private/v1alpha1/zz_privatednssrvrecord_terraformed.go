...
func (tr *PrivateDnsSrvRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateDnsSrvRecord
func (tr *PrivateDnsSrvRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateDnsSrvRecord
func (tr *PrivateDnsSrvRecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PrivateDnsSrvRecord
func (tr *PrivateDnsSrvRecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PrivateDnsSrvRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PrivateDnsSrvRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateDnsSrvRecordParameters{}
