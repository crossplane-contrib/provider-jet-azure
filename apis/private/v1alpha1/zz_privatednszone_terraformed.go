...
// GetTerraformResourceIdField returns Terraform identifier field for this PrivateDnsZone
func (tr *PrivateDnsZone) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PrivateDnsZone
func (tr *PrivateDnsZone) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateDnsZone
func (tr *PrivateDnsZone) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateDnsZone
func (tr *PrivateDnsZone) GetParameters() ([]byte, error) {
...
func (tr *PrivateDnsZone) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateDnsZoneParameters{}
