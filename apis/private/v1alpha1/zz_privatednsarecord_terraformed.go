...
// GetTerraformResourceIdField returns Terraform identifier field for this PrivateDnsARecord
func (tr *PrivateDnsARecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PrivateDnsARecord
func (tr *PrivateDnsARecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateDnsARecord
func (tr *PrivateDnsARecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateDnsARecord
func (tr *PrivateDnsARecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PrivateDnsARecord
func (tr *PrivateDnsARecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PrivateDnsARecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PrivateDnsARecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateDnsARecordParameters{}
