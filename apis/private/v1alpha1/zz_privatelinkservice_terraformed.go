...
// GetTerraformResourceIdField returns Terraform identifier field for this PrivateLinkService
func (tr *PrivateLinkService) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PrivateLinkService
func (tr *PrivateLinkService) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateLinkService
func (tr *PrivateLinkService) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateLinkService
func (tr *PrivateLinkService) GetParameters() ([]byte, error) {
...
func (tr *PrivateLinkService) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateLinkServiceParameters{}
