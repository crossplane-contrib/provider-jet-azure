...
// GetTerraformResourceIdField returns Terraform identifier field for this PrivateDnsAaaaRecord
func (tr *PrivateDnsAaaaRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PrivateDnsAaaaRecord
func (tr *PrivateDnsAaaaRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateDnsAaaaRecord
func (tr *PrivateDnsAaaaRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateDnsAaaaRecord
func (tr *PrivateDnsAaaaRecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PrivateDnsAaaaRecord
func (tr *PrivateDnsAaaaRecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PrivateDnsAaaaRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PrivateDnsAaaaRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateDnsAaaaRecordParameters{}
