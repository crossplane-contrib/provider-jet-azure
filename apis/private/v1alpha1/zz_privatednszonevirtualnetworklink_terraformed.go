...
// GetTerraformResourceIdField returns Terraform identifier field for this PrivateDnsZoneVirtualNetworkLink
func (tr *PrivateDnsZoneVirtualNetworkLink) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PrivateDnsZoneVirtualNetworkLink
func (tr *PrivateDnsZoneVirtualNetworkLink) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateDnsZoneVirtualNetworkLink
func (tr *PrivateDnsZoneVirtualNetworkLink) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateDnsZoneVirtualNetworkLink
func (tr *PrivateDnsZoneVirtualNetworkLink) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PrivateDnsZoneVirtualNetworkLink
func (tr *PrivateDnsZoneVirtualNetworkLink) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PrivateDnsZoneVirtualNetworkLink using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PrivateDnsZoneVirtualNetworkLink) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateDnsZoneVirtualNetworkLinkParameters{}
