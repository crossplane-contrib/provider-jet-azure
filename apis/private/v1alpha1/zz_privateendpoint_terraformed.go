...
func (tr *PrivateEndpoint) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateEndpoint
func (tr *PrivateEndpoint) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateEndpoint
func (tr *PrivateEndpoint) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PrivateEndpoint
func (tr *PrivateEndpoint) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PrivateEndpoint using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PrivateEndpoint) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateEndpointParameters{}
