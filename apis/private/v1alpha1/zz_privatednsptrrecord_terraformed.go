...
// GetTerraformResourceIdField returns Terraform identifier field for this PrivateDnsPtrRecord
func (tr *PrivateDnsPtrRecord) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PrivateDnsPtrRecord
func (tr *PrivateDnsPtrRecord) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PrivateDnsPtrRecord
func (tr *PrivateDnsPtrRecord) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PrivateDnsPtrRecord
func (tr *PrivateDnsPtrRecord) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PrivateDnsPtrRecord
func (tr *PrivateDnsPtrRecord) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PrivateDnsPtrRecord using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PrivateDnsPtrRecord) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PrivateDnsPtrRecordParameters{}
