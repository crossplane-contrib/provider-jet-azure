...
// GetTerraformResourceIdField returns Terraform identifier field for this RoleDefinition
func (tr *RoleDefinition) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this RoleDefinition
func (tr *RoleDefinition) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this RoleDefinition
func (tr *RoleDefinition) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this RoleDefinition
func (tr *RoleDefinition) GetParameters() ([]byte, error) {
...
func (tr *RoleDefinition) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &RoleDefinitionParameters{}
