...
var (
	DscNodeconfigurationKind             = "DscNodeconfiguration"
	DscNodeconfigurationGroupKind        = schema.GroupKind{Group: Group, Kind: DscNodeconfigurationKind}.String()
	DscNodeconfigurationKindAPIVersion   = DscNodeconfigurationKind + "." + GroupVersion.String()
	DscNodeconfigurationGroupVersionKind = GroupVersion.WithKind(DscNodeconfigurationKind)
)
