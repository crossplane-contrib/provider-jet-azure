...
var (
	VariableStringKind             = "VariableString"
	VariableStringGroupKind        = schema.GroupKind{Group: Group, Kind: VariableStringKind}.String()
	VariableStringKindAPIVersion   = VariableStringKind + "." + GroupVersion.String()
	VariableStringGroupVersionKind = GroupVersion.WithKind(VariableStringKind)
)
