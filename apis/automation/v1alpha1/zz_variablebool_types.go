...
var (
	VariableBoolKind             = "VariableBool"
	VariableBoolGroupKind        = schema.GroupKind{Group: Group, Kind: VariableBoolKind}.String()
	VariableBoolKindAPIVersion   = VariableBoolKind + "." + GroupVersion.String()
	VariableBoolGroupVersionKind = GroupVersion.WithKind(VariableBoolKind)
)
