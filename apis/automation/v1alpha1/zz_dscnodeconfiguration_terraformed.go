...
// GetTerraformResourceIDField returns Terraform identifier field for this DscNodeconfiguration
func (tr *DscNodeconfiguration) GetTerraformResourceIDField() string {
	return "id"
}
