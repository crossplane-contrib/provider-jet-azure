...
var (
	ConnectionServicePrincipalKind             = "ConnectionServicePrincipal"
	ConnectionServicePrincipalGroupKind        = schema.GroupKind{Group: Group, Kind: ConnectionServicePrincipalKind}.String()
	ConnectionServicePrincipalKindAPIVersion   = ConnectionServicePrincipalKind + "." + GroupVersion.String()
	ConnectionServicePrincipalGroupVersionKind = GroupVersion.WithKind(ConnectionServicePrincipalKind)
)
