...
var (
	JobScheduleKind             = "JobSchedule"
	JobScheduleGroupKind        = schema.GroupKind{Group: Group, Kind: JobScheduleKind}.String()
	JobScheduleKindAPIVersion   = JobScheduleKind + "." + GroupVersion.String()
	JobScheduleGroupVersionKind = GroupVersion.WithKind(JobScheduleKind)
)
