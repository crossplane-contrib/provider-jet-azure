...
// GetTerraformResourceIDField returns Terraform identifier field for this ConnectionClassicCertificate
func (tr *ConnectionClassicCertificate) GetTerraformResourceIDField() string {
	return "id"
}
