...
// GetTerraformResourceIDField returns Terraform identifier field for this ConnectionServicePrincipal
func (tr *ConnectionServicePrincipal) GetTerraformResourceIDField() string {
	return "id"
}
