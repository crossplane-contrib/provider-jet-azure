...
// GetTerraformResourceIDField returns Terraform identifier field for this ConnectionCertificate
func (tr *ConnectionCertificate) GetTerraformResourceIDField() string {
	return "id"
}
