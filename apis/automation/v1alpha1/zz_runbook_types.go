...
var (
	RunbookKind             = "Runbook"
	RunbookGroupKind        = schema.GroupKind{Group: Group, Kind: RunbookKind}.String()
	RunbookKindAPIVersion   = RunbookKind + "." + GroupVersion.String()
	RunbookGroupVersionKind = GroupVersion.WithKind(RunbookKind)
)
