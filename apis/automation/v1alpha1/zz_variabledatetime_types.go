...
var (
	VariableDatetimeKind             = "VariableDatetime"
	VariableDatetimeGroupKind        = schema.GroupKind{Group: Group, Kind: VariableDatetimeKind}.String()
	VariableDatetimeKindAPIVersion   = VariableDatetimeKind + "." + GroupVersion.String()
	VariableDatetimeGroupVersionKind = GroupVersion.WithKind(VariableDatetimeKind)
)
