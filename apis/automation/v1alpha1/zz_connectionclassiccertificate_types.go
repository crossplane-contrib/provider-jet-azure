...
var (
	ConnectionClassicCertificateKind             = "ConnectionClassicCertificate"
	ConnectionClassicCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: ConnectionClassicCertificateKind}.String()
	ConnectionClassicCertificateKindAPIVersion   = ConnectionClassicCertificateKind + "." + GroupVersion.String()
	ConnectionClassicCertificateGroupVersionKind = GroupVersion.WithKind(ConnectionClassicCertificateKind)
)
