...
var (
	...
	CredentialGroupKind        = schema.GroupKind{Group: Group, Kind: CredentialKind}.String()
	CredentialKindAPIVersion   = CredentialKind + "." + GroupVersion.String()
	CredentialGroupVersionKind = GroupVersion.WithKind(CredentialKind)
)
