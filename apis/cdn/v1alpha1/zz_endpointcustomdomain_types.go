...
var (
	EndpointCustomDomainKind             = "EndpointCustomDomain"
	EndpointCustomDomainGroupKind        = schema.GroupKind{Group: Group, Kind: EndpointCustomDomainKind}.String()
	EndpointCustomDomainKindAPIVersion   = EndpointCustomDomainKind + "." + GroupVersion.String()
	EndpointCustomDomainGroupVersionKind = GroupVersion.WithKind(EndpointCustomDomainKind)
)
