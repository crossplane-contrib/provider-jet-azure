...
func (tr *Snapshot) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this Snapshot
func (tr *Snapshot) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this Snapshot
func (tr *Snapshot) GetParameters() ([]byte, error) {
...
func (tr *Snapshot) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SnapshotParameters{}
