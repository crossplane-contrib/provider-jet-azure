...
var (
	AnalyzerEdgeModuleKind             = "AnalyzerEdgeModule"
	AnalyzerEdgeModuleGroupKind        = schema.GroupKind{Group: Group, Kind: AnalyzerEdgeModuleKind}.String()
	AnalyzerEdgeModuleKindAPIVersion   = AnalyzerEdgeModuleKind + "." + GroupVersion.String()
	AnalyzerEdgeModuleGroupVersionKind = GroupVersion.WithKind(AnalyzerEdgeModuleKind)
)
