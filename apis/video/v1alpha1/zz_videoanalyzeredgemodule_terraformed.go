...
// GetTerraformResourceIdField returns Terraform identifier field for this VideoAnalyzerEdgeModule
func (tr *VideoAnalyzerEdgeModule) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this VideoAnalyzerEdgeModule
func (tr *VideoAnalyzerEdgeModule) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this VideoAnalyzerEdgeModule
func (tr *VideoAnalyzerEdgeModule) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this VideoAnalyzerEdgeModule
func (tr *VideoAnalyzerEdgeModule) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this VideoAnalyzerEdgeModule
func (tr *VideoAnalyzerEdgeModule) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this VideoAnalyzerEdgeModule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VideoAnalyzerEdgeModule) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VideoAnalyzerEdgeModuleParameters{}
