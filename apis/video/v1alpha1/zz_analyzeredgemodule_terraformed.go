...
// GetTerraformResourceIDField returns Terraform identifier field for this AnalyzerEdgeModule
func (tr *AnalyzerEdgeModule) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnalyzerEdgeModule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnalyzerEdgeModule) LateInitialize(attrs []byte) (bool, error) {
	params := &AnalyzerEdgeModuleParameters{}
