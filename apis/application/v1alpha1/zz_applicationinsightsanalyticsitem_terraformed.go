...
// GetTerraformResourceIdField returns Terraform identifier field for this ApplicationInsightsAnalyticsItem
func (tr *ApplicationInsightsAnalyticsItem) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ApplicationInsightsAnalyticsItem
func (tr *ApplicationInsightsAnalyticsItem) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ApplicationInsightsAnalyticsItem
func (tr *ApplicationInsightsAnalyticsItem) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ApplicationInsightsAnalyticsItem
func (tr *ApplicationInsightsAnalyticsItem) GetParameters() ([]byte, error) {
...
func (tr *ApplicationInsightsAnalyticsItem) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ApplicationInsightsAnalyticsItemParameters{}
