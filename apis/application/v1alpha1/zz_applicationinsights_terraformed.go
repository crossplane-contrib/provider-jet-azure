...
// GetTerraformResourceIdField returns Terraform identifier field for this ApplicationInsights
func (tr *ApplicationInsights) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ApplicationInsights
func (tr *ApplicationInsights) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ApplicationInsights
func (tr *ApplicationInsights) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ApplicationInsights
func (tr *ApplicationInsights) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ApplicationInsights
func (tr *ApplicationInsights) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ApplicationInsights using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ApplicationInsights) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ApplicationInsightsParameters{}
