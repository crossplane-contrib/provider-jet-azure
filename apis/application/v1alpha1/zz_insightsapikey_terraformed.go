...
// GetTerraformResourceIDField returns Terraform identifier field for this InsightsApiKey
func (tr *InsightsApiKey) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this InsightsApiKey using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *InsightsApiKey) LateInitialize(attrs []byte) (bool, error) {
	params := &InsightsApiKeyParameters{}
