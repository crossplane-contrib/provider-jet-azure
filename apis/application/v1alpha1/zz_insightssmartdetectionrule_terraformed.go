...
// GetTerraformResourceIDField returns Terraform identifier field for this InsightsSmartDetectionRule
func (tr *InsightsSmartDetectionRule) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this InsightsSmartDetectionRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *InsightsSmartDetectionRule) LateInitialize(attrs []byte) (bool, error) {
	params := &InsightsSmartDetectionRuleParameters{}
