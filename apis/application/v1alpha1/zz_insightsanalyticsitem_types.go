...
// InsightsAnalyticsItem is the Schema for the InsightsAnalyticsItems API
...
var (
	InsightsAnalyticsItemKind             = "InsightsAnalyticsItem"
	InsightsAnalyticsItemGroupKind        = schema.GroupKind{Group: Group, Kind: InsightsAnalyticsItemKind}.String()
	InsightsAnalyticsItemKindAPIVersion   = InsightsAnalyticsItemKind + "." + GroupVersion.String()
	InsightsAnalyticsItemGroupVersionKind = GroupVersion.WithKind(InsightsAnalyticsItemKind)
)

func init() {
	SchemeBuilder.Register(&InsightsAnalyticsItem{}, &InsightsAnalyticsItemList{})
}
