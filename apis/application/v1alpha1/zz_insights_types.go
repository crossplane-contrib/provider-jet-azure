...
// Insights is the Schema for the Insightss API
...
var (
	...
	InsightsGroupKind        = schema.GroupKind{Group: Group, Kind: InsightsKind}.String()
	InsightsKindAPIVersion   = InsightsKind + "." + GroupVersion.String()
	InsightsGroupVersionKind = GroupVersion.WithKind(InsightsKind)
)

func init() {
	SchemeBuilder.Register(&Insights{}, &InsightsList{})
}
