...
// GetTerraformResourceIdField returns Terraform identifier field for this ApplicationInsightsWebTest
func (tr *ApplicationInsightsWebTest) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ApplicationInsightsWebTest
func (tr *ApplicationInsightsWebTest) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ApplicationInsightsWebTest
func (tr *ApplicationInsightsWebTest) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ApplicationInsightsWebTest
func (tr *ApplicationInsightsWebTest) GetParameters() ([]byte, error) {
...
func (tr *ApplicationInsightsWebTest) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ApplicationInsightsWebTestParameters{}
