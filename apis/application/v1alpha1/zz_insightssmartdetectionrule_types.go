...
var (
	InsightsSmartDetectionRuleKind             = "InsightsSmartDetectionRule"
	InsightsSmartDetectionRuleGroupKind        = schema.GroupKind{Group: Group, Kind: InsightsSmartDetectionRuleKind}.String()
	InsightsSmartDetectionRuleKindAPIVersion   = InsightsSmartDetectionRuleKind + "." + GroupVersion.String()
	InsightsSmartDetectionRuleGroupVersionKind = GroupVersion.WithKind(InsightsSmartDetectionRuleKind)
)
