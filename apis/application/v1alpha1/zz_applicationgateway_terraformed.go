...
func (tr *ApplicationGateway) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ApplicationGateway
func (tr *ApplicationGateway) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ApplicationGateway
func (tr *ApplicationGateway) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ApplicationGateway
func (tr *ApplicationGateway) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ApplicationGateway using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ApplicationGateway) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ApplicationGatewayParameters{}
