...
var (
	InsightsApiKeyKind             = "InsightsApiKey"
	InsightsApiKeyGroupKind        = schema.GroupKind{Group: Group, Kind: InsightsApiKeyKind}.String()
	InsightsApiKeyKindAPIVersion   = InsightsApiKeyKind + "." + GroupVersion.String()
	InsightsApiKeyGroupVersionKind = GroupVersion.WithKind(InsightsApiKeyKind)
)
