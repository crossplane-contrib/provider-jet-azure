...
// GetTerraformResourceIDField returns Terraform identifier field for this Insights
func (tr *Insights) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this Insights using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Insights) LateInitialize(attrs []byte) (bool, error) {
	params := &InsightsParameters{}
