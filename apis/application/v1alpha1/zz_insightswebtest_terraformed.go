...
// GetTerraformResourceIDField returns Terraform identifier field for this InsightsWebTest
func (tr *InsightsWebTest) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this InsightsWebTest using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *InsightsWebTest) LateInitialize(attrs []byte) (bool, error) {
	params := &InsightsWebTestParameters{}
