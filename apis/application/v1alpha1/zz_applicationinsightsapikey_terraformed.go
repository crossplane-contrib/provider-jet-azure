...
// GetTerraformResourceIdField returns Terraform identifier field for this ApplicationInsightsApiKey
func (tr *ApplicationInsightsApiKey) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ApplicationInsightsApiKey
func (tr *ApplicationInsightsApiKey) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ApplicationInsightsApiKey
func (tr *ApplicationInsightsApiKey) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ApplicationInsightsApiKey
func (tr *ApplicationInsightsApiKey) GetParameters() ([]byte, error) {
...
func (tr *ApplicationInsightsApiKey) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ApplicationInsightsApiKeyParameters{}
