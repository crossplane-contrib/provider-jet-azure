...
// GetTerraformResourceIDField returns Terraform identifier field for this InsightsAnalyticsItem
func (tr *InsightsAnalyticsItem) GetTerraformResourceIDField() string {
	return "id"
}
