...
var (
	InsightsWebTestKind             = "InsightsWebTest"
	InsightsWebTestGroupKind        = schema.GroupKind{Group: Group, Kind: InsightsWebTestKind}.String()
	InsightsWebTestKindAPIVersion   = InsightsWebTestKind + "." + GroupVersion.String()
	InsightsWebTestGroupVersionKind = GroupVersion.WithKind(InsightsWebTestKind)
)
