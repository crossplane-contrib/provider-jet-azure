...
// GetTerraformResourceIDField returns Terraform identifier field for this TenantConfiguration
func (tr *TenantConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
