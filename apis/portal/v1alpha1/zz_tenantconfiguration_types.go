...
var (
	TenantConfigurationKind             = "TenantConfiguration"
	TenantConfigurationGroupKind        = schema.GroupKind{Group: Group, Kind: TenantConfigurationKind}.String()
	TenantConfigurationKindAPIVersion   = TenantConfigurationKind + "." + GroupVersion.String()
	TenantConfigurationGroupVersionKind = GroupVersion.WithKind(TenantConfigurationKind)
)
