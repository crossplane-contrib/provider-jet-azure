...
var (
	ManagementExportResourceGroupKind             = "ManagementExportResourceGroup"
	ManagementExportResourceGroupGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementExportResourceGroupKind}.String()
	ManagementExportResourceGroupKindAPIVersion   = ManagementExportResourceGroupKind + "." + GroupVersion.String()
	ManagementExportResourceGroupGroupVersionKind = GroupVersion.WithKind(ManagementExportResourceGroupKind)
)
