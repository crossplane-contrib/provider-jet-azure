...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementExportResourceGroup
func (tr *ManagementExportResourceGroup) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementExportResourceGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementExportResourceGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementExportResourceGroupParameters{}
