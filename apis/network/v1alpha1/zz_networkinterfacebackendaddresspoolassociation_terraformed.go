...
// GetTerraformResourceIdField returns Terraform identifier field for this NetworkInterfaceBackendAddressPoolAssociation
func (tr *NetworkInterfaceBackendAddressPoolAssociation) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this NetworkInterfaceBackendAddressPoolAssociation
func (tr *NetworkInterfaceBackendAddressPoolAssociation) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this NetworkInterfaceBackendAddressPoolAssociation
func (tr *NetworkInterfaceBackendAddressPoolAssociation) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this NetworkInterfaceBackendAddressPoolAssociation
func (tr *NetworkInterfaceBackendAddressPoolAssociation) GetParameters() ([]byte, error) {
...
func (tr *NetworkInterfaceBackendAddressPoolAssociation) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &NetworkInterfaceBackendAddressPoolAssociationParameters{}
