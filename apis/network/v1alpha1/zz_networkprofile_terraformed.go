...
func (tr *NetworkProfile) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this NetworkProfile
func (tr *NetworkProfile) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this NetworkProfile
func (tr *NetworkProfile) GetParameters() ([]byte, error) {
...
func (tr *NetworkProfile) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &NetworkProfileParameters{}
