...
// GetTerraformResourceIDField returns Terraform identifier field for this NetworkProfile
func (tr *NetworkProfile) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *NetworkProfile) GetObservation() (map[string]interface{}, error) {
...
func (tr *NetworkProfile) SetObservation(obs map[string]interface{}) error {
...
func (tr *NetworkProfile) GetParameters() (map[string]interface{}, error) {
...
func (tr *NetworkProfile) SetParameters(params map[string]interface{}) error {
