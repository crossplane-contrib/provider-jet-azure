...
// GetTerraformResourceIdField returns Terraform identifier field for this NetworkPacketCapture
func (tr *NetworkPacketCapture) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this NetworkPacketCapture
func (tr *NetworkPacketCapture) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this NetworkPacketCapture
func (tr *NetworkPacketCapture) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this NetworkPacketCapture
func (tr *NetworkPacketCapture) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this NetworkPacketCapture
func (tr *NetworkPacketCapture) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this NetworkPacketCapture using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *NetworkPacketCapture) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &NetworkPacketCaptureParameters{}
