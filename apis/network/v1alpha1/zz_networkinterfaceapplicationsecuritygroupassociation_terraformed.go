...
// GetTerraformResourceIdField returns Terraform identifier field for this NetworkInterfaceApplicationSecurityGroupAssociation
func (tr *NetworkInterfaceApplicationSecurityGroupAssociation) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this NetworkInterfaceApplicationSecurityGroupAssociation
func (tr *NetworkInterfaceApplicationSecurityGroupAssociation) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this NetworkInterfaceApplicationSecurityGroupAssociation
func (tr *NetworkInterfaceApplicationSecurityGroupAssociation) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this NetworkInterfaceApplicationSecurityGroupAssociation
func (tr *NetworkInterfaceApplicationSecurityGroupAssociation) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this NetworkInterfaceApplicationSecurityGroupAssociation
func (tr *NetworkInterfaceApplicationSecurityGroupAssociation) SetParameters(data []byte) error {
...
func (tr *NetworkInterfaceApplicationSecurityGroupAssociation) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &NetworkInterfaceApplicationSecurityGroupAssociationParameters{}
