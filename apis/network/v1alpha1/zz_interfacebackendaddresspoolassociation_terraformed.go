...
// GetTerraformResourceIDField returns Terraform identifier field for this InterfaceBackendAddressPoolAssociation
func (tr *InterfaceBackendAddressPoolAssociation) GetTerraformResourceIDField() string {
	return "id"
}
