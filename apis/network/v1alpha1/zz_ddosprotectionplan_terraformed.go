...
// GetTerraformResourceIDField returns Terraform identifier field for this DdosProtectionPlan
func (tr *DdosProtectionPlan) GetTerraformResourceIDField() string {
	return "id"
}
