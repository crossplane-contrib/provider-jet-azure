...
var (
	ConnectionMonitorKind             = "ConnectionMonitor"
	ConnectionMonitorGroupKind        = schema.GroupKind{Group: Group, Kind: ConnectionMonitorKind}.String()
	ConnectionMonitorKindAPIVersion   = ConnectionMonitorKind + "." + GroupVersion.String()
	ConnectionMonitorGroupVersionKind = GroupVersion.WithKind(ConnectionMonitorKind)
)
