...
// GetTerraformResourceIdField returns Terraform identifier field for this NetworkSecurityGroup
func (tr *NetworkSecurityGroup) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this NetworkSecurityGroup
func (tr *NetworkSecurityGroup) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this NetworkSecurityGroup
func (tr *NetworkSecurityGroup) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this NetworkSecurityGroup
func (tr *NetworkSecurityGroup) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this NetworkSecurityGroup
func (tr *NetworkSecurityGroup) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this NetworkSecurityGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *NetworkSecurityGroup) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &NetworkSecurityGroupParameters{}
