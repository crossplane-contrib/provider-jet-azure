...
// GetTerraformResourceIDField returns Terraform identifier field for this InterfaceNatRuleAssociation
func (tr *InterfaceNatRuleAssociation) GetTerraformResourceIDField() string {
	return "id"
}
