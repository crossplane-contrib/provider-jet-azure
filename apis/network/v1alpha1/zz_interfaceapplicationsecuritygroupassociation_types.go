...
var (
	InterfaceApplicationSecurityGroupAssociationKind             = "InterfaceApplicationSecurityGroupAssociation"
	InterfaceApplicationSecurityGroupAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: InterfaceApplicationSecurityGroupAssociationKind}.String()
	InterfaceApplicationSecurityGroupAssociationKindAPIVersion   = InterfaceApplicationSecurityGroupAssociationKind + "." + GroupVersion.String()
	InterfaceApplicationSecurityGroupAssociationGroupVersionKind = GroupVersion.WithKind(InterfaceApplicationSecurityGroupAssociationKind)
)
