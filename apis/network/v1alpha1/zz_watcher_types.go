...
var (
	WatcherKind             = "Watcher"
	WatcherGroupKind        = schema.GroupKind{Group: Group, Kind: WatcherKind}.String()
	WatcherKindAPIVersion   = WatcherKind + "." + GroupVersion.String()
	WatcherGroupVersionKind = GroupVersion.WithKind(WatcherKind)
)
