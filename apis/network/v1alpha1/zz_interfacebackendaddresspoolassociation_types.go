...
var (
	InterfaceBackendAddressPoolAssociationKind             = "InterfaceBackendAddressPoolAssociation"
	InterfaceBackendAddressPoolAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: InterfaceBackendAddressPoolAssociationKind}.String()
	InterfaceBackendAddressPoolAssociationKindAPIVersion   = InterfaceBackendAddressPoolAssociationKind + "." + GroupVersion.String()
	InterfaceBackendAddressPoolAssociationGroupVersionKind = GroupVersion.WithKind(InterfaceBackendAddressPoolAssociationKind)
)
