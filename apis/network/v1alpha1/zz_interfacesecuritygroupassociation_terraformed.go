...
// GetTerraformResourceIDField returns Terraform identifier field for this InterfaceSecurityGroupAssociation
func (tr *InterfaceSecurityGroupAssociation) GetTerraformResourceIDField() string {
	return "id"
}
