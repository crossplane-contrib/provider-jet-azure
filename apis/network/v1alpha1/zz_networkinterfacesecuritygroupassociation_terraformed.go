...
func (tr *NetworkInterfaceSecurityGroupAssociation) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this NetworkInterfaceSecurityGroupAssociation
func (tr *NetworkInterfaceSecurityGroupAssociation) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this NetworkInterfaceSecurityGroupAssociation
func (tr *NetworkInterfaceSecurityGroupAssociation) GetParameters() ([]byte, error) {
...
func (tr *NetworkInterfaceSecurityGroupAssociation) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &NetworkInterfaceSecurityGroupAssociationParameters{}
