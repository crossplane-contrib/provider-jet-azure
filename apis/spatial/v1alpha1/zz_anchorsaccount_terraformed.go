...
// GetTerraformResourceIDField returns Terraform identifier field for this AnchorsAccount
func (tr *AnchorsAccount) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AnchorsAccount using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AnchorsAccount) LateInitialize(attrs []byte) (bool, error) {
	params := &AnchorsAccountParameters{}
