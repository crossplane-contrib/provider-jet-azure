...
func (tr *SpatialAnchorsAccount) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SpatialAnchorsAccount
func (tr *SpatialAnchorsAccount) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SpatialAnchorsAccount
func (tr *SpatialAnchorsAccount) GetParameters() ([]byte, error) {
...
func (tr *SpatialAnchorsAccount) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SpatialAnchorsAccountParameters{}
