...
// GetTerraformResourceIdField returns Terraform identifier field for this OrchestratedVirtualMachineScaleSet
func (tr *OrchestratedVirtualMachineScaleSet) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this OrchestratedVirtualMachineScaleSet
func (tr *OrchestratedVirtualMachineScaleSet) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this OrchestratedVirtualMachineScaleSet
func (tr *OrchestratedVirtualMachineScaleSet) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this OrchestratedVirtualMachineScaleSet
func (tr *OrchestratedVirtualMachineScaleSet) GetParameters() ([]byte, error) {
...
func (tr *OrchestratedVirtualMachineScaleSet) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &OrchestratedVirtualMachineScaleSetParameters{}
