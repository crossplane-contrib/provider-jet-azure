...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelDataConnectorMicrosoftCloudAppSecurity
func (tr *SentinelDataConnectorMicrosoftCloudAppSecurity) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelDataConnectorMicrosoftCloudAppSecurity
func (tr *SentinelDataConnectorMicrosoftCloudAppSecurity) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelDataConnectorMicrosoftCloudAppSecurity
func (tr *SentinelDataConnectorMicrosoftCloudAppSecurity) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelDataConnectorMicrosoftCloudAppSecurity
func (tr *SentinelDataConnectorMicrosoftCloudAppSecurity) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SentinelDataConnectorMicrosoftCloudAppSecurity
func (tr *SentinelDataConnectorMicrosoftCloudAppSecurity) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SentinelDataConnectorMicrosoftCloudAppSecurity using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SentinelDataConnectorMicrosoftCloudAppSecurity) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelDataConnectorMicrosoftCloudAppSecurityParameters{}
