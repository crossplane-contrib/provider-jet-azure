...
// GetTerraformResourceIDField returns Terraform identifier field for this DataConnectorOffice365
func (tr *DataConnectorOffice365) GetTerraformResourceIDField() string {
	return "id"
}
