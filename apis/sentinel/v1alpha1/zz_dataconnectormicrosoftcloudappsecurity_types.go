...
// DataConnectorMicrosoftCloudAppSecurity is the Schema for the DataConnectorMicrosoftCloudAppSecuritys API
...
var (
	DataConnectorMicrosoftCloudAppSecurityKind             = "DataConnectorMicrosoftCloudAppSecurity"
	DataConnectorMicrosoftCloudAppSecurityGroupKind        = schema.GroupKind{Group: Group, Kind: DataConnectorMicrosoftCloudAppSecurityKind}.String()
	DataConnectorMicrosoftCloudAppSecurityKindAPIVersion   = DataConnectorMicrosoftCloudAppSecurityKind + "." + GroupVersion.String()
	DataConnectorMicrosoftCloudAppSecurityGroupVersionKind = GroupVersion.WithKind(DataConnectorMicrosoftCloudAppSecurityKind)
)

func init() {
	SchemeBuilder.Register(&DataConnectorMicrosoftCloudAppSecurity{}, &DataConnectorMicrosoftCloudAppSecurityList{})
}
