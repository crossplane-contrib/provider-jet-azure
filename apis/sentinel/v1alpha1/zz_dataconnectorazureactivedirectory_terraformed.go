...
// GetTerraformResourceIDField returns Terraform identifier field for this DataConnectorAzureActiveDirectory
func (tr *DataConnectorAzureActiveDirectory) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this DataConnectorAzureActiveDirectory using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DataConnectorAzureActiveDirectory) LateInitialize(attrs []byte) (bool, error) {
	params := &DataConnectorAzureActiveDirectoryParameters{}
