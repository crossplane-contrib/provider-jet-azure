...
var (
	DataConnectorAzureAdvancedThreatProtectionKind             = "DataConnectorAzureAdvancedThreatProtection"
	DataConnectorAzureAdvancedThreatProtectionGroupKind        = schema.GroupKind{Group: Group, Kind: DataConnectorAzureAdvancedThreatProtectionKind}.String()
	DataConnectorAzureAdvancedThreatProtectionKindAPIVersion   = DataConnectorAzureAdvancedThreatProtectionKind + "." + GroupVersion.String()
	DataConnectorAzureAdvancedThreatProtectionGroupVersionKind = GroupVersion.WithKind(DataConnectorAzureAdvancedThreatProtectionKind)
)
