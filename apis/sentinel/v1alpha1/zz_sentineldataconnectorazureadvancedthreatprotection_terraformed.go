...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelDataConnectorAzureAdvancedThreatProtection
func (tr *SentinelDataConnectorAzureAdvancedThreatProtection) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelDataConnectorAzureAdvancedThreatProtection
func (tr *SentinelDataConnectorAzureAdvancedThreatProtection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelDataConnectorAzureAdvancedThreatProtection
func (tr *SentinelDataConnectorAzureAdvancedThreatProtection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelDataConnectorAzureAdvancedThreatProtection
func (tr *SentinelDataConnectorAzureAdvancedThreatProtection) GetParameters() ([]byte, error) {
...
func (tr *SentinelDataConnectorAzureAdvancedThreatProtection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelDataConnectorAzureAdvancedThreatProtectionParameters{}
