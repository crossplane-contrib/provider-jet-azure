...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelDataConnectorThreatIntelligence
func (tr *SentinelDataConnectorThreatIntelligence) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelDataConnectorThreatIntelligence
func (tr *SentinelDataConnectorThreatIntelligence) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelDataConnectorThreatIntelligence
func (tr *SentinelDataConnectorThreatIntelligence) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelDataConnectorThreatIntelligence
func (tr *SentinelDataConnectorThreatIntelligence) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SentinelDataConnectorThreatIntelligence
func (tr *SentinelDataConnectorThreatIntelligence) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SentinelDataConnectorThreatIntelligence using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SentinelDataConnectorThreatIntelligence) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelDataConnectorThreatIntelligenceParameters{}
