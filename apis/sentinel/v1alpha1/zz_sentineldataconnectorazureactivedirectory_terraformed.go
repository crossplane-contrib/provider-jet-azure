...
func (tr *SentinelDataConnectorAzureActiveDirectory) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelDataConnectorAzureActiveDirectoryParameters{}
