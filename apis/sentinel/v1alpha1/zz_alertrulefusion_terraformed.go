...
// GetTerraformResourceIDField returns Terraform identifier field for this AlertRuleFusion
func (tr *AlertRuleFusion) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AlertRuleFusion using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AlertRuleFusion) LateInitialize(attrs []byte) (bool, error) {
	params := &AlertRuleFusionParameters{}
