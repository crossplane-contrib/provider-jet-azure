...
// GetTerraformResourceIDField returns Terraform identifier field for this DataConnectorThreatIntelligence
func (tr *DataConnectorThreatIntelligence) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this DataConnectorThreatIntelligence using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DataConnectorThreatIntelligence) LateInitialize(attrs []byte) (bool, error) {
	params := &DataConnectorThreatIntelligenceParameters{}
