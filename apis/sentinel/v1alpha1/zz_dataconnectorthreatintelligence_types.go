...
// DataConnectorThreatIntelligence is the Schema for the DataConnectorThreatIntelligences API
...
var (
	DataConnectorThreatIntelligenceKind             = "DataConnectorThreatIntelligence"
	DataConnectorThreatIntelligenceGroupKind        = schema.GroupKind{Group: Group, Kind: DataConnectorThreatIntelligenceKind}.String()
	DataConnectorThreatIntelligenceKindAPIVersion   = DataConnectorThreatIntelligenceKind + "." + GroupVersion.String()
	DataConnectorThreatIntelligenceGroupVersionKind = GroupVersion.WithKind(DataConnectorThreatIntelligenceKind)
)

func init() {
	SchemeBuilder.Register(&DataConnectorThreatIntelligence{}, &DataConnectorThreatIntelligenceList{})
}
