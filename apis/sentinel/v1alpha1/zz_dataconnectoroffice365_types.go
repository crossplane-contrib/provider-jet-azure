...
var (
	DataConnectorOffice365Kind             = "DataConnectorOffice365"
	DataConnectorOffice365GroupKind        = schema.GroupKind{Group: Group, Kind: DataConnectorOffice365Kind}.String()
	DataConnectorOffice365KindAPIVersion   = DataConnectorOffice365Kind + "." + GroupVersion.String()
	DataConnectorOffice365GroupVersionKind = GroupVersion.WithKind(DataConnectorOffice365Kind)
)
