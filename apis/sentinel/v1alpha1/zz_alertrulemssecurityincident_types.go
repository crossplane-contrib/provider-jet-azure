...
var (
	AlertRuleMsSecurityIncidentKind             = "AlertRuleMsSecurityIncident"
	AlertRuleMsSecurityIncidentGroupKind        = schema.GroupKind{Group: Group, Kind: AlertRuleMsSecurityIncidentKind}.String()
	AlertRuleMsSecurityIncidentKindAPIVersion   = AlertRuleMsSecurityIncidentKind + "." + GroupVersion.String()
	AlertRuleMsSecurityIncidentGroupVersionKind = GroupVersion.WithKind(AlertRuleMsSecurityIncidentKind)
)
