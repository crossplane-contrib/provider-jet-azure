...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelAlertRuleMsSecurityIncident
func (tr *SentinelAlertRuleMsSecurityIncident) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelAlertRuleMsSecurityIncident
func (tr *SentinelAlertRuleMsSecurityIncident) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelAlertRuleMsSecurityIncident
func (tr *SentinelAlertRuleMsSecurityIncident) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelAlertRuleMsSecurityIncident
func (tr *SentinelAlertRuleMsSecurityIncident) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SentinelAlertRuleMsSecurityIncident
func (tr *SentinelAlertRuleMsSecurityIncident) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SentinelAlertRuleMsSecurityIncident using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SentinelAlertRuleMsSecurityIncident) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelAlertRuleMsSecurityIncidentParameters{}
