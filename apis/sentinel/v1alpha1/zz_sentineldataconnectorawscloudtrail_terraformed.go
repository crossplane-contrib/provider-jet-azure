...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelDataConnectorAwsCloudTrail
func (tr *SentinelDataConnectorAwsCloudTrail) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelDataConnectorAwsCloudTrail
func (tr *SentinelDataConnectorAwsCloudTrail) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelDataConnectorAwsCloudTrail
func (tr *SentinelDataConnectorAwsCloudTrail) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelDataConnectorAwsCloudTrail
func (tr *SentinelDataConnectorAwsCloudTrail) GetParameters() ([]byte, error) {
...
func (tr *SentinelDataConnectorAwsCloudTrail) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelDataConnectorAwsCloudTrailParameters{}
