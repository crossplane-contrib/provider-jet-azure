...
var (
	AlertRuleMachineLearningBehaviorAnalyticsKind             = "AlertRuleMachineLearningBehaviorAnalytics"
	AlertRuleMachineLearningBehaviorAnalyticsGroupKind        = schema.GroupKind{Group: Group, Kind: AlertRuleMachineLearningBehaviorAnalyticsKind}.String()
	AlertRuleMachineLearningBehaviorAnalyticsKindAPIVersion   = AlertRuleMachineLearningBehaviorAnalyticsKind + "." + GroupVersion.String()
	AlertRuleMachineLearningBehaviorAnalyticsGroupVersionKind = GroupVersion.WithKind(AlertRuleMachineLearningBehaviorAnalyticsKind)
)
