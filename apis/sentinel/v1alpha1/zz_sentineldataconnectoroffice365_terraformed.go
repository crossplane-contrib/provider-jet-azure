...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelDataConnectorOffice365
func (tr *SentinelDataConnectorOffice365) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelDataConnectorOffice365
func (tr *SentinelDataConnectorOffice365) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelDataConnectorOffice365
func (tr *SentinelDataConnectorOffice365) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelDataConnectorOffice365
func (tr *SentinelDataConnectorOffice365) GetParameters() ([]byte, error) {
...
func (tr *SentinelDataConnectorOffice365) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelDataConnectorOffice365Parameters{}
