...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelAlertRuleScheduled
func (tr *SentinelAlertRuleScheduled) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelAlertRuleScheduled
func (tr *SentinelAlertRuleScheduled) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelAlertRuleScheduled
func (tr *SentinelAlertRuleScheduled) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelAlertRuleScheduled
func (tr *SentinelAlertRuleScheduled) GetParameters() ([]byte, error) {
...
func (tr *SentinelAlertRuleScheduled) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelAlertRuleScheduledParameters{}
