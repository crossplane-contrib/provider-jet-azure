...
// GetTerraformResourceIDField returns Terraform identifier field for this DataConnectorMicrosoftCloudAppSecurity
func (tr *DataConnectorMicrosoftCloudAppSecurity) GetTerraformResourceIDField() string {
	return "id"
}
