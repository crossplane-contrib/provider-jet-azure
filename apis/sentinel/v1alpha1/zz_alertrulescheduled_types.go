...
var (
	AlertRuleScheduledKind             = "AlertRuleScheduled"
	AlertRuleScheduledGroupKind        = schema.GroupKind{Group: Group, Kind: AlertRuleScheduledKind}.String()
	AlertRuleScheduledKindAPIVersion   = AlertRuleScheduledKind + "." + GroupVersion.String()
	AlertRuleScheduledGroupVersionKind = GroupVersion.WithKind(AlertRuleScheduledKind)
)
