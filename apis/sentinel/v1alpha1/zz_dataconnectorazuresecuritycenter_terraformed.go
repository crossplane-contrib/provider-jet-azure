...
// GetTerraformResourceIDField returns Terraform identifier field for this DataConnectorAzureSecurityCenter
func (tr *DataConnectorAzureSecurityCenter) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this DataConnectorAzureSecurityCenter using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DataConnectorAzureSecurityCenter) LateInitialize(attrs []byte) (bool, error) {
	params := &DataConnectorAzureSecurityCenterParameters{}
