...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelDataConnectorAzureSecurityCenter
func (tr *SentinelDataConnectorAzureSecurityCenter) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelDataConnectorAzureSecurityCenter
func (tr *SentinelDataConnectorAzureSecurityCenter) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelDataConnectorAzureSecurityCenter
func (tr *SentinelDataConnectorAzureSecurityCenter) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelDataConnectorAzureSecurityCenter
func (tr *SentinelDataConnectorAzureSecurityCenter) GetParameters() ([]byte, error) {
...
func (tr *SentinelDataConnectorAzureSecurityCenter) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelDataConnectorAzureSecurityCenterParameters{}
