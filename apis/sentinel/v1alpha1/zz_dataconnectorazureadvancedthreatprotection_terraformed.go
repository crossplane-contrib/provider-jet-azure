...
// GetTerraformResourceIDField returns Terraform identifier field for this DataConnectorAzureAdvancedThreatProtection
func (tr *DataConnectorAzureAdvancedThreatProtection) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this DataConnectorAzureAdvancedThreatProtection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DataConnectorAzureAdvancedThreatProtection) LateInitialize(attrs []byte) (bool, error) {
	params := &DataConnectorAzureAdvancedThreatProtectionParameters{}
