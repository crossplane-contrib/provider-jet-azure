...
// GetID returns ID of underlying Terraform resource of this DataConnectorAzureAdvancedThreatProtection
func (tr *DataConnectorAzureAdvancedThreatProtection) GetID() string {
