...
var (
	DataConnectorAzureActiveDirectoryKind             = "DataConnectorAzureActiveDirectory"
	DataConnectorAzureActiveDirectoryGroupKind        = schema.GroupKind{Group: Group, Kind: DataConnectorAzureActiveDirectoryKind}.String()
	DataConnectorAzureActiveDirectoryKindAPIVersion   = DataConnectorAzureActiveDirectoryKind + "." + GroupVersion.String()
	DataConnectorAzureActiveDirectoryGroupVersionKind = GroupVersion.WithKind(DataConnectorAzureActiveDirectoryKind)
)
