...
// GetTerraformResourceIdField returns Terraform identifier field for this SentinelAlertRuleFusion
func (tr *SentinelAlertRuleFusion) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SentinelAlertRuleFusion
func (tr *SentinelAlertRuleFusion) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SentinelAlertRuleFusion
func (tr *SentinelAlertRuleFusion) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SentinelAlertRuleFusion
func (tr *SentinelAlertRuleFusion) GetParameters() ([]byte, error) {
...
func (tr *SentinelAlertRuleFusion) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SentinelAlertRuleFusionParameters{}
