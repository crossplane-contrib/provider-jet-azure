...
var (
	AlertRuleFusionKind             = "AlertRuleFusion"
	AlertRuleFusionGroupKind        = schema.GroupKind{Group: Group, Kind: AlertRuleFusionKind}.String()
	AlertRuleFusionKindAPIVersion   = AlertRuleFusionKind + "." + GroupVersion.String()
	AlertRuleFusionGroupVersionKind = GroupVersion.WithKind(AlertRuleFusionKind)
)
