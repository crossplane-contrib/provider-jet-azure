...
// GetTerraformResourceIDField returns Terraform identifier field for this DataConnectorAwsCloudTrail
func (tr *DataConnectorAwsCloudTrail) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this DataConnectorAwsCloudTrail using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DataConnectorAwsCloudTrail) LateInitialize(attrs []byte) (bool, error) {
	params := &DataConnectorAwsCloudTrailParameters{}
