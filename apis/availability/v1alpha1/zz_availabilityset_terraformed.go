...
// GetTerraformResourceIdField returns Terraform identifier field for this AvailabilitySet
func (tr *AvailabilitySet) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this AvailabilitySet
func (tr *AvailabilitySet) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AvailabilitySet
func (tr *AvailabilitySet) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AvailabilitySet
func (tr *AvailabilitySet) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this AvailabilitySet
func (tr *AvailabilitySet) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this AvailabilitySet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AvailabilitySet) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AvailabilitySetParameters{}
