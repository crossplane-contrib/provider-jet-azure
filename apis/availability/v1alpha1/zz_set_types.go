...
var (
	SetKind             = "Set"
	SetGroupKind        = schema.GroupKind{Group: Group, Kind: SetKind}.String()
	SetKindAPIVersion   = SetKind + "." + GroupVersion.String()
	SetGroupVersionKind = GroupVersion.WithKind(SetKind)
)
