...
// GetTerraformResourceIDField returns Terraform identifier field for this ClusterNodePool
func (tr *ClusterNodePool) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *ClusterNodePool) GetObservation() (map[string]interface{}, error) {
...
func (tr *ClusterNodePool) SetObservation(obs map[string]interface{}) error {
...
func (tr *ClusterNodePool) GetParameters() (map[string]interface{}, error) {
...
func (tr *ClusterNodePool) SetParameters(params map[string]interface{}) error {
