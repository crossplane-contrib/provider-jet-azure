...
import (
	...
	v1alpha11 "github.com/crossplane-contrib/provider-tf-azure/apis/virtual/v1alpha1"
...
// ResolveReferences of this ClusterNodePool.
func (mg *ClusterNodePool) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
