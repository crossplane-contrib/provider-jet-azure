...
// GetTerraformResourceIdField returns Terraform identifier field for this KubernetesClusterNodePool
func (tr *KubernetesClusterNodePool) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this KubernetesClusterNodePool
func (tr *KubernetesClusterNodePool) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this KubernetesClusterNodePool
func (tr *KubernetesClusterNodePool) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this KubernetesClusterNodePool
func (tr *KubernetesClusterNodePool) GetParameters() ([]byte, error) {
...
func (tr *KubernetesClusterNodePool) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &KubernetesClusterNodePoolParameters{}
