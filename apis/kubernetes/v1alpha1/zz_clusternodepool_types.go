...
type ClusterNodePoolKubeletConfigObservation struct {
}

type ClusterNodePoolKubeletConfigParameters struct {
...
type ClusterNodePoolLinuxOsConfigObservation struct {
}

type ClusterNodePoolLinuxOsConfigParameters struct {
...
type ClusterNodePoolParameters struct {
	...
	// +kubebuilder:validation:Optional
	KubeletConfig []ClusterNodePoolKubeletConfigParameters `json:"kubeletConfig,omitempty" tf:"kubelet_config,omitempty"`
	...
	// +kubebuilder:validation:Optional
	UpgradeSettings []ClusterNodePoolUpgradeSettingsParameters `json:"upgradeSettings,omitempty" tf:"upgrade_settings,omitempty"`
...
type ClusterNodePoolUpgradeSettingsParameters struct {
...
// ClusterNodePool is the Schema for the ClusterNodePools API
...
var (
	ClusterNodePoolKind             = "ClusterNodePool"
	ClusterNodePoolGroupKind        = schema.GroupKind{Group: Group, Kind: ClusterNodePoolKind}.String()
	ClusterNodePoolKindAPIVersion   = ClusterNodePoolKind + "." + GroupVersion.String()
	ClusterNodePoolGroupVersionKind = GroupVersion.WithKind(ClusterNodePoolKind)
)
