...
// GetTerraformResourceIdField returns Terraform identifier field for this LbOutboundRule
func (tr *LbOutboundRule) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LbOutboundRule
func (tr *LbOutboundRule) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LbOutboundRule
func (tr *LbOutboundRule) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LbOutboundRule
func (tr *LbOutboundRule) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this LbOutboundRule
func (tr *LbOutboundRule) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this LbOutboundRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LbOutboundRule) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LbOutboundRuleParameters{}
