...
// GetTerraformResourceIDField returns Terraform identifier field for this OutboundRule
func (tr *OutboundRule) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this OutboundRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *OutboundRule) LateInitialize(attrs []byte) (bool, error) {
	params := &OutboundRuleParameters{}
