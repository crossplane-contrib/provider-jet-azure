...
// GetTerraformResourceIdField returns Terraform identifier field for this LbBackendAddressPoolAddress
func (tr *LbBackendAddressPoolAddress) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LbBackendAddressPoolAddress
func (tr *LbBackendAddressPoolAddress) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LbBackendAddressPoolAddress
func (tr *LbBackendAddressPoolAddress) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LbBackendAddressPoolAddress
func (tr *LbBackendAddressPoolAddress) GetParameters() ([]byte, error) {
...
func (tr *LbBackendAddressPoolAddress) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LbBackendAddressPoolAddressParameters{}
