...
// GetTerraformResourceIDField returns Terraform identifier field for this BackendAddressPoolAddress
func (tr *BackendAddressPoolAddress) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this BackendAddressPoolAddress using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BackendAddressPoolAddress) LateInitialize(attrs []byte) (bool, error) {
	params := &BackendAddressPoolAddressParameters{}
