...
var (
	BackendAddressPoolAddressKind             = "BackendAddressPoolAddress"
	BackendAddressPoolAddressGroupKind        = schema.GroupKind{Group: Group, Kind: BackendAddressPoolAddressKind}.String()
	BackendAddressPoolAddressKindAPIVersion   = BackendAddressPoolAddressKind + "." + GroupVersion.String()
	BackendAddressPoolAddressGroupVersionKind = GroupVersion.WithKind(BackendAddressPoolAddressKind)
)
