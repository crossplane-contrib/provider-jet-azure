...
// GetTerraformResourceIdField returns Terraform identifier field for this LbBackendAddressPool
func (tr *LbBackendAddressPool) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LbBackendAddressPool
func (tr *LbBackendAddressPool) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LbBackendAddressPool
func (tr *LbBackendAddressPool) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LbBackendAddressPool
func (tr *LbBackendAddressPool) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this LbBackendAddressPool
func (tr *LbBackendAddressPool) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this LbBackendAddressPool using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LbBackendAddressPool) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LbBackendAddressPoolParameters{}
