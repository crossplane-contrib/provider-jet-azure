...
// GetTerraformResourceIDField returns Terraform identifier field for this BackendAddressPool
func (tr *BackendAddressPool) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this BackendAddressPool using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BackendAddressPool) LateInitialize(attrs []byte) (bool, error) {
	params := &BackendAddressPoolParameters{}
