...
var (
	ProbeKind             = "Probe"
	ProbeGroupKind        = schema.GroupKind{Group: Group, Kind: ProbeKind}.String()
	ProbeKindAPIVersion   = ProbeKind + "." + GroupVersion.String()
	ProbeGroupVersionKind = GroupVersion.WithKind(ProbeKind)
)
