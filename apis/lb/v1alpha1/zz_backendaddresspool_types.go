...
var (
	BackendAddressPoolKind             = "BackendAddressPool"
	BackendAddressPoolGroupKind        = schema.GroupKind{Group: Group, Kind: BackendAddressPoolKind}.String()
	BackendAddressPoolKindAPIVersion   = BackendAddressPoolKind + "." + GroupVersion.String()
	BackendAddressPoolGroupVersionKind = GroupVersion.WithKind(BackendAddressPoolKind)
)
