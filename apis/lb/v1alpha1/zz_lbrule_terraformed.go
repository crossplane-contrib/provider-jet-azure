...
// GetTerraformResourceIdField returns Terraform identifier field for this LbRule
func (tr *LbRule) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LbRule
func (tr *LbRule) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LbRule
func (tr *LbRule) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LbRule
func (tr *LbRule) GetParameters() ([]byte, error) {
...
func (tr *LbRule) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LbRuleParameters{}
