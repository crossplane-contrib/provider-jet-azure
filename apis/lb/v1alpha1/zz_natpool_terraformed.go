...
// GetTerraformResourceIDField returns Terraform identifier field for this NatPool
func (tr *NatPool) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this NatPool using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *NatPool) LateInitialize(attrs []byte) (bool, error) {
	params := &NatPoolParameters{}
