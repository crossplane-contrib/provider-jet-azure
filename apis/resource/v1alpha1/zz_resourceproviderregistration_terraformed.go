...
// GetTerraformResourceIdField returns Terraform identifier field for this ResourceProviderRegistration
func (tr *ResourceProviderRegistration) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ResourceProviderRegistration
func (tr *ResourceProviderRegistration) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ResourceProviderRegistration
func (tr *ResourceProviderRegistration) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ResourceProviderRegistration
func (tr *ResourceProviderRegistration) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ResourceProviderRegistration
func (tr *ResourceProviderRegistration) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ResourceProviderRegistration using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResourceProviderRegistration) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ResourceProviderRegistrationParameters{}
