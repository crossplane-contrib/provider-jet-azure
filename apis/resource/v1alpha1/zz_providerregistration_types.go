...
// ProviderRegistration is the Schema for the ProviderRegistrations API
...
var (
	ProviderRegistrationKind             = "ProviderRegistration"
	ProviderRegistrationGroupKind        = schema.GroupKind{Group: Group, Kind: ProviderRegistrationKind}.String()
	ProviderRegistrationKindAPIVersion   = ProviderRegistrationKind + "." + GroupVersion.String()
	ProviderRegistrationGroupVersionKind = GroupVersion.WithKind(ProviderRegistrationKind)
)
