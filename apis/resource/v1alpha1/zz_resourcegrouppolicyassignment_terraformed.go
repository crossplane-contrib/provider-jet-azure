...
// GetTerraformResourceIdField returns Terraform identifier field for this ResourceGroupPolicyAssignment
func (tr *ResourceGroupPolicyAssignment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ResourceGroupPolicyAssignment
func (tr *ResourceGroupPolicyAssignment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ResourceGroupPolicyAssignment
func (tr *ResourceGroupPolicyAssignment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ResourceGroupPolicyAssignment
func (tr *ResourceGroupPolicyAssignment) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ResourceGroupPolicyAssignment
func (tr *ResourceGroupPolicyAssignment) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ResourceGroupPolicyAssignment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResourceGroupPolicyAssignment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ResourceGroupPolicyAssignmentParameters{}
