...
// GetTerraformResourceIdField returns Terraform identifier field for this ResourcePolicyAssignment
func (tr *ResourcePolicyAssignment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ResourcePolicyAssignment
func (tr *ResourcePolicyAssignment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ResourcePolicyAssignment
func (tr *ResourcePolicyAssignment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ResourcePolicyAssignment
func (tr *ResourcePolicyAssignment) GetParameters() ([]byte, error) {
...
func (tr *ResourcePolicyAssignment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ResourcePolicyAssignmentParameters{}
