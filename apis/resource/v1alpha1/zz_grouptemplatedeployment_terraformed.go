...
// GetTerraformResourceIDField returns Terraform identifier field for this GroupTemplateDeployment
func (tr *GroupTemplateDeployment) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this GroupTemplateDeployment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GroupTemplateDeployment) LateInitialize(attrs []byte) (bool, error) {
	params := &GroupTemplateDeploymentParameters{}
