...
// ResolveReferences of this GroupPolicyAssignment.
func (mg *GroupPolicyAssignment) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this GroupTemplateDeployment.
func (mg *GroupTemplateDeployment) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
