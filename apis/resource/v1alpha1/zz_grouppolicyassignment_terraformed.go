...
// GetTerraformResourceIDField returns Terraform identifier field for this GroupPolicyAssignment
func (tr *GroupPolicyAssignment) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this GroupPolicyAssignment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GroupPolicyAssignment) LateInitialize(attrs []byte) (bool, error) {
	params := &GroupPolicyAssignmentParameters{}
