...
var (
	HybridConnectionAuthorizationRuleKind             = "HybridConnectionAuthorizationRule"
	HybridConnectionAuthorizationRuleGroupKind        = schema.GroupKind{Group: Group, Kind: HybridConnectionAuthorizationRuleKind}.String()
	HybridConnectionAuthorizationRuleKindAPIVersion   = HybridConnectionAuthorizationRuleKind + "." + GroupVersion.String()
	HybridConnectionAuthorizationRuleGroupVersionKind = GroupVersion.WithKind(HybridConnectionAuthorizationRuleKind)
)
