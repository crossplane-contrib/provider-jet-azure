...
var (
	HybridConnectionKind             = "HybridConnection"
	HybridConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: HybridConnectionKind}.String()
	HybridConnectionKindAPIVersion   = HybridConnectionKind + "." + GroupVersion.String()
	HybridConnectionGroupVersionKind = GroupVersion.WithKind(HybridConnectionKind)
)
