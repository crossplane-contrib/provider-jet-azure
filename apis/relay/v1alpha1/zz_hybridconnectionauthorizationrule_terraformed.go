...
// GetTerraformResourceIDField returns Terraform identifier field for this HybridConnectionAuthorizationRule
func (tr *HybridConnectionAuthorizationRule) GetTerraformResourceIDField() string {
	return "id"
}
