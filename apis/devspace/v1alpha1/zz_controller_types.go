...
var (
	...
	ControllerGroupKind        = schema.GroupKind{Group: Group, Kind: ControllerKind}.String()
	ControllerKindAPIVersion   = ControllerKind + "." + GroupVersion.String()
	ControllerGroupVersionKind = GroupVersion.WithKind(ControllerKind)
)
