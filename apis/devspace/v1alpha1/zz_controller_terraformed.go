...
// GetTerraformResourceIDField returns Terraform identifier field for this Controller
func (tr *Controller) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this Controller using its observed tfState.
