...
// GetTerraformResourceIDField returns Terraform identifier field for this AppIntegrationAccountBatchConfiguration
func (tr *AppIntegrationAccountBatchConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
