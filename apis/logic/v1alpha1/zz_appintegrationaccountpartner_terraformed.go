...
// GetTerraformResourceIDField returns Terraform identifier field for this AppIntegrationAccountPartner
func (tr *AppIntegrationAccountPartner) GetTerraformResourceIDField() string {
	return "id"
}
