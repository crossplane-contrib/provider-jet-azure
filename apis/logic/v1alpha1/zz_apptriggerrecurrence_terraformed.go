...
// GetTerraformResourceIDField returns Terraform identifier field for this AppTriggerRecurrence
func (tr *AppTriggerRecurrence) GetTerraformResourceIDField() string {
	return "id"
}
