...
// GetTerraformResourceIDField returns Terraform identifier field for this AppTriggerHttpRequest
func (tr *AppTriggerHttpRequest) GetTerraformResourceIDField() string {
	return "id"
}
