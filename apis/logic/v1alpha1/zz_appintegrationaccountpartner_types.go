...
var (
	AppIntegrationAccountPartnerKind             = "AppIntegrationAccountPartner"
	AppIntegrationAccountPartnerGroupKind        = schema.GroupKind{Group: Group, Kind: AppIntegrationAccountPartnerKind}.String()
	AppIntegrationAccountPartnerKindAPIVersion   = AppIntegrationAccountPartnerKind + "." + GroupVersion.String()
	AppIntegrationAccountPartnerGroupVersionKind = GroupVersion.WithKind(AppIntegrationAccountPartnerKind)
)
