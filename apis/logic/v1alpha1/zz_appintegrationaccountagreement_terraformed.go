...
// GetTerraformResourceIDField returns Terraform identifier field for this AppIntegrationAccountAgreement
func (tr *AppIntegrationAccountAgreement) GetTerraformResourceIDField() string {
	return "id"
}
