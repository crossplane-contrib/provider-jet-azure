...
var (
	AppActionCustomKind             = "AppActionCustom"
	AppActionCustomGroupKind        = schema.GroupKind{Group: Group, Kind: AppActionCustomKind}.String()
	AppActionCustomKindAPIVersion   = AppActionCustomKind + "." + GroupVersion.String()
	AppActionCustomGroupVersionKind = GroupVersion.WithKind(AppActionCustomKind)
)
