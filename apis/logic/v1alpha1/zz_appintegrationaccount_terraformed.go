...
// GetTerraformResourceIDField returns Terraform identifier field for this AppIntegrationAccount
func (tr *AppIntegrationAccount) GetTerraformResourceIDField() string {
	return "id"
}
