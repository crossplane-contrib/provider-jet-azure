...
// GetTerraformResourceIDField returns Terraform identifier field for this AppIntegrationAccountAssembly
func (tr *AppIntegrationAccountAssembly) GetTerraformResourceIDField() string {
	return "id"
}
