...
var (
	AppIntegrationAccountAssemblyKind             = "AppIntegrationAccountAssembly"
	AppIntegrationAccountAssemblyGroupKind        = schema.GroupKind{Group: Group, Kind: AppIntegrationAccountAssemblyKind}.String()
	AppIntegrationAccountAssemblyKindAPIVersion   = AppIntegrationAccountAssemblyKind + "." + GroupVersion.String()
	AppIntegrationAccountAssemblyGroupVersionKind = GroupVersion.WithKind(AppIntegrationAccountAssemblyKind)
)
