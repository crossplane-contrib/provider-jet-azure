...
var (
	AppTriggerCustomKind             = "AppTriggerCustom"
	AppTriggerCustomGroupKind        = schema.GroupKind{Group: Group, Kind: AppTriggerCustomKind}.String()
	AppTriggerCustomKindAPIVersion   = AppTriggerCustomKind + "." + GroupVersion.String()
	AppTriggerCustomGroupVersionKind = GroupVersion.WithKind(AppTriggerCustomKind)
)
