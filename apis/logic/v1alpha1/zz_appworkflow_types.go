...
var (
	AppWorkflowKind             = "AppWorkflow"
	AppWorkflowGroupKind        = schema.GroupKind{Group: Group, Kind: AppWorkflowKind}.String()
	AppWorkflowKindAPIVersion   = AppWorkflowKind + "." + GroupVersion.String()
	AppWorkflowGroupVersionKind = GroupVersion.WithKind(AppWorkflowKind)
)
