...
var (
	AppTriggerHttpRequestKind             = "AppTriggerHttpRequest"
	AppTriggerHttpRequestGroupKind        = schema.GroupKind{Group: Group, Kind: AppTriggerHttpRequestKind}.String()
	AppTriggerHttpRequestKindAPIVersion   = AppTriggerHttpRequestKind + "." + GroupVersion.String()
	AppTriggerHttpRequestGroupVersionKind = GroupVersion.WithKind(AppTriggerHttpRequestKind)
)
