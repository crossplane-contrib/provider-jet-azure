...
var (
	AppIntegrationAccountBatchConfigurationKind             = "AppIntegrationAccountBatchConfiguration"
	AppIntegrationAccountBatchConfigurationGroupKind        = schema.GroupKind{Group: Group, Kind: AppIntegrationAccountBatchConfigurationKind}.String()
	AppIntegrationAccountBatchConfigurationKindAPIVersion   = AppIntegrationAccountBatchConfigurationKind + "." + GroupVersion.String()
	AppIntegrationAccountBatchConfigurationGroupVersionKind = GroupVersion.WithKind(AppIntegrationAccountBatchConfigurationKind)
)
