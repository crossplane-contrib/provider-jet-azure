...
var (
	AppTriggerRecurrenceKind             = "AppTriggerRecurrence"
	AppTriggerRecurrenceGroupKind        = schema.GroupKind{Group: Group, Kind: AppTriggerRecurrenceKind}.String()
	AppTriggerRecurrenceKindAPIVersion   = AppTriggerRecurrenceKind + "." + GroupVersion.String()
	AppTriggerRecurrenceGroupVersionKind = GroupVersion.WithKind(AppTriggerRecurrenceKind)
)
