...
var (
	AppActionHttpKind             = "AppActionHttp"
	AppActionHttpGroupKind        = schema.GroupKind{Group: Group, Kind: AppActionHttpKind}.String()
	AppActionHttpKindAPIVersion   = AppActionHttpKind + "." + GroupVersion.String()
	AppActionHttpGroupVersionKind = GroupVersion.WithKind(AppActionHttpKind)
)
