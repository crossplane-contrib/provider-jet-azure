...
var (
	AppIntegrationAccountKind             = "AppIntegrationAccount"
	AppIntegrationAccountGroupKind        = schema.GroupKind{Group: Group, Kind: AppIntegrationAccountKind}.String()
	AppIntegrationAccountKindAPIVersion   = AppIntegrationAccountKind + "." + GroupVersion.String()
	AppIntegrationAccountGroupVersionKind = GroupVersion.WithKind(AppIntegrationAccountKind)
)
