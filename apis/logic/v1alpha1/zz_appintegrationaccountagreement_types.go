...
var (
	AppIntegrationAccountAgreementKind             = "AppIntegrationAccountAgreement"
	AppIntegrationAccountAgreementGroupKind        = schema.GroupKind{Group: Group, Kind: AppIntegrationAccountAgreementKind}.String()
	AppIntegrationAccountAgreementKindAPIVersion   = AppIntegrationAccountAgreementKind + "." + GroupVersion.String()
	AppIntegrationAccountAgreementGroupVersionKind = GroupVersion.WithKind(AppIntegrationAccountAgreementKind)
)
