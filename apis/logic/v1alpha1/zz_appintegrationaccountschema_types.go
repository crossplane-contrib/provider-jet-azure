...
var (
	AppIntegrationAccountSchemaKind             = "AppIntegrationAccountSchema"
	AppIntegrationAccountSchemaGroupKind        = schema.GroupKind{Group: Group, Kind: AppIntegrationAccountSchemaKind}.String()
	AppIntegrationAccountSchemaKindAPIVersion   = AppIntegrationAccountSchemaKind + "." + GroupVersion.String()
	AppIntegrationAccountSchemaGroupVersionKind = GroupVersion.WithKind(AppIntegrationAccountSchemaKind)
)
