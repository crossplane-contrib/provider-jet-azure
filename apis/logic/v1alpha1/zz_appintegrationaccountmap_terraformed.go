...
// GetTerraformResourceIDField returns Terraform identifier field for this AppIntegrationAccountMap
func (tr *AppIntegrationAccountMap) GetTerraformResourceIDField() string {
	return "id"
}
