...
// GetTerraformResourceIDField returns Terraform identifier field for this AppIntegrationAccountSession
func (tr *AppIntegrationAccountSession) GetTerraformResourceIDField() string {
	return "id"
}
