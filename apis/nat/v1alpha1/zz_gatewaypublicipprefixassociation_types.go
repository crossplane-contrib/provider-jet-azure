...
var (
	GatewayPublicIpPrefixAssociationKind             = "GatewayPublicIpPrefixAssociation"
	GatewayPublicIpPrefixAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: GatewayPublicIpPrefixAssociationKind}.String()
	GatewayPublicIpPrefixAssociationKindAPIVersion   = GatewayPublicIpPrefixAssociationKind + "." + GroupVersion.String()
	GatewayPublicIpPrefixAssociationGroupVersionKind = GroupVersion.WithKind(GatewayPublicIpPrefixAssociationKind)
)
