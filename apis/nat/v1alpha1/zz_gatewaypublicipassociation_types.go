...
var (
	GatewayPublicIpAssociationKind             = "GatewayPublicIpAssociation"
	GatewayPublicIpAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: GatewayPublicIpAssociationKind}.String()
	GatewayPublicIpAssociationKindAPIVersion   = GatewayPublicIpAssociationKind + "." + GroupVersion.String()
	GatewayPublicIpAssociationGroupVersionKind = GroupVersion.WithKind(GatewayPublicIpAssociationKind)
)
