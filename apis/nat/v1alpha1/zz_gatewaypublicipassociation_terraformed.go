...
// GetTerraformResourceIDField returns Terraform identifier field for this GatewayPublicIpAssociation
func (tr *GatewayPublicIpAssociation) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this GatewayPublicIpAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GatewayPublicIpAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &GatewayPublicIpAssociationParameters{}
