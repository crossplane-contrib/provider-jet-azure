...
// GetTerraformResourceIDField returns Terraform identifier field for this GatewayPublicIpPrefixAssociation
func (tr *GatewayPublicIpPrefixAssociation) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this GatewayPublicIpPrefixAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GatewayPublicIpPrefixAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &GatewayPublicIpPrefixAssociationParameters{}
