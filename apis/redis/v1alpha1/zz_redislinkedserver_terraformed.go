...
// GetTerraformResourceIdField returns Terraform identifier field for this RedisLinkedServer
func (tr *RedisLinkedServer) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this RedisLinkedServer
func (tr *RedisLinkedServer) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this RedisLinkedServer
func (tr *RedisLinkedServer) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this RedisLinkedServer
func (tr *RedisLinkedServer) GetParameters() ([]byte, error) {
...
func (tr *RedisLinkedServer) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &RedisLinkedServerParameters{}
