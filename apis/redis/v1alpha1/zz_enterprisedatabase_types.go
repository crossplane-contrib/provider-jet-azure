...
var (
	EnterpriseDatabaseKind             = "EnterpriseDatabase"
	EnterpriseDatabaseGroupKind        = schema.GroupKind{Group: Group, Kind: EnterpriseDatabaseKind}.String()
	EnterpriseDatabaseKindAPIVersion   = EnterpriseDatabaseKind + "." + GroupVersion.String()
	EnterpriseDatabaseGroupVersionKind = GroupVersion.WithKind(EnterpriseDatabaseKind)
)
