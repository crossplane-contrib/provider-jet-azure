...
// GetTerraformResourceIdField returns Terraform identifier field for this RedisEnterpriseCluster
func (tr *RedisEnterpriseCluster) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this RedisEnterpriseCluster
func (tr *RedisEnterpriseCluster) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this RedisEnterpriseCluster
func (tr *RedisEnterpriseCluster) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this RedisEnterpriseCluster
func (tr *RedisEnterpriseCluster) GetParameters() ([]byte, error) {
...
func (tr *RedisEnterpriseCluster) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &RedisEnterpriseClusterParameters{}
