...
// GetTerraformResourceIdField returns Terraform identifier field for this RedisEnterpriseDatabase
func (tr *RedisEnterpriseDatabase) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this RedisEnterpriseDatabase
func (tr *RedisEnterpriseDatabase) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this RedisEnterpriseDatabase
func (tr *RedisEnterpriseDatabase) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this RedisEnterpriseDatabase
func (tr *RedisEnterpriseDatabase) GetParameters() ([]byte, error) {
...
func (tr *RedisEnterpriseDatabase) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &RedisEnterpriseDatabaseParameters{}
