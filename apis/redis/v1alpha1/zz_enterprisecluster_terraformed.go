...
// GetTerraformResourceIDField returns Terraform identifier field for this EnterpriseCluster
func (tr *EnterpriseCluster) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this EnterpriseCluster using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EnterpriseCluster) LateInitialize(attrs []byte) (bool, error) {
	params := &EnterpriseClusterParameters{}
