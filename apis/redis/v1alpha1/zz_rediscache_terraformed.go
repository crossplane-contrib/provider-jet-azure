...
// GetTerraformResourceIdField returns Terraform identifier field for this RedisCache
func (tr *RedisCache) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this RedisCache
func (tr *RedisCache) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this RedisCache
func (tr *RedisCache) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this RedisCache
func (tr *RedisCache) GetParameters() ([]byte, error) {
...
func (tr *RedisCache) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &RedisCacheParameters{}
