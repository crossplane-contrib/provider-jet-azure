...
// GetTerraformResourceIdField returns Terraform identifier field for this RedisFirewallRule
func (tr *RedisFirewallRule) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this RedisFirewallRule
func (tr *RedisFirewallRule) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this RedisFirewallRule
func (tr *RedisFirewallRule) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this RedisFirewallRule
func (tr *RedisFirewallRule) GetParameters() ([]byte, error) {
...
func (tr *RedisFirewallRule) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &RedisFirewallRuleParameters{}
