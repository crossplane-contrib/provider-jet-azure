...
var (
	LinkedServerKind             = "LinkedServer"
	LinkedServerGroupKind        = schema.GroupKind{Group: Group, Kind: LinkedServerKind}.String()
	LinkedServerKindAPIVersion   = LinkedServerKind + "." + GroupVersion.String()
	LinkedServerGroupVersionKind = GroupVersion.WithKind(LinkedServerKind)
)
