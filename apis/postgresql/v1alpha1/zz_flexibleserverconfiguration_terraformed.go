...
// GetTerraformResourceIDField returns Terraform identifier field for this FlexibleServerConfiguration
func (tr *FlexibleServerConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
