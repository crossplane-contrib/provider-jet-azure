...
// GetTerraformResourceIdField returns Terraform identifier field for this PostgresqlDatabase
func (tr *PostgresqlDatabase) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PostgresqlDatabase
func (tr *PostgresqlDatabase) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PostgresqlDatabase
func (tr *PostgresqlDatabase) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PostgresqlDatabase
func (tr *PostgresqlDatabase) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PostgresqlDatabase
func (tr *PostgresqlDatabase) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PostgresqlDatabase using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PostgresqlDatabase) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PostgresqlDatabaseParameters{}
