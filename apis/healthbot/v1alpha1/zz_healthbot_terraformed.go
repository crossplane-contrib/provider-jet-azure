...
// GetTerraformResourceIdField returns Terraform identifier field for this Healthbot
func (tr *Healthbot) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this Healthbot
func (tr *Healthbot) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this Healthbot
func (tr *Healthbot) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this Healthbot
func (tr *Healthbot) GetParameters() ([]byte, error) {
...
func (tr *Healthbot) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &HealthbotParameters{}
