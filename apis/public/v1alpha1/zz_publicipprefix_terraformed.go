...
func (tr *PublicIpPrefix) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PublicIpPrefix
func (tr *PublicIpPrefix) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PublicIpPrefix
func (tr *PublicIpPrefix) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PublicIpPrefix
func (tr *PublicIpPrefix) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PublicIpPrefix using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PublicIpPrefix) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PublicIpPrefixParameters{}
