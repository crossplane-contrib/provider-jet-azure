...
// GetTerraformResourceIdField returns Terraform identifier field for this PublicIp
func (tr *PublicIp) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PublicIp
func (tr *PublicIp) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PublicIp
func (tr *PublicIp) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PublicIp
func (tr *PublicIp) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PublicIp
func (tr *PublicIp) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PublicIp using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PublicIp) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PublicIpParameters{}
