...
func (tr *NotificationHubNamespace) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this NotificationHubNamespace
func (tr *NotificationHubNamespace) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this NotificationHubNamespace
func (tr *NotificationHubNamespace) GetParameters() ([]byte, error) {
...
func (tr *NotificationHubNamespace) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &NotificationHubNamespaceParameters{}
