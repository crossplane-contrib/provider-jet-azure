...
// GetTerraformResourceIDField returns Terraform identifier field for this NotificationHubNamespace
func (tr *NotificationHubNamespace) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *NotificationHubNamespace) GetObservation() (map[string]interface{}, error) {
...
func (tr *NotificationHubNamespace) SetObservation(obs map[string]interface{}) error {
...
func (tr *NotificationHubNamespace) GetParameters() (map[string]interface{}, error) {
...
func (tr *NotificationHubNamespace) SetParameters(params map[string]interface{}) error {
