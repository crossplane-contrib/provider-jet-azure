...
var (
	HubKind             = "Hub"
	HubGroupKind        = schema.GroupKind{Group: Group, Kind: HubKind}.String()
	HubKindAPIVersion   = HubKind + "." + GroupVersion.String()
	HubGroupVersionKind = GroupVersion.WithKind(HubKind)
)
