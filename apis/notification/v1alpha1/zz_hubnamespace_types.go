...
var (
	HubNamespaceKind             = "HubNamespace"
	HubNamespaceGroupKind        = schema.GroupKind{Group: Group, Kind: HubNamespaceKind}.String()
	HubNamespaceKindAPIVersion   = HubNamespaceKind + "." + GroupVersion.String()
	HubNamespaceGroupVersionKind = GroupVersion.WithKind(HubNamespaceKind)
)
