...
// GetTerraformResourceIDField returns Terraform identifier field for this HubNamespace
func (tr *HubNamespace) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this HubNamespace using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HubNamespace) LateInitialize(attrs []byte) (bool, error) {
	params := &HubNamespaceParameters{}
