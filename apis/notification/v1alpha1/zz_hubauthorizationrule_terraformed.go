...
// GetTerraformResourceIDField returns Terraform identifier field for this HubAuthorizationRule
func (tr *HubAuthorizationRule) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this HubAuthorizationRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HubAuthorizationRule) LateInitialize(attrs []byte) (bool, error) {
	params := &HubAuthorizationRuleParameters{}
