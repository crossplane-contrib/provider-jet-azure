...
// GetTerraformResourceIdField returns Terraform identifier field for this NotificationHub
func (tr *NotificationHub) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this NotificationHub
func (tr *NotificationHub) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this NotificationHub
func (tr *NotificationHub) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this NotificationHub
func (tr *NotificationHub) GetParameters() ([]byte, error) {
...
func (tr *NotificationHub) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &NotificationHubParameters{}
