...
func (tr *DatabaseMigrationProject) GetObservation() (map[string]interface{}, error) {
...
func (tr *DatabaseMigrationProject) SetObservation(obs map[string]interface{}) error {
...
func (tr *DatabaseMigrationProject) GetParameters() (map[string]interface{}, error) {
...
func (tr *DatabaseMigrationProject) SetParameters(params map[string]interface{}) error {
...
func (tr *DatabaseMigrationService) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *DatabaseMigrationService) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
func (tr *DatabaseMigrationService) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *DatabaseMigrationService) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
