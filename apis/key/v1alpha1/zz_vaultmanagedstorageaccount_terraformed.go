...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultManagedStorageAccount
func (tr *VaultManagedStorageAccount) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VaultManagedStorageAccount using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultManagedStorageAccount) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultManagedStorageAccountParameters{}
