...
var (
	VaultKeyKind             = "VaultKey"
	VaultKeyGroupKind        = schema.GroupKind{Group: Group, Kind: VaultKeyKind}.String()
	VaultKeyKindAPIVersion   = VaultKeyKind + "." + GroupVersion.String()
	VaultKeyGroupVersionKind = GroupVersion.WithKind(VaultKeyKind)
)
