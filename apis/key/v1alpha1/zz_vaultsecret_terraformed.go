...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultSecret
func (tr *VaultSecret) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VaultSecret using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultSecret) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultSecretParameters{}
