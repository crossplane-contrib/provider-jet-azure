...
var (
	VaultManagedStorageAccountSasTokenDefinitionKind             = "VaultManagedStorageAccountSasTokenDefinition"
	VaultManagedStorageAccountSasTokenDefinitionGroupKind        = schema.GroupKind{Group: Group, Kind: VaultManagedStorageAccountSasTokenDefinitionKind}.String()
	VaultManagedStorageAccountSasTokenDefinitionKindAPIVersion   = VaultManagedStorageAccountSasTokenDefinitionKind + "." + GroupVersion.String()
	VaultManagedStorageAccountSasTokenDefinitionGroupVersionKind = GroupVersion.WithKind(VaultManagedStorageAccountSasTokenDefinitionKind)
)
