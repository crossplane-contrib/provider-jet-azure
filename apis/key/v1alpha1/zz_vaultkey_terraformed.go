...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultKey
func (tr *VaultKey) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VaultKey using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultKey) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultKeyParameters{}
