...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultManagedHardwareSecurityModule
func (tr *VaultManagedHardwareSecurityModule) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VaultManagedHardwareSecurityModule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultManagedHardwareSecurityModule) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultManagedHardwareSecurityModuleParameters{}
