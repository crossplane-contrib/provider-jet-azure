...
var (
	VaultCertificateIssuerKind             = "VaultCertificateIssuer"
	VaultCertificateIssuerGroupKind        = schema.GroupKind{Group: Group, Kind: VaultCertificateIssuerKind}.String()
	VaultCertificateIssuerKindAPIVersion   = VaultCertificateIssuerKind + "." + GroupVersion.String()
	VaultCertificateIssuerGroupVersionKind = GroupVersion.WithKind(VaultCertificateIssuerKind)
)
