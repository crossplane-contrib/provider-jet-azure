...
var (
	VaultCertificateKind             = "VaultCertificate"
	VaultCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: VaultCertificateKind}.String()
	VaultCertificateKindAPIVersion   = VaultCertificateKind + "." + GroupVersion.String()
	VaultCertificateGroupVersionKind = GroupVersion.WithKind(VaultCertificateKind)
)
