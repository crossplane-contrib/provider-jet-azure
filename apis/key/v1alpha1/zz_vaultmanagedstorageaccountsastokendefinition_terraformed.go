...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultManagedStorageAccountSasTokenDefinition
func (tr *VaultManagedStorageAccountSasTokenDefinition) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VaultManagedStorageAccountSasTokenDefinition using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultManagedStorageAccountSasTokenDefinition) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultManagedStorageAccountSasTokenDefinitionParameters{}
