...
var (
	...
	VaultSecretGroupKind        = schema.GroupKind{Group: Group, Kind: VaultSecretKind}.String()
	VaultSecretKindAPIVersion   = VaultSecretKind + "." + GroupVersion.String()
	VaultSecretGroupVersionKind = GroupVersion.WithKind(VaultSecretKind)
)
