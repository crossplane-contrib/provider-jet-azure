...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultCertificateIssuer
func (tr *VaultCertificateIssuer) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VaultCertificateIssuer using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultCertificateIssuer) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultCertificateIssuerParameters{}
