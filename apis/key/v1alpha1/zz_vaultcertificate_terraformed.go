...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultCertificate
func (tr *VaultCertificate) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VaultCertificate using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultCertificate) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultCertificateParameters{}
