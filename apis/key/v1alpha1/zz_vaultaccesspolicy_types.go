...
var (
	VaultAccessPolicyKind             = "VaultAccessPolicy"
	VaultAccessPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: VaultAccessPolicyKind}.String()
	VaultAccessPolicyKindAPIVersion   = VaultAccessPolicyKind + "." + GroupVersion.String()
	VaultAccessPolicyGroupVersionKind = GroupVersion.WithKind(VaultAccessPolicyKind)
)
