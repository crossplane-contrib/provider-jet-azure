...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultAccessPolicy
func (tr *VaultAccessPolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VaultAccessPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultAccessPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultAccessPolicyParameters{}
