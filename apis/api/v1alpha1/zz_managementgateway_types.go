...
var (
	ManagementGatewayKind             = "ManagementGateway"
	ManagementGatewayGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementGatewayKind}.String()
	ManagementGatewayKindAPIVersion   = ManagementGatewayKind + "." + GroupVersion.String()
	ManagementGatewayGroupVersionKind = GroupVersion.WithKind(ManagementGatewayKind)
)
