...
var (
	ManagementAuthorizationServerKind             = "ManagementAuthorizationServer"
	ManagementAuthorizationServerGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementAuthorizationServerKind}.String()
	ManagementAuthorizationServerKindAPIVersion   = ManagementAuthorizationServerKind + "." + GroupVersion.String()
	ManagementAuthorizationServerGroupVersionKind = GroupVersion.WithKind(ManagementAuthorizationServerKind)
)
