...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementAuthorizationServer
func (tr *ManagementAuthorizationServer) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementAuthorizationServer using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementAuthorizationServer) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementAuthorizationServerParameters{}
