...
var (
	ManagementIdentityProviderFacebookKind             = "ManagementIdentityProviderFacebook"
	ManagementIdentityProviderFacebookGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementIdentityProviderFacebookKind}.String()
	ManagementIdentityProviderFacebookKindAPIVersion   = ManagementIdentityProviderFacebookKind + "." + GroupVersion.String()
	ManagementIdentityProviderFacebookGroupVersionKind = GroupVersion.WithKind(ManagementIdentityProviderFacebookKind)
)
