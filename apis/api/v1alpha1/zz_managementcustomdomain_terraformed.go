...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementCustomDomain
func (tr *ManagementCustomDomain) GetTerraformResourceIDField() string {
	return "id"
}
