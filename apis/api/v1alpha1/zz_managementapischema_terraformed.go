...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApiSchema
func (tr *ManagementApiSchema) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApiSchema using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApiSchema) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiSchemaParameters{}
