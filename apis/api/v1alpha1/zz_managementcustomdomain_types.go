...
var (
	ManagementCustomDomainKind             = "ManagementCustomDomain"
	ManagementCustomDomainGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementCustomDomainKind}.String()
	ManagementCustomDomainKindAPIVersion   = ManagementCustomDomainKind + "." + GroupVersion.String()
	ManagementCustomDomainGroupVersionKind = GroupVersion.WithKind(ManagementCustomDomainKind)
)
