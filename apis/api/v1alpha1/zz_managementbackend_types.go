...
var (
	ManagementBackendKind             = "ManagementBackend"
	ManagementBackendGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementBackendKind}.String()
	ManagementBackendKindAPIVersion   = ManagementBackendKind + "." + GroupVersion.String()
	ManagementBackendGroupVersionKind = GroupVersion.WithKind(ManagementBackendKind)
)
