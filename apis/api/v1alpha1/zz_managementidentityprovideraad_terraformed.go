...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementIdentityProviderAad
func (tr *ManagementIdentityProviderAad) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementIdentityProviderAad using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementIdentityProviderAad) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementIdentityProviderAadParameters{}
