...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApiOperation
func (tr *ManagementApiOperation) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApiOperation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApiOperation) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiOperationParameters{}
