...
var (
	ManagementApiVersionSetKind             = "ManagementApiVersionSet"
	ManagementApiVersionSetGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementApiVersionSetKind}.String()
	ManagementApiVersionSetKindAPIVersion   = ManagementApiVersionSetKind + "." + GroupVersion.String()
	ManagementApiVersionSetGroupVersionKind = GroupVersion.WithKind(ManagementApiVersionSetKind)
)
