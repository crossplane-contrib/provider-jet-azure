...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApiPolicy
func (tr *ManagementApiPolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApiPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApiPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiPolicyParameters{}
