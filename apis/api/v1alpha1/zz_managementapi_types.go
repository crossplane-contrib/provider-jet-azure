...
var (
	ManagementApiKind             = "ManagementApi"
	ManagementApiGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementApiKind}.String()
	ManagementApiKindAPIVersion   = ManagementApiKind + "." + GroupVersion.String()
	ManagementApiGroupVersionKind = GroupVersion.WithKind(ManagementApiKind)
)
