...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementBackend
func (tr *ManagementBackend) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementBackend using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementBackend) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementBackendParameters{}
