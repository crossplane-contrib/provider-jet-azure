...
var (
	ManagementIdentityProviderMicrosoftKind             = "ManagementIdentityProviderMicrosoft"
	ManagementIdentityProviderMicrosoftGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementIdentityProviderMicrosoftKind}.String()
	ManagementIdentityProviderMicrosoftKindAPIVersion   = ManagementIdentityProviderMicrosoftKind + "." + GroupVersion.String()
	ManagementIdentityProviderMicrosoftGroupVersionKind = GroupVersion.WithKind(ManagementIdentityProviderMicrosoftKind)
)
