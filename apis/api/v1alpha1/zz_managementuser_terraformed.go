...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementUser
func (tr *ManagementUser) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementUser using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementUser) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementUserParameters{}
