...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementProductPolicy
func (tr *ManagementProductPolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementProductPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementProductPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementProductPolicyParameters{}
