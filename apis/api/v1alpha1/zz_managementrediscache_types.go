...
var (
	ManagementRedisCacheKind             = "ManagementRedisCache"
	ManagementRedisCacheGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementRedisCacheKind}.String()
	ManagementRedisCacheKindAPIVersion   = ManagementRedisCacheKind + "." + GroupVersion.String()
	ManagementRedisCacheGroupVersionKind = GroupVersion.WithKind(ManagementRedisCacheKind)
)
