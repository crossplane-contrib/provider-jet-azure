...
var (
	ManagementApiSchemaKind             = "ManagementApiSchema"
	ManagementApiSchemaGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementApiSchemaKind}.String()
	ManagementApiSchemaKindAPIVersion   = ManagementApiSchemaKind + "." + GroupVersion.String()
	ManagementApiSchemaGroupVersionKind = GroupVersion.WithKind(ManagementApiSchemaKind)
)
