...
var (
	ManagementIdentityProviderTwitterKind             = "ManagementIdentityProviderTwitter"
	ManagementIdentityProviderTwitterGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementIdentityProviderTwitterKind}.String()
	ManagementIdentityProviderTwitterKindAPIVersion   = ManagementIdentityProviderTwitterKind + "." + GroupVersion.String()
	ManagementIdentityProviderTwitterGroupVersionKind = GroupVersion.WithKind(ManagementIdentityProviderTwitterKind)
)
