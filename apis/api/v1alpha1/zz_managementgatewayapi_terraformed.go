...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementGatewayApi
func (tr *ManagementGatewayApi) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementGatewayApi using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementGatewayApi) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementGatewayApiParameters{}
