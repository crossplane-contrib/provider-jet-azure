...
var (
	ManagementApiReleaseKind             = "ManagementApiRelease"
	ManagementApiReleaseGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementApiReleaseKind}.String()
	ManagementApiReleaseKindAPIVersion   = ManagementApiReleaseKind + "." + GroupVersion.String()
	ManagementApiReleaseGroupVersionKind = GroupVersion.WithKind(ManagementApiReleaseKind)
)
