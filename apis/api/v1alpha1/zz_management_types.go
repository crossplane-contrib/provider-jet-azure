...
var (
	...
	ManagementGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementKind}.String()
	ManagementKindAPIVersion   = ManagementKind + "." + GroupVersion.String()
	ManagementGroupVersionKind = GroupVersion.WithKind(ManagementKind)
)
