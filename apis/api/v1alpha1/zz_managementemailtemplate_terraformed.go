...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementEmailTemplate
func (tr *ManagementEmailTemplate) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementEmailTemplate using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementEmailTemplate) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementEmailTemplateParameters{}
