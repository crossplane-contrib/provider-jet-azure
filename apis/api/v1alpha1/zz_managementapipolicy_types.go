...
var (
	ManagementApiPolicyKind             = "ManagementApiPolicy"
	ManagementApiPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementApiPolicyKind}.String()
	ManagementApiPolicyKindAPIVersion   = ManagementApiPolicyKind + "." + GroupVersion.String()
	ManagementApiPolicyGroupVersionKind = GroupVersion.WithKind(ManagementApiPolicyKind)
)
