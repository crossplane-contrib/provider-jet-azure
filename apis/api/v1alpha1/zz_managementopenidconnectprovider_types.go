...
// ManagementOpenidConnectProvider is the Schema for the ManagementOpenidConnectProviders API
...
var (
	ManagementOpenidConnectProviderKind             = "ManagementOpenidConnectProvider"
	ManagementOpenidConnectProviderGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementOpenidConnectProviderKind}.String()
	ManagementOpenidConnectProviderKindAPIVersion   = ManagementOpenidConnectProviderKind + "." + GroupVersion.String()
	ManagementOpenidConnectProviderGroupVersionKind = GroupVersion.WithKind(ManagementOpenidConnectProviderKind)
)

func init() {
	SchemeBuilder.Register(&ManagementOpenidConnectProvider{}, &ManagementOpenidConnectProviderList{})
}
