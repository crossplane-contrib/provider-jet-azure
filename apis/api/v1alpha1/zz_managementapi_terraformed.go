...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApi
func (tr *ManagementApi) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApi using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApi) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiParameters{}
