...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApiVersionSet
func (tr *ManagementApiVersionSet) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApiVersionSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApiVersionSet) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiVersionSetParameters{}
