...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementNamedValue
func (tr *ManagementNamedValue) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementNamedValue using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementNamedValue) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementNamedValueParameters{}
