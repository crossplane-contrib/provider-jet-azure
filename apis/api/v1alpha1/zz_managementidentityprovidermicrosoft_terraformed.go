...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementIdentityProviderMicrosoft
func (tr *ManagementIdentityProviderMicrosoft) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementIdentityProviderMicrosoft using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementIdentityProviderMicrosoft) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementIdentityProviderMicrosoftParameters{}
