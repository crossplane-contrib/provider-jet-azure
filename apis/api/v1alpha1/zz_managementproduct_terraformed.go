...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementProduct
func (tr *ManagementProduct) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementProduct using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementProduct) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementProductParameters{}
