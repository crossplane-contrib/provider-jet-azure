...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementLogger
func (tr *ManagementLogger) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementLogger using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementLogger) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementLoggerParameters{}
