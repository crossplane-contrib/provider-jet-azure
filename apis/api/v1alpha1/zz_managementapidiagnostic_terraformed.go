...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApiDiagnostic
func (tr *ManagementApiDiagnostic) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApiDiagnostic using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApiDiagnostic) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiDiagnosticParameters{}
