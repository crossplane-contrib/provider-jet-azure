...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementProperty
func (tr *ManagementProperty) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementProperty using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementProperty) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementPropertyParameters{}
