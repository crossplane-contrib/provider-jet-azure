...
var (
	ManagementIdentityProviderAadKind             = "ManagementIdentityProviderAad"
	ManagementIdentityProviderAadGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementIdentityProviderAadKind}.String()
	ManagementIdentityProviderAadKindAPIVersion   = ManagementIdentityProviderAadKind + "." + GroupVersion.String()
	ManagementIdentityProviderAadGroupVersionKind = GroupVersion.WithKind(ManagementIdentityProviderAadKind)
)
