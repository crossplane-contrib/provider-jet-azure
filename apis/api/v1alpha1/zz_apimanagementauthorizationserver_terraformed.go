...
// GetConnectionDetailsMapping for this ApiManagementAuthorizationServer
func (tr *ApiManagementAuthorizationServer) GetConnectionDetailsMapping() map[string]string {
...
func (tr *ApiManagementAuthorizationServer) GetObservation() (map[string]interface{}, error) {
...
func (tr *ApiManagementAuthorizationServer) SetObservation(obs map[string]interface{}) error {
...
func (tr *ApiManagementAuthorizationServer) GetParameters() (map[string]interface{}, error) {
...
func (tr *ApiManagementAuthorizationServer) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this ApiManagementAuthorizationServer using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ApiManagementAuthorizationServer) LateInitialize(attrs []byte) (bool, error) {
	params := &ApiManagementAuthorizationServerParameters{}
...
func (tr *ApiManagementAuthorizationServer) GetTerraformSchemaVersion() int {
	return 0
}
