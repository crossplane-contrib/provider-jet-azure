...
// ManagementSubscription is the Schema for the ManagementSubscriptions API
...
var (
	ManagementSubscriptionKind             = "ManagementSubscription"
	ManagementSubscriptionGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementSubscriptionKind}.String()
	ManagementSubscriptionKindAPIVersion   = ManagementSubscriptionKind + "." + GroupVersion.String()
	ManagementSubscriptionGroupVersionKind = GroupVersion.WithKind(ManagementSubscriptionKind)
)

func init() {
	SchemeBuilder.Register(&ManagementSubscription{}, &ManagementSubscriptionList{})
}
