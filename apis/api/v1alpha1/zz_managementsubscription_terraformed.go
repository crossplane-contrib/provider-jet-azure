...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementSubscription
func (tr *ManagementSubscription) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementSubscription using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementSubscription) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementSubscriptionParameters{}
