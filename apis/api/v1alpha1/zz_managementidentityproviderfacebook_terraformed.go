...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementIdentityProviderFacebook
func (tr *ManagementIdentityProviderFacebook) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementIdentityProviderFacebook using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementIdentityProviderFacebook) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementIdentityProviderFacebookParameters{}
