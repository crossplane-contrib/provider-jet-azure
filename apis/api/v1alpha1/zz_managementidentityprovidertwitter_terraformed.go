...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementIdentityProviderTwitter
func (tr *ManagementIdentityProviderTwitter) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementIdentityProviderTwitter using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementIdentityProviderTwitter) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementIdentityProviderTwitterParameters{}
