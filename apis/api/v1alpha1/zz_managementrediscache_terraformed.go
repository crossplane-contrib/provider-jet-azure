...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementRedisCache
func (tr *ManagementRedisCache) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementRedisCache using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementRedisCache) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementRedisCacheParameters{}
