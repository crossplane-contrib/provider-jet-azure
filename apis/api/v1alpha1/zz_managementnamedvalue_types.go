...
// ManagementNamedValue is the Schema for the ManagementNamedValues API
...
var (
	ManagementNamedValueKind             = "ManagementNamedValue"
	ManagementNamedValueGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementNamedValueKind}.String()
	ManagementNamedValueKindAPIVersion   = ManagementNamedValueKind + "." + GroupVersion.String()
	ManagementNamedValueGroupVersionKind = GroupVersion.WithKind(ManagementNamedValueKind)
)

func init() {
	SchemeBuilder.Register(&ManagementNamedValue{}, &ManagementNamedValueList{})
}
