...
var (
	ManagementDiagnosticKind             = "ManagementDiagnostic"
	ManagementDiagnosticGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementDiagnosticKind}.String()
	ManagementDiagnosticKindAPIVersion   = ManagementDiagnosticKind + "." + GroupVersion.String()
	ManagementDiagnosticGroupVersionKind = GroupVersion.WithKind(ManagementDiagnosticKind)
)
