...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementTag
func (tr *ManagementTag) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementTag using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementTag) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementTagParameters{}
