...
// GetTerraformResourceIdField returns Terraform identifier field for this ApiManagement
func (tr *ApiManagement) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this ApiManagement
func (tr *ApiManagement) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this ApiManagement
func (tr *ApiManagement) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this ApiManagement
func (tr *ApiManagement) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this ApiManagement
func (tr *ApiManagement) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this ApiManagement using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ApiManagement) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &ApiManagementParameters{}
