...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementProductApi
func (tr *ManagementProductApi) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementProductApi using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementProductApi) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementProductApiParameters{}
