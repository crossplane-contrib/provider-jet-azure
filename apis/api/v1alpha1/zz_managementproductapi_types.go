...
// ManagementProductApi is the Schema for the ManagementProductApis API
...
var (
	ManagementProductApiKind             = "ManagementProductApi"
	ManagementProductApiGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementProductApiKind}.String()
	ManagementProductApiKindAPIVersion   = ManagementProductApiKind + "." + GroupVersion.String()
	ManagementProductApiGroupVersionKind = GroupVersion.WithKind(ManagementProductApiKind)
)

func init() {
	SchemeBuilder.Register(&ManagementProductApi{}, &ManagementProductApiList{})
}
