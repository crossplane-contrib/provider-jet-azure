...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementCertificate
func (tr *ManagementCertificate) GetTerraformResourceIDField() string {
	return "id"
}
