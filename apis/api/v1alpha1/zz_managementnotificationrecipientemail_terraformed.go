...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementNotificationRecipientEmail
func (tr *ManagementNotificationRecipientEmail) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementNotificationRecipientEmail using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementNotificationRecipientEmail) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementNotificationRecipientEmailParameters{}
