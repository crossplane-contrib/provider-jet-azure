...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApiRelease
func (tr *ManagementApiRelease) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApiRelease using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApiRelease) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiReleaseParameters{}
