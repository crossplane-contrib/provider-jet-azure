...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApiOperationPolicy
func (tr *ManagementApiOperationPolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApiOperationPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApiOperationPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiOperationPolicyParameters{}
