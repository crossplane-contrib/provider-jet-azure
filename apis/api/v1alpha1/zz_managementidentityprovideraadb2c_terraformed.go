...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementIdentityProviderAadb2C
func (tr *ManagementIdentityProviderAadb2C) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementIdentityProviderAadb2C using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementIdentityProviderAadb2C) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementIdentityProviderAadb2CParameters{}
