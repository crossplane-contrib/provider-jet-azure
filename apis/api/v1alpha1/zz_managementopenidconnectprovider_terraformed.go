...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementOpenidConnectProvider
func (tr *ManagementOpenidConnectProvider) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementOpenidConnectProvider using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementOpenidConnectProvider) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementOpenidConnectProviderParameters{}
