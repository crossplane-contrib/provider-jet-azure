...
var (
	ManagementIdentityProviderGoogleKind             = "ManagementIdentityProviderGoogle"
	ManagementIdentityProviderGoogleGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementIdentityProviderGoogleKind}.String()
	ManagementIdentityProviderGoogleKindAPIVersion   = ManagementIdentityProviderGoogleKind + "." + GroupVersion.String()
	ManagementIdentityProviderGoogleGroupVersionKind = GroupVersion.WithKind(ManagementIdentityProviderGoogleKind)
)
