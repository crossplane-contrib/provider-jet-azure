...
var (
	ManagementPropertyKind             = "ManagementProperty"
	ManagementPropertyGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementPropertyKind}.String()
	ManagementPropertyKindAPIVersion   = ManagementPropertyKind + "." + GroupVersion.String()
	ManagementPropertyGroupVersionKind = GroupVersion.WithKind(ManagementPropertyKind)
)
