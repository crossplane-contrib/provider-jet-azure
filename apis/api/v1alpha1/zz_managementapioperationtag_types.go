...
var (
	ManagementApiOperationTagKind             = "ManagementApiOperationTag"
	ManagementApiOperationTagGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementApiOperationTagKind}.String()
	ManagementApiOperationTagKindAPIVersion   = ManagementApiOperationTagKind + "." + GroupVersion.String()
	ManagementApiOperationTagGroupVersionKind = GroupVersion.WithKind(ManagementApiOperationTagKind)
)
