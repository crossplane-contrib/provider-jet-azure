...
var (
	ManagementNotificationRecipientEmailKind             = "ManagementNotificationRecipientEmail"
	ManagementNotificationRecipientEmailGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementNotificationRecipientEmailKind}.String()
	ManagementNotificationRecipientEmailKindAPIVersion   = ManagementNotificationRecipientEmailKind + "." + GroupVersion.String()
	ManagementNotificationRecipientEmailGroupVersionKind = GroupVersion.WithKind(ManagementNotificationRecipientEmailKind)
)
