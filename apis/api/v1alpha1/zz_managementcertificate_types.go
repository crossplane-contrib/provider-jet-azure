...
var (
	ManagementCertificateKind             = "ManagementCertificate"
	ManagementCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementCertificateKind}.String()
	ManagementCertificateKindAPIVersion   = ManagementCertificateKind + "." + GroupVersion.String()
	ManagementCertificateGroupVersionKind = GroupVersion.WithKind(ManagementCertificateKind)
)
