...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementIdentityProviderGoogle
func (tr *ManagementIdentityProviderGoogle) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementIdentityProviderGoogle using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementIdentityProviderGoogle) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementIdentityProviderGoogleParameters{}
