...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementApiOperationTag
func (tr *ManagementApiOperationTag) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementApiOperationTag using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementApiOperationTag) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementApiOperationTagParameters{}
