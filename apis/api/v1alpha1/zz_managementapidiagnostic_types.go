...
// ManagementApiDiagnostic is the Schema for the ManagementApiDiagnostics API
...
var (
	ManagementApiDiagnosticKind             = "ManagementApiDiagnostic"
	ManagementApiDiagnosticGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementApiDiagnosticKind}.String()
	ManagementApiDiagnosticKindAPIVersion   = ManagementApiDiagnosticKind + "." + GroupVersion.String()
	ManagementApiDiagnosticGroupVersionKind = GroupVersion.WithKind(ManagementApiDiagnosticKind)
)

func init() {
	SchemeBuilder.Register(&ManagementApiDiagnostic{}, &ManagementApiDiagnosticList{})
}
