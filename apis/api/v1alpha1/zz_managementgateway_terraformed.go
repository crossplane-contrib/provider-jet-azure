...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementGateway
func (tr *ManagementGateway) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementGateway using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementGateway) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementGatewayParameters{}
