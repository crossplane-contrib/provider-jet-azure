...
// GetConnectionDetailsMapping for this ApiManagementLogger
func (tr *ApiManagementLogger) GetConnectionDetailsMapping() map[string]string {
...
func (tr *ApiManagementLogger) GetObservation() (map[string]interface{}, error) {
...
func (tr *ApiManagementLogger) SetObservation(obs map[string]interface{}) error {
...
func (tr *ApiManagementLogger) GetParameters() (map[string]interface{}, error) {
...
func (tr *ApiManagementLogger) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this ApiManagementLogger using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ApiManagementLogger) LateInitialize(attrs []byte) (bool, error) {
	params := &ApiManagementLoggerParameters{}
...
func (tr *ApiManagementLogger) GetTerraformSchemaVersion() int {
	return 0
}
