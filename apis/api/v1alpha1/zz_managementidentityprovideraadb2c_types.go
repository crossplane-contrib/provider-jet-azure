...
var (
	ManagementIdentityProviderAadb2CKind             = "ManagementIdentityProviderAadb2C"
	ManagementIdentityProviderAadb2CGroupKind        = schema.GroupKind{Group: Group, Kind: ManagementIdentityProviderAadb2CKind}.String()
	ManagementIdentityProviderAadb2CKindAPIVersion   = ManagementIdentityProviderAadb2CKind + "." + GroupVersion.String()
	ManagementIdentityProviderAadb2CGroupVersionKind = GroupVersion.WithKind(ManagementIdentityProviderAadb2CKind)
)
