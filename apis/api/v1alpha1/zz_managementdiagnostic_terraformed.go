...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagementDiagnostic
func (tr *ManagementDiagnostic) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ManagementDiagnostic using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ManagementDiagnostic) LateInitialize(attrs []byte) (bool, error) {
	params := &ManagementDiagnosticParameters{}
