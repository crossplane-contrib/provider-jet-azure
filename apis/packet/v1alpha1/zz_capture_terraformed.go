...
// GetTerraformResourceIDField returns Terraform identifier field for this Capture
func (tr *Capture) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this Capture using its observed tfState.
