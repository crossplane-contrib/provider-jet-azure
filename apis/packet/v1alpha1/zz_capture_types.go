...
var (
	CaptureKind             = "Capture"
	CaptureGroupKind        = schema.GroupKind{Group: Group, Kind: CaptureKind}.String()
	CaptureKindAPIVersion   = CaptureKind + "." + GroupVersion.String()
	CaptureGroupVersionKind = GroupVersion.WithKind(CaptureKind)
)
