...
// GetTerraformResourceIdField returns Terraform identifier field for this PacketCapture
func (tr *PacketCapture) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PacketCapture
func (tr *PacketCapture) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PacketCapture
func (tr *PacketCapture) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PacketCapture
func (tr *PacketCapture) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PacketCapture
func (tr *PacketCapture) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PacketCapture using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PacketCapture) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PacketCaptureParameters{}
