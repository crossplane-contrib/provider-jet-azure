...
// GetTerraformResourceIdField returns Terraform identifier field for this FrontdoorCustomHttpsConfiguration
func (tr *FrontdoorCustomHttpsConfiguration) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this FrontdoorCustomHttpsConfiguration
func (tr *FrontdoorCustomHttpsConfiguration) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this FrontdoorCustomHttpsConfiguration
func (tr *FrontdoorCustomHttpsConfiguration) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this FrontdoorCustomHttpsConfiguration
func (tr *FrontdoorCustomHttpsConfiguration) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this FrontdoorCustomHttpsConfiguration
func (tr *FrontdoorCustomHttpsConfiguration) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this FrontdoorCustomHttpsConfiguration using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FrontdoorCustomHttpsConfiguration) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &FrontdoorCustomHttpsConfigurationParameters{}
