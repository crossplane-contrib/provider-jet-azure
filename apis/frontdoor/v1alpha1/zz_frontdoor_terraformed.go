...
// GetTerraformResourceIdField returns Terraform identifier field for this Frontdoor
func (tr *Frontdoor) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this Frontdoor
func (tr *Frontdoor) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this Frontdoor
func (tr *Frontdoor) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this Frontdoor
func (tr *Frontdoor) GetParameters() ([]byte, error) {
...
func (tr *Frontdoor) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &FrontdoorParameters{}
