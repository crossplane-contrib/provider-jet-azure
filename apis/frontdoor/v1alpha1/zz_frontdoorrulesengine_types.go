...
var (
	FrontdoorRulesEngineKind             = "FrontdoorRulesEngine"
	FrontdoorRulesEngineGroupKind        = schema.GroupKind{Group: Group, Kind: FrontdoorRulesEngineKind}.String()
	FrontdoorRulesEngineKindAPIVersion   = FrontdoorRulesEngineKind + "." + GroupVersion.String()
	FrontdoorRulesEngineGroupVersionKind = GroupVersion.WithKind(FrontdoorRulesEngineKind)
)
