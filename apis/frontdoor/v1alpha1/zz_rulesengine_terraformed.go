...
// GetTerraformResourceIDField returns Terraform identifier field for this RulesEngine
func (tr *RulesEngine) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RulesEngine using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RulesEngine) LateInitialize(attrs []byte) (bool, error) {
	params := &RulesEngineParameters{}
