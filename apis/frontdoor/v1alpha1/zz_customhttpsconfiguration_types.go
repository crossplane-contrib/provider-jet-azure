...
var (
	CustomHttpsConfigurationKind             = "CustomHttpsConfiguration"
	CustomHttpsConfigurationGroupKind        = schema.GroupKind{Group: Group, Kind: CustomHttpsConfigurationKind}.String()
	CustomHttpsConfigurationKindAPIVersion   = CustomHttpsConfigurationKind + "." + GroupVersion.String()
	CustomHttpsConfigurationGroupVersionKind = GroupVersion.WithKind(CustomHttpsConfigurationKind)
)
