...
// GetTerraformResourceIdField returns Terraform identifier field for this FrontdoorFirewallPolicy
func (tr *FrontdoorFirewallPolicy) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this FrontdoorFirewallPolicy
func (tr *FrontdoorFirewallPolicy) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this FrontdoorFirewallPolicy
func (tr *FrontdoorFirewallPolicy) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this FrontdoorFirewallPolicy
func (tr *FrontdoorFirewallPolicy) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this FrontdoorFirewallPolicy
func (tr *FrontdoorFirewallPolicy) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this FrontdoorFirewallPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FrontdoorFirewallPolicy) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &FrontdoorFirewallPolicyParameters{}
