...
// GetTerraformResourceIDField returns Terraform identifier field for this FrontdoorRulesEngine
func (tr *FrontdoorRulesEngine) GetTerraformResourceIDField() string {
	return "id"
}
