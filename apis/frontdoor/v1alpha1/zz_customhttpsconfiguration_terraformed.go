...
// GetTerraformResourceIDField returns Terraform identifier field for this CustomHttpsConfiguration
func (tr *CustomHttpsConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CustomHttpsConfiguration using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CustomHttpsConfiguration) LateInitialize(attrs []byte) (bool, error) {
	params := &CustomHttpsConfigurationParameters{}
