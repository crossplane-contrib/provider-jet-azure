...
var (
	HardwareSecurityModuleKind             = "HardwareSecurityModule"
	HardwareSecurityModuleGroupKind        = schema.GroupKind{Group: Group, Kind: HardwareSecurityModuleKind}.String()
	HardwareSecurityModuleKindAPIVersion   = HardwareSecurityModuleKind + "." + GroupVersion.String()
	HardwareSecurityModuleGroupVersionKind = GroupVersion.WithKind(HardwareSecurityModuleKind)
)
