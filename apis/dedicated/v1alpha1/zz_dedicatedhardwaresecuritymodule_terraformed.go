...
// LateInitialize this DedicatedHardwareSecurityModule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DedicatedHardwareSecurityModule) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DedicatedHardwareSecurityModuleParameters{}
