...
// GetTerraformResourceIdField returns Terraform identifier field for this DedicatedHost
func (tr *DedicatedHost) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this DedicatedHost
func (tr *DedicatedHost) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DedicatedHost
func (tr *DedicatedHost) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DedicatedHost
func (tr *DedicatedHost) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this DedicatedHost
func (tr *DedicatedHost) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this DedicatedHost using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DedicatedHost) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DedicatedHostParameters{}
