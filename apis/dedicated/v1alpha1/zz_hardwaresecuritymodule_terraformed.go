...
// GetTerraformResourceIDField returns Terraform identifier field for this HardwareSecurityModule
func (tr *HardwareSecurityModule) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this HardwareSecurityModule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HardwareSecurityModule) LateInitialize(attrs []byte) (bool, error) {
	params := &HardwareSecurityModuleParameters{}
