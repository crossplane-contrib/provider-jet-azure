...
// GetTerraformResourceIdField returns Terraform identifier field for this LocalNetworkGateway
func (tr *LocalNetworkGateway) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LocalNetworkGateway
func (tr *LocalNetworkGateway) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LocalNetworkGateway
func (tr *LocalNetworkGateway) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LocalNetworkGateway
func (tr *LocalNetworkGateway) GetParameters() ([]byte, error) {
...
func (tr *LocalNetworkGateway) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LocalNetworkGatewayParameters{}
