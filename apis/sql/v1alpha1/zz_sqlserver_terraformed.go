...
func (tr *SqlServer) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SqlServer
func (tr *SqlServer) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SqlServer
func (tr *SqlServer) GetParameters() ([]byte, error) {
...
func (tr *SqlServer) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SqlServerParameters{}
