...
// GetTerraformResourceIdField returns Terraform identifier field for this SqlDatabase
func (tr *SqlDatabase) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SqlDatabase
func (tr *SqlDatabase) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SqlDatabase
func (tr *SqlDatabase) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SqlDatabase
func (tr *SqlDatabase) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SqlDatabase
func (tr *SqlDatabase) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SqlDatabase using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SqlDatabase) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SqlDatabaseParameters{}
