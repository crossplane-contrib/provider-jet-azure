...
var (
	ManagedDatabaseKind             = "ManagedDatabase"
	ManagedDatabaseGroupKind        = schema.GroupKind{Group: Group, Kind: ManagedDatabaseKind}.String()
	ManagedDatabaseKindAPIVersion   = ManagedDatabaseKind + "." + GroupVersion.String()
	ManagedDatabaseGroupVersionKind = GroupVersion.WithKind(ManagedDatabaseKind)
)
