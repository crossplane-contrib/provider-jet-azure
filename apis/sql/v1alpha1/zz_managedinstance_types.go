...
var (
	ManagedInstanceKind             = "ManagedInstance"
	ManagedInstanceGroupKind        = schema.GroupKind{Group: Group, Kind: ManagedInstanceKind}.String()
	ManagedInstanceKindAPIVersion   = ManagedInstanceKind + "." + GroupVersion.String()
	ManagedInstanceGroupVersionKind = GroupVersion.WithKind(ManagedInstanceKind)
)
