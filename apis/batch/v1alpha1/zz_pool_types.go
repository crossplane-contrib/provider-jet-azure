...
type ContainerRegistriesParameters struct {
	...
	// +kubebuilder:validation:Optional
	RegistryServer *string `json:"registryServer,omitempty" tf:"registry_server"`
...
type FixedScaleParameters struct {
	...
	// +kubebuilder:validation:Optional
	TargetDedicatedNodes *float64 `json:"targetDedicatedNodes,omitempty" tf:"target_dedicated_nodes,omitempty"`

	// +kubebuilder:validation:Optional
	TargetLowPriorityNodes *float64 `json:"targetLowPriorityNodes,omitempty" tf:"target_low_priority_nodes,omitempty"`
}
...
type PoolIdentityObservation struct {
}

type PoolIdentityParameters struct {
...
type PoolParameters struct {
	...
	// +kubebuilder:validation:Optional
	Identity []PoolIdentityParameters `json:"identity,omitempty" tf:"identity,omitempty"`

	// +kubebuilder:validation:Optional
	MaxTasksPerNode *float64 `json:"maxTasksPerNode,omitempty" tf:"max_tasks_per_node,omitempty"`
...
type StartTaskParameters struct {
	...
	// +kubebuilder:validation:Optional
	MaxTaskRetryCount *float64 `json:"maxTaskRetryCount,omitempty" tf:"max_task_retry_count,omitempty"`
