...
// GetTerraformResourceIdField returns Terraform identifier field for this TemplateDeployment
func (tr *TemplateDeployment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this TemplateDeployment
func (tr *TemplateDeployment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this TemplateDeployment
func (tr *TemplateDeployment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this TemplateDeployment
func (tr *TemplateDeployment) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this TemplateDeployment
func (tr *TemplateDeployment) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this TemplateDeployment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TemplateDeployment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &TemplateDeploymentParameters{}
