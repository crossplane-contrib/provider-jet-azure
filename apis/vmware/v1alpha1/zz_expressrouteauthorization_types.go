...
var (
	ExpressRouteAuthorizationKind             = "ExpressRouteAuthorization"
	ExpressRouteAuthorizationGroupKind        = schema.GroupKind{Group: Group, Kind: ExpressRouteAuthorizationKind}.String()
	ExpressRouteAuthorizationKindAPIVersion   = ExpressRouteAuthorizationKind + "." + GroupVersion.String()
	ExpressRouteAuthorizationGroupVersionKind = GroupVersion.WithKind(ExpressRouteAuthorizationKind)
)
