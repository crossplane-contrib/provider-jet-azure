...
// GetTerraformResourceIDField returns Terraform identifier field for this PrivateCloud
func (tr *PrivateCloud) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this PrivateCloud using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PrivateCloud) LateInitialize(attrs []byte) (bool, error) {
	params := &PrivateCloudParameters{}
