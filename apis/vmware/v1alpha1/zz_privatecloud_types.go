...
var (
	PrivateCloudKind             = "PrivateCloud"
	PrivateCloudGroupKind        = schema.GroupKind{Group: Group, Kind: PrivateCloudKind}.String()
	PrivateCloudKindAPIVersion   = PrivateCloudKind + "." + GroupVersion.String()
	PrivateCloudGroupVersionKind = GroupVersion.WithKind(PrivateCloudKind)
)
