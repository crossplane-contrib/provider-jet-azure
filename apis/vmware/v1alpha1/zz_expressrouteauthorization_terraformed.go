...
// GetTerraformResourceIDField returns Terraform identifier field for this ExpressRouteAuthorization
func (tr *ExpressRouteAuthorization) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ExpressRouteAuthorization using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ExpressRouteAuthorization) LateInitialize(attrs []byte) (bool, error) {
	params := &ExpressRouteAuthorizationParameters{}
