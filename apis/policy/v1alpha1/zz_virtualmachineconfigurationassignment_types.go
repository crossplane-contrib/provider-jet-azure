...
var (
	VirtualMachineConfigurationAssignmentKind             = "VirtualMachineConfigurationAssignment"
	VirtualMachineConfigurationAssignmentGroupKind        = schema.GroupKind{Group: Group, Kind: VirtualMachineConfigurationAssignmentKind}.String()
	VirtualMachineConfigurationAssignmentKindAPIVersion   = VirtualMachineConfigurationAssignmentKind + "." + GroupVersion.String()
	VirtualMachineConfigurationAssignmentGroupVersionKind = GroupVersion.WithKind(VirtualMachineConfigurationAssignmentKind)
)
