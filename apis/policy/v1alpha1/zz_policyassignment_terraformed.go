...
// GetTerraformResourceIdField returns Terraform identifier field for this PolicyAssignment
func (tr *PolicyAssignment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PolicyAssignment
func (tr *PolicyAssignment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PolicyAssignment
func (tr *PolicyAssignment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PolicyAssignment
func (tr *PolicyAssignment) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PolicyAssignment
func (tr *PolicyAssignment) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PolicyAssignment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PolicyAssignment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PolicyAssignmentParameters{}
