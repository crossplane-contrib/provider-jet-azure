...
// GetTerraformResourceIdField returns Terraform identifier field for this PolicySetDefinition
func (tr *PolicySetDefinition) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this PolicySetDefinition
func (tr *PolicySetDefinition) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this PolicySetDefinition
func (tr *PolicySetDefinition) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this PolicySetDefinition
func (tr *PolicySetDefinition) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this PolicySetDefinition
func (tr *PolicySetDefinition) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this PolicySetDefinition using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PolicySetDefinition) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &PolicySetDefinitionParameters{}
