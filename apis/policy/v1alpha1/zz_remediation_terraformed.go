...
// GetTerraformResourceIDField returns Terraform identifier field for this Remediation
func (tr *Remediation) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this Remediation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Remediation) LateInitialize(attrs []byte) (bool, error) {
	params := &RemediationParameters{}
