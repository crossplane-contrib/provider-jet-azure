...
var (
	...
	RemediationGroupKind        = schema.GroupKind{Group: Group, Kind: RemediationKind}.String()
	RemediationKindAPIVersion   = RemediationKind + "." + GroupVersion.String()
	RemediationGroupVersionKind = GroupVersion.WithKind(RemediationKind)
)
