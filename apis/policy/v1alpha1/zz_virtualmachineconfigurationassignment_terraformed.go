...
// GetTerraformResourceIDField returns Terraform identifier field for this VirtualMachineConfigurationAssignment
func (tr *VirtualMachineConfigurationAssignment) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this VirtualMachineConfigurationAssignment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VirtualMachineConfigurationAssignment) LateInitialize(attrs []byte) (bool, error) {
	params := &VirtualMachineConfigurationAssignmentParameters{}
