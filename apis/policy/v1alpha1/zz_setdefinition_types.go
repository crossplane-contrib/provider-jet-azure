...
// SetDefinition is the Schema for the SetDefinitions API
...
var (
	SetDefinitionKind             = "SetDefinition"
	SetDefinitionGroupKind        = schema.GroupKind{Group: Group, Kind: SetDefinitionKind}.String()
	SetDefinitionKindAPIVersion   = SetDefinitionKind + "." + GroupVersion.String()
	SetDefinitionGroupVersionKind = GroupVersion.WithKind(SetDefinitionKind)
)

func init() {
	SchemeBuilder.Register(&SetDefinition{}, &SetDefinitionList{})
}
