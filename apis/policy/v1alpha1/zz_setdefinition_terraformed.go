...
// GetTerraformResourceIDField returns Terraform identifier field for this SetDefinition
func (tr *SetDefinition) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this SetDefinition using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SetDefinition) LateInitialize(attrs []byte) (bool, error) {
	params := &SetDefinitionParameters{}
