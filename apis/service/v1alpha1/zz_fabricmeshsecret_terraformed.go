...
// GetTerraformResourceIDField returns Terraform identifier field for this FabricMeshSecret
func (tr *FabricMeshSecret) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this FabricMeshSecret using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FabricMeshSecret) LateInitialize(attrs []byte) (bool, error) {
	params := &FabricMeshSecretParameters{}
