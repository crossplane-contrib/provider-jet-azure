...
// GetTerraformResourceIDField returns Terraform identifier field for this FabricMeshLocalNetwork
func (tr *FabricMeshLocalNetwork) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this FabricMeshLocalNetwork using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FabricMeshLocalNetwork) LateInitialize(attrs []byte) (bool, error) {
	params := &FabricMeshLocalNetworkParameters{}
