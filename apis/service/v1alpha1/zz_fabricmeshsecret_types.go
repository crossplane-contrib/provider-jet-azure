...
// FabricMeshSecret is the Schema for the FabricMeshSecrets API
...
var (
	FabricMeshSecretKind             = "FabricMeshSecret"
	FabricMeshSecretGroupKind        = schema.GroupKind{Group: Group, Kind: FabricMeshSecretKind}.String()
	FabricMeshSecretKindAPIVersion   = FabricMeshSecretKind + "." + GroupVersion.String()
	FabricMeshSecretGroupVersionKind = GroupVersion.WithKind(FabricMeshSecretKind)
)

func init() {
	SchemeBuilder.Register(&FabricMeshSecret{}, &FabricMeshSecretList{})
}
