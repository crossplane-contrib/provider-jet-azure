...
var (
	FabricMeshLocalNetworkKind             = "FabricMeshLocalNetwork"
	FabricMeshLocalNetworkGroupKind        = schema.GroupKind{Group: Group, Kind: FabricMeshLocalNetworkKind}.String()
	FabricMeshLocalNetworkKindAPIVersion   = FabricMeshLocalNetworkKind + "." + GroupVersion.String()
	FabricMeshLocalNetworkGroupVersionKind = GroupVersion.WithKind(FabricMeshLocalNetworkKind)
)
