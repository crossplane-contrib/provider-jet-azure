...
var (
	FabricMeshApplicationKind             = "FabricMeshApplication"
	FabricMeshApplicationGroupKind        = schema.GroupKind{Group: Group, Kind: FabricMeshApplicationKind}.String()
	FabricMeshApplicationKindAPIVersion   = FabricMeshApplicationKind + "." + GroupVersion.String()
	FabricMeshApplicationGroupVersionKind = GroupVersion.WithKind(FabricMeshApplicationKind)
)
