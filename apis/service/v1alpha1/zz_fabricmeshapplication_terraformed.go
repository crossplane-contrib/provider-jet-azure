...
// GetTerraformResourceIDField returns Terraform identifier field for this FabricMeshApplication
func (tr *FabricMeshApplication) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this FabricMeshApplication using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FabricMeshApplication) LateInitialize(attrs []byte) (bool, error) {
	params := &FabricMeshApplicationParameters{}
