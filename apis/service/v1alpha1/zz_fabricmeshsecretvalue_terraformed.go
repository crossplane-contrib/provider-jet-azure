...
// GetTerraformResourceIDField returns Terraform identifier field for this FabricMeshSecretValue
func (tr *FabricMeshSecretValue) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this FabricMeshSecretValue using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FabricMeshSecretValue) LateInitialize(attrs []byte) (bool, error) {
	params := &FabricMeshSecretValueParameters{}
