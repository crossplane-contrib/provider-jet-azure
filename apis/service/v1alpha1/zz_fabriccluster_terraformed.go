...
// GetTerraformResourceIDField returns Terraform identifier field for this FabricCluster
func (tr *FabricCluster) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this FabricCluster using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FabricCluster) LateInitialize(attrs []byte) (bool, error) {
	params := &FabricClusterParameters{}
