...
// FabricMeshSecretValue is the Schema for the FabricMeshSecretValues API
...
var (
	FabricMeshSecretValueKind             = "FabricMeshSecretValue"
	FabricMeshSecretValueGroupKind        = schema.GroupKind{Group: Group, Kind: FabricMeshSecretValueKind}.String()
	FabricMeshSecretValueKindAPIVersion   = FabricMeshSecretValueKind + "." + GroupVersion.String()
	FabricMeshSecretValueGroupVersionKind = GroupVersion.WithKind(FabricMeshSecretValueKind)
)

func init() {
	SchemeBuilder.Register(&FabricMeshSecretValue{}, &FabricMeshSecretValueList{})
}
