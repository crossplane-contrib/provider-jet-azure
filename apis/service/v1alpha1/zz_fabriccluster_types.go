...
// FabricCluster is the Schema for the FabricClusters API
...
var (
	FabricClusterKind             = "FabricCluster"
	FabricClusterGroupKind        = schema.GroupKind{Group: Group, Kind: FabricClusterKind}.String()
	FabricClusterKindAPIVersion   = FabricClusterKind + "." + GroupVersion.String()
	FabricClusterGroupVersionKind = GroupVersion.WithKind(FabricClusterKind)
)

func init() {
	SchemeBuilder.Register(&FabricCluster{}, &FabricClusterList{})
}
