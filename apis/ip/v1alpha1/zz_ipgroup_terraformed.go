...
func (tr *IpGroup) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this IpGroup
func (tr *IpGroup) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this IpGroup
func (tr *IpGroup) GetParameters() ([]byte, error) {
...
func (tr *IpGroup) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &IpGroupParameters{}
