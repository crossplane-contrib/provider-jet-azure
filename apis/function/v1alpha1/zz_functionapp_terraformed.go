...
// GetTerraformResourceIdField returns Terraform identifier field for this FunctionApp
func (tr *FunctionApp) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this FunctionApp
func (tr *FunctionApp) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this FunctionApp
func (tr *FunctionApp) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this FunctionApp
func (tr *FunctionApp) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this FunctionApp
func (tr *FunctionApp) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this FunctionApp using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FunctionApp) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &FunctionAppParameters{}
