...
// GetTerraformResourceIDField returns Terraform identifier field for this DatabaseMigrationProject
func (tr *DatabaseMigrationProject) GetTerraformResourceIDField() string {
	return "id"
}
