...
func (tr *DatabaseMigrationProject) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this DatabaseMigrationProject
func (tr *DatabaseMigrationProject) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this DatabaseMigrationProject
func (tr *DatabaseMigrationProject) GetParameters() ([]byte, error) {
...
func (tr *DatabaseMigrationProject) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &DatabaseMigrationProjectParameters{}
