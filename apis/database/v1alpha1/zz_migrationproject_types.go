...
var (
	MigrationProjectKind             = "MigrationProject"
	MigrationProjectGroupKind        = schema.GroupKind{Group: Group, Kind: MigrationProjectKind}.String()
	MigrationProjectKindAPIVersion   = MigrationProjectKind + "." + GroupVersion.String()
	MigrationProjectGroupVersionKind = GroupVersion.WithKind(MigrationProjectKind)
)
