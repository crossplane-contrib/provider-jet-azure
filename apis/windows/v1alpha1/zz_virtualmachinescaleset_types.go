...
type VirtualMachineScaleSetAdditionalUnattendContentParameters struct {
...
type VirtualMachineScaleSetParameters struct {
	...
	// +kubebuilder:validation:Optional
	AdditionalUnattendContent []VirtualMachineScaleSetAdditionalUnattendContentParameters `json:"additionalUnattendContent,omitempty" tf:"additional_unattend_content,omitempty"`
	...
	// +kubebuilder:validation:Optional
	WinrmListener []VirtualMachineScaleSetWinrmListenerParameters `json:"winrmListener,omitempty" tf:"winrm_listener,omitempty"`
...
type VirtualMachineScaleSetWinrmListenerParameters struct {
