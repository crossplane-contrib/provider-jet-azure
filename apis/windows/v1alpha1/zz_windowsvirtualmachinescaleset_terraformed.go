...
// GetTerraformResourceIdField returns Terraform identifier field for this WindowsVirtualMachineScaleSet
func (tr *WindowsVirtualMachineScaleSet) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this WindowsVirtualMachineScaleSet
func (tr *WindowsVirtualMachineScaleSet) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this WindowsVirtualMachineScaleSet
func (tr *WindowsVirtualMachineScaleSet) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this WindowsVirtualMachineScaleSet
func (tr *WindowsVirtualMachineScaleSet) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this WindowsVirtualMachineScaleSet
func (tr *WindowsVirtualMachineScaleSet) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this WindowsVirtualMachineScaleSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *WindowsVirtualMachineScaleSet) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &WindowsVirtualMachineScaleSetParameters{}
