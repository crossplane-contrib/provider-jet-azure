...
var (
	ServerKeyKind             = "ServerKey"
	ServerKeyGroupKind        = schema.GroupKind{Group: Group, Kind: ServerKeyKind}.String()
	ServerKeyKindAPIVersion   = ServerKeyKind + "." + GroupVersion.String()
	ServerKeyGroupVersionKind = GroupVersion.WithKind(ServerKeyKind)
)
