...
// GetTerraformResourceIdField returns Terraform identifier field for this MysqlDatabase
func (tr *MysqlDatabase) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MysqlDatabase
func (tr *MysqlDatabase) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MysqlDatabase
func (tr *MysqlDatabase) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MysqlDatabase
func (tr *MysqlDatabase) GetParameters() ([]byte, error) {
...
func (tr *MysqlDatabase) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MysqlDatabaseParameters{}
