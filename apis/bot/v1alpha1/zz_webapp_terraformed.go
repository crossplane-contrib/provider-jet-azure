...
// GetTerraformResourceIDField returns Terraform identifier field for this WebApp
func (tr *WebApp) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this WebApp using its observed tfState.
