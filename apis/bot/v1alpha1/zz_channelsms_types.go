...
var (
	ChannelSmsKind             = "ChannelSms"
	ChannelSmsGroupKind        = schema.GroupKind{Group: Group, Kind: ChannelSmsKind}.String()
	ChannelSmsKindAPIVersion   = ChannelSmsKind + "." + GroupVersion.String()
	ChannelSmsGroupVersionKind = GroupVersion.WithKind(ChannelSmsKind)
)
