...
// GetTerraformResourceIDField returns Terraform identifier field for this ChannelEmail
func (tr *ChannelEmail) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ChannelEmail using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ChannelEmail) LateInitialize(attrs []byte) (bool, error) {
	params := &ChannelEmailParameters{}
