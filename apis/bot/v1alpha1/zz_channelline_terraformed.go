...
// GetTerraformResourceIDField returns Terraform identifier field for this ChannelLine
func (tr *ChannelLine) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ChannelLine using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ChannelLine) LateInitialize(attrs []byte) (bool, error) {
	params := &ChannelLineParameters{}
