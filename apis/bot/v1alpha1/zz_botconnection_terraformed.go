...
// GetTerraformResourceIdField returns Terraform identifier field for this BotConnection
func (tr *BotConnection) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BotConnection
func (tr *BotConnection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BotConnection
func (tr *BotConnection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BotConnection
func (tr *BotConnection) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this BotConnection
func (tr *BotConnection) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this BotConnection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BotConnection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BotConnectionParameters{}
