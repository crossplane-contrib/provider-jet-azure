...
var (
	ChannelDirectlineKind             = "ChannelDirectline"
	ChannelDirectlineGroupKind        = schema.GroupKind{Group: Group, Kind: ChannelDirectlineKind}.String()
	ChannelDirectlineKindAPIVersion   = ChannelDirectlineKind + "." + GroupVersion.String()
	ChannelDirectlineGroupVersionKind = GroupVersion.WithKind(ChannelDirectlineKind)
)
