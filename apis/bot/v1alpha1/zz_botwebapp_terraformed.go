...
// GetTerraformResourceIdField returns Terraform identifier field for this BotWebApp
func (tr *BotWebApp) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BotWebApp
func (tr *BotWebApp) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BotWebApp
func (tr *BotWebApp) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BotWebApp
func (tr *BotWebApp) GetParameters() ([]byte, error) {
...
func (tr *BotWebApp) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BotWebAppParameters{}
