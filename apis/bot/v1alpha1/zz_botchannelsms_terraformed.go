...
// GetTerraformResourceIdField returns Terraform identifier field for this BotChannelSms
func (tr *BotChannelSms) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BotChannelSms
func (tr *BotChannelSms) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BotChannelSms
func (tr *BotChannelSms) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BotChannelSms
func (tr *BotChannelSms) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this BotChannelSms
func (tr *BotChannelSms) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this BotChannelSms using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BotChannelSms) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BotChannelSmsParameters{}
