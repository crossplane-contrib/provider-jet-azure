...
var (
	ChannelWebChatKind             = "ChannelWebChat"
	ChannelWebChatGroupKind        = schema.GroupKind{Group: Group, Kind: ChannelWebChatKind}.String()
	ChannelWebChatKindAPIVersion   = ChannelWebChatKind + "." + GroupVersion.String()
	ChannelWebChatGroupVersionKind = GroupVersion.WithKind(ChannelWebChatKind)
)
