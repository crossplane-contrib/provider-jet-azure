...
var (
	ChannelAlexaKind             = "ChannelAlexa"
	ChannelAlexaGroupKind        = schema.GroupKind{Group: Group, Kind: ChannelAlexaKind}.String()
	ChannelAlexaKindAPIVersion   = ChannelAlexaKind + "." + GroupVersion.String()
	ChannelAlexaGroupVersionKind = GroupVersion.WithKind(ChannelAlexaKind)
)
