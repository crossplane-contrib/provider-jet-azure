...
var (
	ChannelSlackKind             = "ChannelSlack"
	ChannelSlackGroupKind        = schema.GroupKind{Group: Group, Kind: ChannelSlackKind}.String()
	ChannelSlackKindAPIVersion   = ChannelSlackKind + "." + GroupVersion.String()
	ChannelSlackGroupVersionKind = GroupVersion.WithKind(ChannelSlackKind)
)
