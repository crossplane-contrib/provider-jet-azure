...
// GetTerraformResourceIdField returns Terraform identifier field for this BotChannelAlexa
func (tr *BotChannelAlexa) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BotChannelAlexa
func (tr *BotChannelAlexa) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BotChannelAlexa
func (tr *BotChannelAlexa) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BotChannelAlexa
func (tr *BotChannelAlexa) GetParameters() ([]byte, error) {
...
func (tr *BotChannelAlexa) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BotChannelAlexaParameters{}
