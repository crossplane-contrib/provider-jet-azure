...
// GetTerraformResourceIdField returns Terraform identifier field for this BotChannelMsTeams
func (tr *BotChannelMsTeams) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BotChannelMsTeams
func (tr *BotChannelMsTeams) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BotChannelMsTeams
func (tr *BotChannelMsTeams) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BotChannelMsTeams
func (tr *BotChannelMsTeams) GetParameters() ([]byte, error) {
...
func (tr *BotChannelMsTeams) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BotChannelMsTeamsParameters{}
