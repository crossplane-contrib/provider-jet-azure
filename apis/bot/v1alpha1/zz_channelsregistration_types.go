...
var (
	ChannelsRegistrationKind             = "ChannelsRegistration"
	ChannelsRegistrationGroupKind        = schema.GroupKind{Group: Group, Kind: ChannelsRegistrationKind}.String()
	ChannelsRegistrationKindAPIVersion   = ChannelsRegistrationKind + "." + GroupVersion.String()
	ChannelsRegistrationGroupVersionKind = GroupVersion.WithKind(ChannelsRegistrationKind)
)
