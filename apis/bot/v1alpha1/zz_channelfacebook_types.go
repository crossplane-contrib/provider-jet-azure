...
var (
	ChannelFacebookKind             = "ChannelFacebook"
	ChannelFacebookGroupKind        = schema.GroupKind{Group: Group, Kind: ChannelFacebookKind}.String()
	ChannelFacebookKindAPIVersion   = ChannelFacebookKind + "." + GroupVersion.String()
	ChannelFacebookGroupVersionKind = GroupVersion.WithKind(ChannelFacebookKind)
)
