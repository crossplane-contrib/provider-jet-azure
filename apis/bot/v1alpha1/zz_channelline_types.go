...
// ChannelLine is the Schema for the ChannelLines API
...
var (
	ChannelLineKind             = "ChannelLine"
	ChannelLineGroupKind        = schema.GroupKind{Group: Group, Kind: ChannelLineKind}.String()
	ChannelLineKindAPIVersion   = ChannelLineKind + "." + GroupVersion.String()
	ChannelLineGroupVersionKind = GroupVersion.WithKind(ChannelLineKind)
)

func init() {
	SchemeBuilder.Register(&ChannelLine{}, &ChannelLineList{})
}
