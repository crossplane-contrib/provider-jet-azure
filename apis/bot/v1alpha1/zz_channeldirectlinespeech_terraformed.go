...
// GetTerraformResourceIDField returns Terraform identifier field for this ChannelDirectLineSpeech
func (tr *ChannelDirectLineSpeech) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ChannelDirectLineSpeech using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ChannelDirectLineSpeech) LateInitialize(attrs []byte) (bool, error) {
	params := &ChannelDirectLineSpeechParameters{}
