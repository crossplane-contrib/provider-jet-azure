...
// GetTerraformResourceIdField returns Terraform identifier field for this BotChannelEmail
func (tr *BotChannelEmail) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BotChannelEmail
func (tr *BotChannelEmail) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BotChannelEmail
func (tr *BotChannelEmail) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BotChannelEmail
func (tr *BotChannelEmail) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this BotChannelEmail
func (tr *BotChannelEmail) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this BotChannelEmail using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BotChannelEmail) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BotChannelEmailParameters{}
