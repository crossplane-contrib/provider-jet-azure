...
// GetTerraformResourceIDField returns Terraform identifier field for this ChannelSlack
func (tr *ChannelSlack) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ChannelSlack using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ChannelSlack) LateInitialize(attrs []byte) (bool, error) {
	params := &ChannelSlackParameters{}
