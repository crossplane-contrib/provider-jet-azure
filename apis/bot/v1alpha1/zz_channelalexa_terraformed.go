...
// GetTerraformResourceIDField returns Terraform identifier field for this ChannelAlexa
func (tr *ChannelAlexa) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ChannelAlexa using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ChannelAlexa) LateInitialize(attrs []byte) (bool, error) {
	params := &ChannelAlexaParameters{}
