...
// GetTerraformResourceIDField returns Terraform identifier field for this ChannelMsTeams
func (tr *ChannelMsTeams) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ChannelMsTeams using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ChannelMsTeams) LateInitialize(attrs []byte) (bool, error) {
	params := &ChannelMsTeamsParameters{}
