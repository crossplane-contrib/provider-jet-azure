...
// GetTerraformResourceIdField returns Terraform identifier field for this BotChannelLine
func (tr *BotChannelLine) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this BotChannelLine
func (tr *BotChannelLine) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this BotChannelLine
func (tr *BotChannelLine) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this BotChannelLine
func (tr *BotChannelLine) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this BotChannelLine
func (tr *BotChannelLine) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this BotChannelLine using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BotChannelLine) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &BotChannelLineParameters{}
