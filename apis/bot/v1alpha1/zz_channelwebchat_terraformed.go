...
// GetTerraformResourceIDField returns Terraform identifier field for this ChannelWebChat
func (tr *ChannelWebChat) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ChannelWebChat using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ChannelWebChat) LateInitialize(attrs []byte) (bool, error) {
	params := &ChannelWebChatParameters{}
