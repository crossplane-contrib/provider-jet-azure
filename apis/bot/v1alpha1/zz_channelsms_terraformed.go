...
// GetTerraformResourceIDField returns Terraform identifier field for this ChannelSms
func (tr *ChannelSms) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ChannelSms using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ChannelSms) LateInitialize(attrs []byte) (bool, error) {
	params := &ChannelSmsParameters{}
