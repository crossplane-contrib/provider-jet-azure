...
var (
	WebAppKind             = "WebApp"
	WebAppGroupKind        = schema.GroupKind{Group: Group, Kind: WebAppKind}.String()
	WebAppKindAPIVersion   = WebAppKind + "." + GroupVersion.String()
	WebAppGroupVersionKind = GroupVersion.WithKind(WebAppKind)
)
