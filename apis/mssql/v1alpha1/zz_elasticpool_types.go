...
var (
	ElasticpoolKind             = "Elasticpool"
	ElasticpoolGroupKind        = schema.GroupKind{Group: Group, Kind: ElasticpoolKind}.String()
	ElasticpoolKindAPIVersion   = ElasticpoolKind + "." + GroupVersion.String()
	ElasticpoolGroupVersionKind = GroupVersion.WithKind(ElasticpoolKind)
)
