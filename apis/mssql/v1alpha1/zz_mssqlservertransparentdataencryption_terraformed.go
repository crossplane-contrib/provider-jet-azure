...
// GetTerraformResourceIdField returns Terraform identifier field for this MssqlServerTransparentDataEncryption
func (tr *MssqlServerTransparentDataEncryption) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MssqlServerTransparentDataEncryption
func (tr *MssqlServerTransparentDataEncryption) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MssqlServerTransparentDataEncryption
func (tr *MssqlServerTransparentDataEncryption) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MssqlServerTransparentDataEncryption
func (tr *MssqlServerTransparentDataEncryption) GetParameters() ([]byte, error) {
...
func (tr *MssqlServerTransparentDataEncryption) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MssqlServerTransparentDataEncryptionParameters{}
