...
type AutoBackupParameters struct {
	...
	RetentionPeriodInDays *int64 `json:"retentionPeriodInDays" tf:"retention_period_in_days,omitempty"`
...
type AutoPatchingParameters struct {
	...
	// +kubebuilder:validation:Required
	MaintenanceWindowDurationInMinutes *int64 `json:"maintenanceWindowDurationInMinutes" tf:"maintenance_window_duration_in_minutes,omitempty"`

	// +kubebuilder:validation:Required
	MaintenanceWindowStartingHour *int64 `json:"maintenanceWindowStartingHour" tf:"maintenance_window_starting_hour,omitempty"`
}
...
type DataSettingsParameters struct {
	...
	// +kubebuilder:validation:Required
	Luns []*int64 `json:"luns" tf:"luns,omitempty"`
}
...
type ManualScheduleParameters struct {
	...
	// +kubebuilder:validation:Required
	FullBackupStartHour *int64 `json:"fullBackupStartHour" tf:"full_backup_start_hour,omitempty"`

	// +kubebuilder:validation:Required
	FullBackupWindowInHours *int64 `json:"fullBackupWindowInHours" tf:"full_backup_window_in_hours,omitempty"`

	// +kubebuilder:validation:Required
	LogBackupFrequencyInMinutes *int64 `json:"logBackupFrequencyInMinutes" tf:"log_backup_frequency_in_minutes,omitempty"`
}
