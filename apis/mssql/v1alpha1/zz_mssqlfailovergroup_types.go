...
var (
	MssqlFailoverGroupKind             = "MssqlFailoverGroup"
	MssqlFailoverGroupGroupKind        = schema.GroupKind{Group: Group, Kind: MssqlFailoverGroupKind}.String()
	MssqlFailoverGroupKindAPIVersion   = MssqlFailoverGroupKind + "." + GroupVersion.String()
	MssqlFailoverGroupGroupVersionKind = GroupVersion.WithKind(MssqlFailoverGroupKind)
)
