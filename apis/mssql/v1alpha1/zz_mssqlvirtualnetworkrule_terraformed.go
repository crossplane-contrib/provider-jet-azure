...
// GetTerraformResourceIdField returns Terraform identifier field for this MssqlVirtualNetworkRule
func (tr *MssqlVirtualNetworkRule) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MssqlVirtualNetworkRule
func (tr *MssqlVirtualNetworkRule) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MssqlVirtualNetworkRule
func (tr *MssqlVirtualNetworkRule) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MssqlVirtualNetworkRule
func (tr *MssqlVirtualNetworkRule) GetParameters() ([]byte, error) {
...
func (tr *MssqlVirtualNetworkRule) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MssqlVirtualNetworkRuleParameters{}
