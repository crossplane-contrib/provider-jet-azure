...
// GetTerraformResourceIDField returns Terraform identifier field for this MssqlFailoverGroup
func (tr *MssqlFailoverGroup) GetTerraformResourceIDField() string {
	return "id"
}
