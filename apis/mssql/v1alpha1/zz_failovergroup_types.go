...
var (
	FailoverGroupKind             = "FailoverGroup"
	FailoverGroupGroupKind        = schema.GroupKind{Group: Group, Kind: FailoverGroupKind}.String()
	FailoverGroupKindAPIVersion   = FailoverGroupKind + "." + GroupVersion.String()
	FailoverGroupGroupVersionKind = GroupVersion.WithKind(FailoverGroupKind)
)
