...
// GetTerraformResourceIdField returns Terraform identifier field for this MssqlServer
func (tr *MssqlServer) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MssqlServer
func (tr *MssqlServer) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MssqlServer
func (tr *MssqlServer) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MssqlServer
func (tr *MssqlServer) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this MssqlServer
func (tr *MssqlServer) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this MssqlServer using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MssqlServer) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MssqlServerParameters{}
