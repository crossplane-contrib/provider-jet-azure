...
var (
	JobCredentialKind             = "JobCredential"
	JobCredentialGroupKind        = schema.GroupKind{Group: Group, Kind: JobCredentialKind}.String()
	JobCredentialKindAPIVersion   = JobCredentialKind + "." + GroupVersion.String()
	JobCredentialGroupVersionKind = GroupVersion.WithKind(JobCredentialKind)
)
