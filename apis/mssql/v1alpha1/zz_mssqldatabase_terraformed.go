...
// GetTerraformResourceIdField returns Terraform identifier field for this MssqlDatabase
func (tr *MssqlDatabase) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MssqlDatabase
func (tr *MssqlDatabase) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MssqlDatabase
func (tr *MssqlDatabase) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MssqlDatabase
func (tr *MssqlDatabase) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this MssqlDatabase
func (tr *MssqlDatabase) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this MssqlDatabase using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MssqlDatabase) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MssqlDatabaseParameters{}
