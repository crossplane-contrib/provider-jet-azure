...
// GetTerraformResourceIdField returns Terraform identifier field for this MssqlDatabaseExtendedAuditingPolicy
func (tr *MssqlDatabaseExtendedAuditingPolicy) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MssqlDatabaseExtendedAuditingPolicy
func (tr *MssqlDatabaseExtendedAuditingPolicy) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MssqlDatabaseExtendedAuditingPolicy
func (tr *MssqlDatabaseExtendedAuditingPolicy) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MssqlDatabaseExtendedAuditingPolicy
func (tr *MssqlDatabaseExtendedAuditingPolicy) GetParameters() ([]byte, error) {
...
func (tr *MssqlDatabaseExtendedAuditingPolicy) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MssqlDatabaseExtendedAuditingPolicyParameters{}
