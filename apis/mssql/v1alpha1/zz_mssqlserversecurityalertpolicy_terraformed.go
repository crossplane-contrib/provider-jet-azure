...
// GetTerraformResourceIdField returns Terraform identifier field for this MssqlServerSecurityAlertPolicy
func (tr *MssqlServerSecurityAlertPolicy) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MssqlServerSecurityAlertPolicy
func (tr *MssqlServerSecurityAlertPolicy) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MssqlServerSecurityAlertPolicy
func (tr *MssqlServerSecurityAlertPolicy) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MssqlServerSecurityAlertPolicy
func (tr *MssqlServerSecurityAlertPolicy) GetParameters() ([]byte, error) {
...
func (tr *MssqlServerSecurityAlertPolicy) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MssqlServerSecurityAlertPolicyParameters{}
