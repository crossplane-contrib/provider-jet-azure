...
// GetTerraformResourceIdField returns Terraform identifier field for this MssqlVirtualMachine
func (tr *MssqlVirtualMachine) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MssqlVirtualMachine
func (tr *MssqlVirtualMachine) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MssqlVirtualMachine
func (tr *MssqlVirtualMachine) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MssqlVirtualMachine
func (tr *MssqlVirtualMachine) GetParameters() ([]byte, error) {
...
func (tr *MssqlVirtualMachine) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MssqlVirtualMachineParameters{}
