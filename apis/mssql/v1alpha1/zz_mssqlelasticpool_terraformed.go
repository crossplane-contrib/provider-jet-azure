...
// GetTerraformResourceIdField returns Terraform identifier field for this MssqlElasticpool
func (tr *MssqlElasticpool) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MssqlElasticpool
func (tr *MssqlElasticpool) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MssqlElasticpool
func (tr *MssqlElasticpool) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MssqlElasticpool
func (tr *MssqlElasticpool) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this MssqlElasticpool
func (tr *MssqlElasticpool) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this MssqlElasticpool using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MssqlElasticpool) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MssqlElasticpoolParameters{}
