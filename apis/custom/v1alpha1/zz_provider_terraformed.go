...
// GetTerraformResourceIDField returns Terraform identifier field for this Provider
func (tr *Provider) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *Provider) GetObservation() (map[string]interface{}, error) {
...
func (tr *Provider) SetObservation(obs map[string]interface{}) error {
...
func (tr *Provider) GetParameters() (map[string]interface{}, error) {
...
func (tr *Provider) SetParameters(params map[string]interface{}) error {
