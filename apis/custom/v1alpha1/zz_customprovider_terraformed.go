...
// GetTerraformResourceIdField returns Terraform identifier field for this CustomProvider
func (tr *CustomProvider) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this CustomProvider
func (tr *CustomProvider) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this CustomProvider
func (tr *CustomProvider) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this CustomProvider
func (tr *CustomProvider) GetParameters() ([]byte, error) {
...
func (tr *CustomProvider) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &CustomProviderParameters{}
