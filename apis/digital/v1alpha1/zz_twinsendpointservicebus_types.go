...
var (
	TwinsEndpointServicebusKind             = "TwinsEndpointServicebus"
	TwinsEndpointServicebusGroupKind        = schema.GroupKind{Group: Group, Kind: TwinsEndpointServicebusKind}.String()
	TwinsEndpointServicebusKindAPIVersion   = TwinsEndpointServicebusKind + "." + GroupVersion.String()
	TwinsEndpointServicebusGroupVersionKind = GroupVersion.WithKind(TwinsEndpointServicebusKind)
)
