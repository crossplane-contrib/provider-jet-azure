...
var (
	TwinsEndpointEventgridKind             = "TwinsEndpointEventgrid"
	TwinsEndpointEventgridGroupKind        = schema.GroupKind{Group: Group, Kind: TwinsEndpointEventgridKind}.String()
	TwinsEndpointEventgridKindAPIVersion   = TwinsEndpointEventgridKind + "." + GroupVersion.String()
	TwinsEndpointEventgridGroupVersionKind = GroupVersion.WithKind(TwinsEndpointEventgridKind)
)
