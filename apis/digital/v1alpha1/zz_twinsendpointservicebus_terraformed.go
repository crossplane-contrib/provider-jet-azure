...
// GetTerraformResourceIDField returns Terraform identifier field for this TwinsEndpointServicebus
func (tr *TwinsEndpointServicebus) GetTerraformResourceIDField() string {
	return "id"
}
