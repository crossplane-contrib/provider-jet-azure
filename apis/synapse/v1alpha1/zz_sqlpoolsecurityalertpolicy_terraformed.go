...
// GetTerraformResourceIDField returns Terraform identifier field for this SqlPoolSecurityAlertPolicy
func (tr *SqlPoolSecurityAlertPolicy) GetTerraformResourceIDField() string {
	return "id"
}
