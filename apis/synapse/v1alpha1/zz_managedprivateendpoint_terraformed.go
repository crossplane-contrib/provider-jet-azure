...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagedPrivateEndpoint
func (tr *ManagedPrivateEndpoint) GetTerraformResourceIDField() string {
	return "id"
}
