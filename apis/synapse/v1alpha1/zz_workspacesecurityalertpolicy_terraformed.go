...
// GetTerraformResourceIDField returns Terraform identifier field for this WorkspaceSecurityAlertPolicy
func (tr *WorkspaceSecurityAlertPolicy) GetTerraformResourceIDField() string {
	return "id"
}
