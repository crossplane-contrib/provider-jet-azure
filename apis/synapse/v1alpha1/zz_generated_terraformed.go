...
// GetTerraformResourceType returns Terraform resource type for this SQLPoolVulnerabilityAssessmentBaseline
func (mg *SQLPoolVulnerabilityAssessmentBaseline) GetTerraformResourceType() string {
	return "azurerm_synapse_sql_pool_vulnerability_assessment_baseline"
}

// GetConnectionDetailsMapping for this SQLPoolVulnerabilityAssessmentBaseline
func (tr *SQLPoolVulnerabilityAssessmentBaseline) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this SQLPoolVulnerabilityAssessmentBaseline
func (tr *SQLPoolVulnerabilityAssessmentBaseline) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this SQLPoolVulnerabilityAssessmentBaseline
func (tr *SQLPoolVulnerabilityAssessmentBaseline) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this SQLPoolVulnerabilityAssessmentBaseline
func (tr *SQLPoolVulnerabilityAssessmentBaseline) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this SQLPoolVulnerabilityAssessmentBaseline
func (tr *SQLPoolVulnerabilityAssessmentBaseline) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this SQLPoolVulnerabilityAssessmentBaseline
func (tr *SQLPoolVulnerabilityAssessmentBaseline) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this SQLPoolVulnerabilityAssessmentBaseline using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SQLPoolVulnerabilityAssessmentBaseline) LateInitialize(attrs []byte) (bool, error) {
	params := &SQLPoolVulnerabilityAssessmentBaselineParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *SQLPoolVulnerabilityAssessmentBaseline) GetTerraformSchemaVersion() int {
	return 0
}
