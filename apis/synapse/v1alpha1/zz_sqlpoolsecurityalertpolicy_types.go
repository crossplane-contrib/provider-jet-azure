...
var (
	SqlPoolSecurityAlertPolicyKind             = "SqlPoolSecurityAlertPolicy"
	SqlPoolSecurityAlertPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: SqlPoolSecurityAlertPolicyKind}.String()
	SqlPoolSecurityAlertPolicyKindAPIVersion   = SqlPoolSecurityAlertPolicyKind + "." + GroupVersion.String()
	SqlPoolSecurityAlertPolicyGroupVersionKind = GroupVersion.WithKind(SqlPoolSecurityAlertPolicyKind)
)
