...
// GetTerraformResourceIDField returns Terraform identifier field for this IntegrationRuntimeAzure
func (tr *IntegrationRuntimeAzure) GetTerraformResourceIDField() string {
	return "id"
}
