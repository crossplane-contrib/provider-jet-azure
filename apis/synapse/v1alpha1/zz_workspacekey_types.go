...
var (
	WorkspaceKeyKind             = "WorkspaceKey"
	WorkspaceKeyGroupKind        = schema.GroupKind{Group: Group, Kind: WorkspaceKeyKind}.String()
	WorkspaceKeyKindAPIVersion   = WorkspaceKeyKind + "." + GroupVersion.String()
	WorkspaceKeyGroupVersionKind = GroupVersion.WithKind(WorkspaceKeyKind)
)
