...
var (
	WorkspaceExtendedAuditingPolicyKind             = "WorkspaceExtendedAuditingPolicy"
	WorkspaceExtendedAuditingPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: WorkspaceExtendedAuditingPolicyKind}.String()
	WorkspaceExtendedAuditingPolicyKindAPIVersion   = WorkspaceExtendedAuditingPolicyKind + "." + GroupVersion.String()
	WorkspaceExtendedAuditingPolicyGroupVersionKind = GroupVersion.WithKind(WorkspaceExtendedAuditingPolicyKind)
)
