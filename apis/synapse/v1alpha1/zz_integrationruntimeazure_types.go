...
var (
	IntegrationRuntimeAzureKind             = "IntegrationRuntimeAzure"
	IntegrationRuntimeAzureGroupKind        = schema.GroupKind{Group: Group, Kind: IntegrationRuntimeAzureKind}.String()
	IntegrationRuntimeAzureKindAPIVersion   = IntegrationRuntimeAzureKind + "." + GroupVersion.String()
	IntegrationRuntimeAzureGroupVersionKind = GroupVersion.WithKind(IntegrationRuntimeAzureKind)
)
