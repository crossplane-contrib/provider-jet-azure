...
var (
	WorkspaceSecurityAlertPolicyKind             = "WorkspaceSecurityAlertPolicy"
	WorkspaceSecurityAlertPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: WorkspaceSecurityAlertPolicyKind}.String()
	WorkspaceSecurityAlertPolicyKindAPIVersion   = WorkspaceSecurityAlertPolicyKind + "." + GroupVersion.String()
	WorkspaceSecurityAlertPolicyGroupVersionKind = GroupVersion.WithKind(WorkspaceSecurityAlertPolicyKind)
)
