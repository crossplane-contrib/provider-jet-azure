...
// GetTerraformResourceIDField returns Terraform identifier field for this WorkspaceExtendedAuditingPolicy
func (tr *WorkspaceExtendedAuditingPolicy) GetTerraformResourceIDField() string {
	return "id"
}
