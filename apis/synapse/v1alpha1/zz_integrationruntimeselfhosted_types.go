...
var (
	IntegrationRuntimeSelfHostedKind             = "IntegrationRuntimeSelfHosted"
	IntegrationRuntimeSelfHostedGroupKind        = schema.GroupKind{Group: Group, Kind: IntegrationRuntimeSelfHostedKind}.String()
	IntegrationRuntimeSelfHostedKindAPIVersion   = IntegrationRuntimeSelfHostedKind + "." + GroupVersion.String()
	IntegrationRuntimeSelfHostedGroupVersionKind = GroupVersion.WithKind(IntegrationRuntimeSelfHostedKind)
)
