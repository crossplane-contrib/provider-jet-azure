...
// GetTerraformResourceIDField returns Terraform identifier field for this SqlPoolExtendedAuditingPolicy
func (tr *SqlPoolExtendedAuditingPolicy) GetTerraformResourceIDField() string {
	return "id"
}
