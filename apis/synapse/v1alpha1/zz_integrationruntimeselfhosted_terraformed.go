...
// GetTerraformResourceIDField returns Terraform identifier field for this IntegrationRuntimeSelfHosted
func (tr *IntegrationRuntimeSelfHosted) GetTerraformResourceIDField() string {
	return "id"
}
