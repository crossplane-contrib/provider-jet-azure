...
var (
	LinkedServiceKind             = "LinkedService"
	LinkedServiceGroupKind        = schema.GroupKind{Group: Group, Kind: LinkedServiceKind}.String()
	LinkedServiceKindAPIVersion   = LinkedServiceKind + "." + GroupVersion.String()
	LinkedServiceGroupVersionKind = GroupVersion.WithKind(LinkedServiceKind)
)
