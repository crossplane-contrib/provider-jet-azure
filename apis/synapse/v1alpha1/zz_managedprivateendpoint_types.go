...
var (
	ManagedPrivateEndpointKind             = "ManagedPrivateEndpoint"
	ManagedPrivateEndpointGroupKind        = schema.GroupKind{Group: Group, Kind: ManagedPrivateEndpointKind}.String()
	ManagedPrivateEndpointKindAPIVersion   = ManagedPrivateEndpointKind + "." + GroupVersion.String()
	ManagedPrivateEndpointGroupVersionKind = GroupVersion.WithKind(ManagedPrivateEndpointKind)
)
