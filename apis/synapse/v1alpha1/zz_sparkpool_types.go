...
var (
	SparkPoolKind             = "SparkPool"
	SparkPoolGroupKind        = schema.GroupKind{Group: Group, Kind: SparkPoolKind}.String()
	SparkPoolKindAPIVersion   = SparkPoolKind + "." + GroupVersion.String()
	SparkPoolGroupVersionKind = GroupVersion.WithKind(SparkPoolKind)
)
