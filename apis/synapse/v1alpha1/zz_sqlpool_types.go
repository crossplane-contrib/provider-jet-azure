...
var (
	SqlPoolKind             = "SqlPool"
	SqlPoolGroupKind        = schema.GroupKind{Group: Group, Kind: SqlPoolKind}.String()
	SqlPoolKindAPIVersion   = SqlPoolKind + "." + GroupVersion.String()
	SqlPoolGroupVersionKind = GroupVersion.WithKind(SqlPoolKind)
)
