...
var (
	NamespaceCustomerManagedKeyKind             = "NamespaceCustomerManagedKey"
	NamespaceCustomerManagedKeyGroupKind        = schema.GroupKind{Group: Group, Kind: NamespaceCustomerManagedKeyKind}.String()
	NamespaceCustomerManagedKeyKindAPIVersion   = NamespaceCustomerManagedKeyKind + "." + GroupVersion.String()
	NamespaceCustomerManagedKeyGroupVersionKind = GroupVersion.WithKind(NamespaceCustomerManagedKeyKind)
)
