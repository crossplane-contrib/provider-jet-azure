...
var (
	NamespaceAuthorizationRuleKind             = "NamespaceAuthorizationRule"
	NamespaceAuthorizationRuleGroupKind        = schema.GroupKind{Group: Group, Kind: NamespaceAuthorizationRuleKind}.String()
	NamespaceAuthorizationRuleKindAPIVersion   = NamespaceAuthorizationRuleKind + "." + GroupVersion.String()
	NamespaceAuthorizationRuleGroupVersionKind = GroupVersion.WithKind(NamespaceAuthorizationRuleKind)
)
