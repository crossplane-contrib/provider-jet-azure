...
// GetTerraformResourceIDField returns Terraform identifier field for this NamespaceCustomerManagedKey
func (tr *NamespaceCustomerManagedKey) GetTerraformResourceIDField() string {
	return "id"
}
