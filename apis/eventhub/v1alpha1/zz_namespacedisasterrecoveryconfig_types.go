...
var (
	NamespaceDisasterRecoveryConfigKind             = "NamespaceDisasterRecoveryConfig"
	NamespaceDisasterRecoveryConfigGroupKind        = schema.GroupKind{Group: Group, Kind: NamespaceDisasterRecoveryConfigKind}.String()
	NamespaceDisasterRecoveryConfigKindAPIVersion   = NamespaceDisasterRecoveryConfigKind + "." + GroupVersion.String()
	NamespaceDisasterRecoveryConfigGroupVersionKind = GroupVersion.WithKind(NamespaceDisasterRecoveryConfigKind)
)
