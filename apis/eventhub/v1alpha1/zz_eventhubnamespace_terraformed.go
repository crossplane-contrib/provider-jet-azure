...
// GetTerraformResourceIdField returns Terraform identifier field for this EventhubNamespace
func (tr *EventhubNamespace) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this EventhubNamespace
func (tr *EventhubNamespace) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this EventhubNamespace
func (tr *EventhubNamespace) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this EventhubNamespace
func (tr *EventhubNamespace) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this EventhubNamespace
func (tr *EventhubNamespace) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this EventhubNamespace using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EventhubNamespace) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &EventhubNamespaceParameters{}
