...
// GetTerraformResourceIDField returns Terraform identifier field for this LearningSynapseSpark
func (tr *LearningSynapseSpark) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this LearningSynapseSpark using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LearningSynapseSpark) LateInitialize(attrs []byte) (bool, error) {
	params := &LearningSynapseSparkParameters{}
