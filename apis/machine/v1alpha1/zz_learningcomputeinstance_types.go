...
var (
	LearningComputeInstanceKind             = "LearningComputeInstance"
	LearningComputeInstanceGroupKind        = schema.GroupKind{Group: Group, Kind: LearningComputeInstanceKind}.String()
	LearningComputeInstanceKindAPIVersion   = LearningComputeInstanceKind + "." + GroupVersion.String()
	LearningComputeInstanceGroupVersionKind = GroupVersion.WithKind(LearningComputeInstanceKind)
)
