...
// GetTerraformResourceIDField returns Terraform identifier field for this LearningWorkspace
func (tr *LearningWorkspace) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this LearningWorkspace using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LearningWorkspace) LateInitialize(attrs []byte) (bool, error) {
	params := &LearningWorkspaceParameters{}
