...
// GetTerraformResourceIDField returns Terraform identifier field for this LearningComputeInstance
func (tr *LearningComputeInstance) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this LearningComputeInstance using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LearningComputeInstance) LateInitialize(attrs []byte) (bool, error) {
	params := &LearningComputeInstanceParameters{}
