...
var (
	LearningSynapseSparkKind             = "LearningSynapseSpark"
	LearningSynapseSparkGroupKind        = schema.GroupKind{Group: Group, Kind: LearningSynapseSparkKind}.String()
	LearningSynapseSparkKindAPIVersion   = LearningSynapseSparkKind + "." + GroupVersion.String()
	LearningSynapseSparkGroupVersionKind = GroupVersion.WithKind(LearningSynapseSparkKind)
)
