...
// GetTerraformResourceIDField returns Terraform identifier field for this LearningComputeCluster
func (tr *LearningComputeCluster) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this LearningComputeCluster using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LearningComputeCluster) LateInitialize(attrs []byte) (bool, error) {
	params := &LearningComputeClusterParameters{}
