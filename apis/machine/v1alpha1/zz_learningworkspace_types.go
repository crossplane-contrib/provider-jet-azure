...
// LearningWorkspace is the Schema for the LearningWorkspaces API
...
var (
	LearningWorkspaceKind             = "LearningWorkspace"
	LearningWorkspaceGroupKind        = schema.GroupKind{Group: Group, Kind: LearningWorkspaceKind}.String()
	LearningWorkspaceKindAPIVersion   = LearningWorkspaceKind + "." + GroupVersion.String()
	LearningWorkspaceGroupVersionKind = GroupVersion.WithKind(LearningWorkspaceKind)
)

func init() {
	SchemeBuilder.Register(&LearningWorkspace{}, &LearningWorkspaceList{})
}
