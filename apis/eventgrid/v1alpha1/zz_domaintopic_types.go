...
var (
	DomainTopicKind             = "DomainTopic"
	DomainTopicGroupKind        = schema.GroupKind{Group: Group, Kind: DomainTopicKind}.String()
	DomainTopicKindAPIVersion   = DomainTopicKind + "." + GroupVersion.String()
	DomainTopicGroupVersionKind = GroupVersion.WithKind(DomainTopicKind)
)
