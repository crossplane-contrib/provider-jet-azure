...
// GetTerraformResourceIDField returns Terraform identifier field for this SystemTopicEventSubscription
func (tr *SystemTopicEventSubscription) GetTerraformResourceIDField() string {
	return "id"
}
