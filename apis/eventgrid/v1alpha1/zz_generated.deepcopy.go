...
func (in *SystemTopicEventSubscriptionObservation) DeepCopyInto(out *SystemTopicEventSubscriptionObservation) {
	*out = *in
	...
	if in.WebhookEndpoint != nil {
		in, out := &in.WebhookEndpoint, &out.WebhookEndpoint
		*out = make([]SystemTopicEventSubscriptionWebhookEndpointObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SystemTopicEventSubscriptionParameters) DeepCopyInto(out *SystemTopicEventSubscriptionParameters) {
	*out = *in
	if in.AdvancedFilter != nil {
		in, out := &in.AdvancedFilter, &out.AdvancedFilter
		*out = make([]SystemTopicEventSubscriptionAdvancedFilterParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.AzureFunctionEndpoint != nil {
		in, out := &in.AzureFunctionEndpoint, &out.AzureFunctionEndpoint
		*out = make([]SystemTopicEventSubscriptionAzureFunctionEndpointParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DeadLetterIdentity != nil {
		in, out := &in.DeadLetterIdentity, &out.DeadLetterIdentity
		*out = make([]SystemTopicEventSubscriptionDeadLetterIdentityParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DeliveryIdentity != nil {
		in, out := &in.DeliveryIdentity, &out.DeliveryIdentity
		*out = make([]SystemTopicEventSubscriptionDeliveryIdentityParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.RetryPolicy != nil {
		in, out := &in.RetryPolicy, &out.RetryPolicy
		*out = make([]SystemTopicEventSubscriptionRetryPolicyParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.StorageBlobDeadLetterDestination != nil {
		in, out := &in.StorageBlobDeadLetterDestination, &out.StorageBlobDeadLetterDestination
		*out = make([]SystemTopicEventSubscriptionStorageBlobDeadLetterDestinationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.StorageQueueEndpoint != nil {
		in, out := &in.StorageQueueEndpoint, &out.StorageQueueEndpoint
		*out = make([]SystemTopicEventSubscriptionStorageQueueEndpointParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SubjectFilter != nil {
		in, out := &in.SubjectFilter, &out.SubjectFilter
		*out = make([]SystemTopicEventSubscriptionSubjectFilterParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WebhookEndpoint != nil {
		in, out := &in.WebhookEndpoint, &out.WebhookEndpoint
		*out = make([]SystemTopicEventSubscriptionWebhookEndpointParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SystemTopicObservation) DeepCopyInto(out *SystemTopicObservation) {
	*out = *in
	...
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]SystemTopicIdentityObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SystemTopicParameters) DeepCopyInto(out *SystemTopicParameters) {
	*out = *in
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]SystemTopicIdentityParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TopicObservation) DeepCopyInto(out *TopicObservation) {
	*out = *in
	...
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]TopicIdentityObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TopicParameters) DeepCopyInto(out *TopicParameters) {
	*out = *in
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]TopicIdentityParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.InputMappingDefaultValues != nil {
		in, out := &in.InputMappingDefaultValues, &out.InputMappingDefaultValues
		*out = make([]TopicInputMappingDefaultValuesParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.InputMappingFields != nil {
		in, out := &in.InputMappingFields, &out.InputMappingFields
		*out = make([]TopicInputMappingFieldsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
