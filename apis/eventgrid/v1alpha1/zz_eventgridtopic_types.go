...
type EventgridTopicIdentityObservation struct {
	PrincipalID *string `json:"principalId,omitempty" tf:"principal_id,omitempty"`

	TenantID *string `json:"tenantId,omitempty" tf:"tenant_id,omitempty"`
}

type EventgridTopicIdentityParameters struct {
...
type EventgridTopicParameters struct {
	...
	// +kubebuilder:validation:Optional
	Identity []EventgridTopicIdentityParameters `json:"identity,omitempty" tf:"identity,omitempty"`

	// +kubebuilder:validation:Optional
	InboundIPRule []EventgridTopicInboundIPRuleParameters `json:"inboundIpRule,omitempty" tf:"inbound_ip_rule,omitempty"`

	// +kubebuilder:validation:Optional
	InputMappingDefaultValues []EventgridTopicInputMappingDefaultValuesParameters `json:"inputMappingDefaultValues,omitempty" tf:"input_mapping_default_values,omitempty"`

	// +kubebuilder:validation:Optional
	InputMappingFields []EventgridTopicInputMappingFieldsParameters `json:"inputMappingFields,omitempty" tf:"input_mapping_fields,omitempty"`
