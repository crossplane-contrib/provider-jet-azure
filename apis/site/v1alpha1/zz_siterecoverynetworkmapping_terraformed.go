...
// GetTerraformResourceIdField returns Terraform identifier field for this SiteRecoveryNetworkMapping
func (tr *SiteRecoveryNetworkMapping) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SiteRecoveryNetworkMapping
func (tr *SiteRecoveryNetworkMapping) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SiteRecoveryNetworkMapping
func (tr *SiteRecoveryNetworkMapping) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SiteRecoveryNetworkMapping
func (tr *SiteRecoveryNetworkMapping) GetParameters() ([]byte, error) {
...
func (tr *SiteRecoveryNetworkMapping) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SiteRecoveryNetworkMappingParameters{}
