...
var (
	RecoveryFabricKind             = "RecoveryFabric"
	RecoveryFabricGroupKind        = schema.GroupKind{Group: Group, Kind: RecoveryFabricKind}.String()
	RecoveryFabricKindAPIVersion   = RecoveryFabricKind + "." + GroupVersion.String()
	RecoveryFabricGroupVersionKind = GroupVersion.WithKind(RecoveryFabricKind)
)
