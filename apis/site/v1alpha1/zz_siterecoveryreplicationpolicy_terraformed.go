...
// GetTerraformResourceIdField returns Terraform identifier field for this SiteRecoveryReplicationPolicy
func (tr *SiteRecoveryReplicationPolicy) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SiteRecoveryReplicationPolicy
func (tr *SiteRecoveryReplicationPolicy) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SiteRecoveryReplicationPolicy
func (tr *SiteRecoveryReplicationPolicy) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SiteRecoveryReplicationPolicy
func (tr *SiteRecoveryReplicationPolicy) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SiteRecoveryReplicationPolicy
func (tr *SiteRecoveryReplicationPolicy) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SiteRecoveryReplicationPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SiteRecoveryReplicationPolicy) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SiteRecoveryReplicationPolicyParameters{}
