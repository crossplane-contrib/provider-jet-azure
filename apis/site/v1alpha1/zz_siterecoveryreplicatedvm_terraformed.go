...
// GetTerraformResourceIdField returns Terraform identifier field for this SiteRecoveryReplicatedVm
func (tr *SiteRecoveryReplicatedVm) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SiteRecoveryReplicatedVm
func (tr *SiteRecoveryReplicatedVm) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SiteRecoveryReplicatedVm
func (tr *SiteRecoveryReplicatedVm) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SiteRecoveryReplicatedVm
func (tr *SiteRecoveryReplicatedVm) GetParameters() ([]byte, error) {
...
func (tr *SiteRecoveryReplicatedVm) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SiteRecoveryReplicatedVmParameters{}
