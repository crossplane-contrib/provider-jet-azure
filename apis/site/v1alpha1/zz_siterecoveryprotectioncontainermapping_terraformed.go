...
// GetTerraformResourceIdField returns Terraform identifier field for this SiteRecoveryProtectionContainerMapping
func (tr *SiteRecoveryProtectionContainerMapping) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SiteRecoveryProtectionContainerMapping
func (tr *SiteRecoveryProtectionContainerMapping) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SiteRecoveryProtectionContainerMapping
func (tr *SiteRecoveryProtectionContainerMapping) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SiteRecoveryProtectionContainerMapping
func (tr *SiteRecoveryProtectionContainerMapping) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SiteRecoveryProtectionContainerMapping
func (tr *SiteRecoveryProtectionContainerMapping) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SiteRecoveryProtectionContainerMapping using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SiteRecoveryProtectionContainerMapping) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SiteRecoveryProtectionContainerMappingParameters{}
