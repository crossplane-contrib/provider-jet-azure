...
// RecoveryReplicationPolicy is the Schema for the RecoveryReplicationPolicys API
...
var (
	RecoveryReplicationPolicyKind             = "RecoveryReplicationPolicy"
	RecoveryReplicationPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: RecoveryReplicationPolicyKind}.String()
	RecoveryReplicationPolicyKindAPIVersion   = RecoveryReplicationPolicyKind + "." + GroupVersion.String()
	RecoveryReplicationPolicyGroupVersionKind = GroupVersion.WithKind(RecoveryReplicationPolicyKind)
)

func init() {
	SchemeBuilder.Register(&RecoveryReplicationPolicy{}, &RecoveryReplicationPolicyList{})
}
