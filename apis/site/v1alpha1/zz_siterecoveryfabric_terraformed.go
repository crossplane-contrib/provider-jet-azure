...
// GetTerraformResourceIdField returns Terraform identifier field for this SiteRecoveryFabric
func (tr *SiteRecoveryFabric) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SiteRecoveryFabric
func (tr *SiteRecoveryFabric) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SiteRecoveryFabric
func (tr *SiteRecoveryFabric) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SiteRecoveryFabric
func (tr *SiteRecoveryFabric) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this SiteRecoveryFabric
func (tr *SiteRecoveryFabric) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this SiteRecoveryFabric using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SiteRecoveryFabric) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SiteRecoveryFabricParameters{}
