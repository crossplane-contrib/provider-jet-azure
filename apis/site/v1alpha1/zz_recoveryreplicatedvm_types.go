...
var (
	RecoveryReplicatedVmKind             = "RecoveryReplicatedVm"
	RecoveryReplicatedVmGroupKind        = schema.GroupKind{Group: Group, Kind: RecoveryReplicatedVmKind}.String()
	RecoveryReplicatedVmKindAPIVersion   = RecoveryReplicatedVmKind + "." + GroupVersion.String()
	RecoveryReplicatedVmGroupVersionKind = GroupVersion.WithKind(RecoveryReplicatedVmKind)
)
