...
// GetTerraformResourceIDField returns Terraform identifier field for this RecoveryProtectionContainer
func (tr *RecoveryProtectionContainer) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RecoveryProtectionContainer using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RecoveryProtectionContainer) LateInitialize(attrs []byte) (bool, error) {
	params := &RecoveryProtectionContainerParameters{}
