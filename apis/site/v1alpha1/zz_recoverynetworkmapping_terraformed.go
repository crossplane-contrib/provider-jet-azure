...
// GetTerraformResourceIDField returns Terraform identifier field for this RecoveryNetworkMapping
func (tr *RecoveryNetworkMapping) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RecoveryNetworkMapping using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RecoveryNetworkMapping) LateInitialize(attrs []byte) (bool, error) {
	params := &RecoveryNetworkMappingParameters{}
