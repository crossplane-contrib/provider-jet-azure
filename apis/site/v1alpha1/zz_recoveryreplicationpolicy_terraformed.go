...
// GetTerraformResourceIDField returns Terraform identifier field for this RecoveryReplicationPolicy
func (tr *RecoveryReplicationPolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RecoveryReplicationPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RecoveryReplicationPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &RecoveryReplicationPolicyParameters{}
