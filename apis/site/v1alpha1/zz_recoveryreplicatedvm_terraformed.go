...
// GetTerraformResourceIDField returns Terraform identifier field for this RecoveryReplicatedVm
func (tr *RecoveryReplicatedVm) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RecoveryReplicatedVm using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RecoveryReplicatedVm) LateInitialize(attrs []byte) (bool, error) {
	params := &RecoveryReplicatedVmParameters{}
