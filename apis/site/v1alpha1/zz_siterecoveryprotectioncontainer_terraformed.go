...
// GetTerraformResourceIdField returns Terraform identifier field for this SiteRecoveryProtectionContainer
func (tr *SiteRecoveryProtectionContainer) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this SiteRecoveryProtectionContainer
func (tr *SiteRecoveryProtectionContainer) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this SiteRecoveryProtectionContainer
func (tr *SiteRecoveryProtectionContainer) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this SiteRecoveryProtectionContainer
func (tr *SiteRecoveryProtectionContainer) GetParameters() ([]byte, error) {
...
func (tr *SiteRecoveryProtectionContainer) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &SiteRecoveryProtectionContainerParameters{}
