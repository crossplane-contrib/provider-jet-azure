...
var (
	RecoveryProtectionContainerKind             = "RecoveryProtectionContainer"
	RecoveryProtectionContainerGroupKind        = schema.GroupKind{Group: Group, Kind: RecoveryProtectionContainerKind}.String()
	RecoveryProtectionContainerKindAPIVersion   = RecoveryProtectionContainerKind + "." + GroupVersion.String()
	RecoveryProtectionContainerGroupVersionKind = GroupVersion.WithKind(RecoveryProtectionContainerKind)
)
