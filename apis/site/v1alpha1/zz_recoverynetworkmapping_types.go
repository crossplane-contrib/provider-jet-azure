...
var (
	RecoveryNetworkMappingKind             = "RecoveryNetworkMapping"
	RecoveryNetworkMappingGroupKind        = schema.GroupKind{Group: Group, Kind: RecoveryNetworkMappingKind}.String()
	RecoveryNetworkMappingKindAPIVersion   = RecoveryNetworkMappingKind + "." + GroupVersion.String()
	RecoveryNetworkMappingGroupVersionKind = GroupVersion.WithKind(RecoveryNetworkMappingKind)
)
