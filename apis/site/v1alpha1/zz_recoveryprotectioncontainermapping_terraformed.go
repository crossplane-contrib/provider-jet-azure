...
// GetTerraformResourceIDField returns Terraform identifier field for this RecoveryProtectionContainerMapping
func (tr *RecoveryProtectionContainerMapping) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this RecoveryProtectionContainerMapping using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RecoveryProtectionContainerMapping) LateInitialize(attrs []byte) (bool, error) {
	params := &RecoveryProtectionContainerMappingParameters{}
