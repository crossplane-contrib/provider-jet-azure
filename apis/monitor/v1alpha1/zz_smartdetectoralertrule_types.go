...
var (
	SmartDetectorAlertRuleKind             = "SmartDetectorAlertRule"
	SmartDetectorAlertRuleGroupKind        = schema.GroupKind{Group: Group, Kind: SmartDetectorAlertRuleKind}.String()
	SmartDetectorAlertRuleKindAPIVersion   = SmartDetectorAlertRuleKind + "." + GroupVersion.String()
	SmartDetectorAlertRuleGroupVersionKind = GroupVersion.WithKind(SmartDetectorAlertRuleKind)
)
