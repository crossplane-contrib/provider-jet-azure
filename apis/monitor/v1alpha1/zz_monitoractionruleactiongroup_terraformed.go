...
// GetTerraformResourceIdField returns Terraform identifier field for this MonitorActionRuleActionGroup
func (tr *MonitorActionRuleActionGroup) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MonitorActionRuleActionGroup
func (tr *MonitorActionRuleActionGroup) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MonitorActionRuleActionGroup
func (tr *MonitorActionRuleActionGroup) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MonitorActionRuleActionGroup
func (tr *MonitorActionRuleActionGroup) GetParameters() ([]byte, error) {
...
func (tr *MonitorActionRuleActionGroup) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MonitorActionRuleActionGroupParameters{}
