...
// GetTerraformResourceIDField returns Terraform identifier field for this ActivityLogAlert
func (tr *ActivityLogAlert) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ActivityLogAlert using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ActivityLogAlert) LateInitialize(attrs []byte) (bool, error) {
	params := &ActivityLogAlertParameters{}
