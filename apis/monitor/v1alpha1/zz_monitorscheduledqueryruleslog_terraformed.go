...
// GetTerraformResourceIdField returns Terraform identifier field for this MonitorScheduledQueryRulesLog
func (tr *MonitorScheduledQueryRulesLog) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MonitorScheduledQueryRulesLog
func (tr *MonitorScheduledQueryRulesLog) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MonitorScheduledQueryRulesLog
func (tr *MonitorScheduledQueryRulesLog) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MonitorScheduledQueryRulesLog
func (tr *MonitorScheduledQueryRulesLog) GetParameters() ([]byte, error) {
...
func (tr *MonitorScheduledQueryRulesLog) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MonitorScheduledQueryRulesLogParameters{}
