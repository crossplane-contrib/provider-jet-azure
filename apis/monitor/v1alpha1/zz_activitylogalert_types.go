...
var (
	ActivityLogAlertKind             = "ActivityLogAlert"
	ActivityLogAlertGroupKind        = schema.GroupKind{Group: Group, Kind: ActivityLogAlertKind}.String()
	ActivityLogAlertKindAPIVersion   = ActivityLogAlertKind + "." + GroupVersion.String()
	ActivityLogAlertGroupVersionKind = GroupVersion.WithKind(ActivityLogAlertKind)
)
