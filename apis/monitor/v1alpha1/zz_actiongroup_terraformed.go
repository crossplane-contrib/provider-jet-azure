...
// GetTerraformResourceIDField returns Terraform identifier field for this ActionGroup
func (tr *ActionGroup) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ActionGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ActionGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &ActionGroupParameters{}
