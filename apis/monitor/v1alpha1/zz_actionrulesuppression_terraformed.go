...
// GetTerraformResourceIDField returns Terraform identifier field for this ActionRuleSuppression
func (tr *ActionRuleSuppression) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ActionRuleSuppression using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ActionRuleSuppression) LateInitialize(attrs []byte) (bool, error) {
	params := &ActionRuleSuppressionParameters{}
