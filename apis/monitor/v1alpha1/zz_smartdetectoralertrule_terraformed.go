...
// GetTerraformResourceIDField returns Terraform identifier field for this SmartDetectorAlertRule
func (tr *SmartDetectorAlertRule) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this SmartDetectorAlertRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SmartDetectorAlertRule) LateInitialize(attrs []byte) (bool, error) {
	params := &SmartDetectorAlertRuleParameters{}
