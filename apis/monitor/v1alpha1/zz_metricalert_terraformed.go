...
// GetTerraformResourceIDField returns Terraform identifier field for this MetricAlert
func (tr *MetricAlert) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this MetricAlert using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MetricAlert) LateInitialize(attrs []byte) (bool, error) {
	params := &MetricAlertParameters{}
