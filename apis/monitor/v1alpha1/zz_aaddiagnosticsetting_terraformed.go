...
// GetTerraformResourceIDField returns Terraform identifier field for this AadDiagnosticSetting
func (tr *AadDiagnosticSetting) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AadDiagnosticSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AadDiagnosticSetting) LateInitialize(attrs []byte) (bool, error) {
	params := &AadDiagnosticSettingParameters{}
