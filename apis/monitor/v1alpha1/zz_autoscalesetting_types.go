...
var (
	AutoscaleSettingKind             = "AutoscaleSetting"
	AutoscaleSettingGroupKind        = schema.GroupKind{Group: Group, Kind: AutoscaleSettingKind}.String()
	AutoscaleSettingKindAPIVersion   = AutoscaleSettingKind + "." + GroupVersion.String()
	AutoscaleSettingGroupVersionKind = GroupVersion.WithKind(AutoscaleSettingKind)
)
