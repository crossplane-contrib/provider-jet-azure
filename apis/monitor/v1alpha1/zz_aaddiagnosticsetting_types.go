...
var (
	AadDiagnosticSettingKind             = "AadDiagnosticSetting"
	AadDiagnosticSettingGroupKind        = schema.GroupKind{Group: Group, Kind: AadDiagnosticSettingKind}.String()
	AadDiagnosticSettingKindAPIVersion   = AadDiagnosticSettingKind + "." + GroupVersion.String()
	AadDiagnosticSettingGroupVersionKind = GroupVersion.WithKind(AadDiagnosticSettingKind)
)
