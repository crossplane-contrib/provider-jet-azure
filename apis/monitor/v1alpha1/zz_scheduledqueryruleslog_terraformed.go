...
// GetTerraformResourceIDField returns Terraform identifier field for this ScheduledQueryRulesLog
func (tr *ScheduledQueryRulesLog) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ScheduledQueryRulesLog using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ScheduledQueryRulesLog) LateInitialize(attrs []byte) (bool, error) {
	params := &ScheduledQueryRulesLogParameters{}
