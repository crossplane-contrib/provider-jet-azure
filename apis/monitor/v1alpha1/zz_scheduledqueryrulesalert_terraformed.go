...
// GetTerraformResourceIDField returns Terraform identifier field for this ScheduledQueryRulesAlert
func (tr *ScheduledQueryRulesAlert) GetTerraformResourceIDField() string {
	return "id"
}
