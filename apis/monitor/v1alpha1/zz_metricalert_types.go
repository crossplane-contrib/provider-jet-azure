...
var (
	MetricAlertKind             = "MetricAlert"
	MetricAlertGroupKind        = schema.GroupKind{Group: Group, Kind: MetricAlertKind}.String()
	MetricAlertKindAPIVersion   = MetricAlertKind + "." + GroupVersion.String()
	MetricAlertGroupVersionKind = GroupVersion.WithKind(MetricAlertKind)
)
