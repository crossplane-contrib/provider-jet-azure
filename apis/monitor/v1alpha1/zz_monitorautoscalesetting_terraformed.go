...
// GetTerraformResourceIdField returns Terraform identifier field for this MonitorAutoscaleSetting
func (tr *MonitorAutoscaleSetting) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MonitorAutoscaleSetting
func (tr *MonitorAutoscaleSetting) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MonitorAutoscaleSetting
func (tr *MonitorAutoscaleSetting) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MonitorAutoscaleSetting
func (tr *MonitorAutoscaleSetting) GetParameters() ([]byte, error) {
...
func (tr *MonitorAutoscaleSetting) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MonitorAutoscaleSettingParameters{}
