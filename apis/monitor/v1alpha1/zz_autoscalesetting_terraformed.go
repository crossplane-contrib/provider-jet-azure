...
// GetTerraformResourceIDField returns Terraform identifier field for this AutoscaleSetting
func (tr *AutoscaleSetting) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AutoscaleSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AutoscaleSetting) LateInitialize(attrs []byte) (bool, error) {
	params := &AutoscaleSettingParameters{}
