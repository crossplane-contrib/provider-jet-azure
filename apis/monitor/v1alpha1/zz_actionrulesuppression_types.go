...
var (
	ActionRuleSuppressionKind             = "ActionRuleSuppression"
	ActionRuleSuppressionGroupKind        = schema.GroupKind{Group: Group, Kind: ActionRuleSuppressionKind}.String()
	ActionRuleSuppressionKindAPIVersion   = ActionRuleSuppressionKind + "." + GroupVersion.String()
	ActionRuleSuppressionGroupVersionKind = GroupVersion.WithKind(ActionRuleSuppressionKind)
)
