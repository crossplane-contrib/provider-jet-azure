...
// GetTerraformResourceIdField returns Terraform identifier field for this MonitorSmartDetectorAlertRule
func (tr *MonitorSmartDetectorAlertRule) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MonitorSmartDetectorAlertRule
func (tr *MonitorSmartDetectorAlertRule) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MonitorSmartDetectorAlertRule
func (tr *MonitorSmartDetectorAlertRule) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MonitorSmartDetectorAlertRule
func (tr *MonitorSmartDetectorAlertRule) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this MonitorSmartDetectorAlertRule
func (tr *MonitorSmartDetectorAlertRule) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this MonitorSmartDetectorAlertRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MonitorSmartDetectorAlertRule) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MonitorSmartDetectorAlertRuleParameters{}
