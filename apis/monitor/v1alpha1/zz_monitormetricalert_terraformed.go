...
// GetTerraformResourceIdField returns Terraform identifier field for this MonitorMetricAlert
func (tr *MonitorMetricAlert) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MonitorMetricAlert
func (tr *MonitorMetricAlert) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MonitorMetricAlert
func (tr *MonitorMetricAlert) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MonitorMetricAlert
func (tr *MonitorMetricAlert) GetParameters() ([]byte, error) {
...
func (tr *MonitorMetricAlert) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MonitorMetricAlertParameters{}
