...
var (
	ActionRuleActionGroupKind             = "ActionRuleActionGroup"
	ActionRuleActionGroupGroupKind        = schema.GroupKind{Group: Group, Kind: ActionRuleActionGroupKind}.String()
	ActionRuleActionGroupKindAPIVersion   = ActionRuleActionGroupKind + "." + GroupVersion.String()
	ActionRuleActionGroupGroupVersionKind = GroupVersion.WithKind(ActionRuleActionGroupKind)
)
