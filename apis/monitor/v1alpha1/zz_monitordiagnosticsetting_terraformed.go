...
// GetTerraformResourceIdField returns Terraform identifier field for this MonitorDiagnosticSetting
func (tr *MonitorDiagnosticSetting) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this MonitorDiagnosticSetting
func (tr *MonitorDiagnosticSetting) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MonitorDiagnosticSetting
func (tr *MonitorDiagnosticSetting) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MonitorDiagnosticSetting
func (tr *MonitorDiagnosticSetting) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this MonitorDiagnosticSetting
func (tr *MonitorDiagnosticSetting) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this MonitorDiagnosticSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MonitorDiagnosticSetting) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MonitorDiagnosticSettingParameters{}
