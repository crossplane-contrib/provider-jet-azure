...
// GetTerraformResourceIdField returns Terraform identifier field for this TenantTemplateDeployment
func (tr *TenantTemplateDeployment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this TenantTemplateDeployment
func (tr *TenantTemplateDeployment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this TenantTemplateDeployment
func (tr *TenantTemplateDeployment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this TenantTemplateDeployment
func (tr *TenantTemplateDeployment) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this TenantTemplateDeployment
func (tr *TenantTemplateDeployment) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this TenantTemplateDeployment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TenantTemplateDeployment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &TenantTemplateDeploymentParameters{}
