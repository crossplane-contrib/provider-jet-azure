...
var (
	MlServicesClusterKind             = "MlServicesCluster"
	MlServicesClusterGroupKind        = schema.GroupKind{Group: Group, Kind: MlServicesClusterKind}.String()
	MlServicesClusterKindAPIVersion   = MlServicesClusterKind + "." + GroupVersion.String()
	MlServicesClusterGroupVersionKind = GroupVersion.WithKind(MlServicesClusterKind)
)
