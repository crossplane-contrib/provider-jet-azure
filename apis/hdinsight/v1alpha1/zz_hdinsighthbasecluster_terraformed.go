...
// GetConnectionDetailsMapping for this HdinsightHbaseCluster
func (tr *HdinsightHbaseCluster) GetConnectionDetailsMapping() map[string]string {
...
func (tr *HdinsightHbaseCluster) GetObservation() (map[string]interface{}, error) {
...
func (tr *HdinsightHbaseCluster) SetObservation(obs map[string]interface{}) error {
...
func (tr *HdinsightHbaseCluster) GetParameters() (map[string]interface{}, error) {
...
func (tr *HdinsightHbaseCluster) SetParameters(params map[string]interface{}) error {
...
func (tr *HdinsightHbaseCluster) LateInitialize(attrs []byte) (bool, error) {
	params := &HdinsightHbaseClusterParameters{}
...
func (tr *HdinsightHbaseCluster) GetTerraformSchemaVersion() int {
	return 0
}
