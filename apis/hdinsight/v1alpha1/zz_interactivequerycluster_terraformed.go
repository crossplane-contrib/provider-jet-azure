...
// GetTerraformResourceIDField returns Terraform identifier field for this InteractiveQueryCluster
func (tr *InteractiveQueryCluster) GetTerraformResourceIDField() string {
	return "id"
}
