...
// GetConnectionDetailsMapping for this HdinsightStormCluster
func (tr *HdinsightStormCluster) GetConnectionDetailsMapping() map[string]string {
...
func (tr *HdinsightStormCluster) GetObservation() (map[string]interface{}, error) {
...
func (tr *HdinsightStormCluster) SetObservation(obs map[string]interface{}) error {
...
func (tr *HdinsightStormCluster) GetParameters() (map[string]interface{}, error) {
...
func (tr *HdinsightStormCluster) SetParameters(params map[string]interface{}) error {
...
func (tr *HdinsightStormCluster) LateInitialize(attrs []byte) (bool, error) {
	params := &HdinsightStormClusterParameters{}
...
func (tr *HdinsightStormCluster) GetTerraformSchemaVersion() int {
	return 0
}
