...
var (
	KafkaClusterKind             = "KafkaCluster"
	KafkaClusterGroupKind        = schema.GroupKind{Group: Group, Kind: KafkaClusterKind}.String()
	KafkaClusterKindAPIVersion   = KafkaClusterKind + "." + GroupVersion.String()
	KafkaClusterGroupVersionKind = GroupVersion.WithKind(KafkaClusterKind)
)
