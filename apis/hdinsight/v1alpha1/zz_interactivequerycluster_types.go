...
var (
	InteractiveQueryClusterKind             = "InteractiveQueryCluster"
	InteractiveQueryClusterGroupKind        = schema.GroupKind{Group: Group, Kind: InteractiveQueryClusterKind}.String()
	InteractiveQueryClusterKindAPIVersion   = InteractiveQueryClusterKind + "." + GroupVersion.String()
	InteractiveQueryClusterGroupVersionKind = GroupVersion.WithKind(InteractiveQueryClusterKind)
)
