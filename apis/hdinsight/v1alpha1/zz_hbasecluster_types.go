...
var (
	HbaseClusterKind             = "HbaseCluster"
	HbaseClusterGroupKind        = schema.GroupKind{Group: Group, Kind: HbaseClusterKind}.String()
	HbaseClusterKindAPIVersion   = HbaseClusterKind + "." + GroupVersion.String()
	HbaseClusterGroupVersionKind = GroupVersion.WithKind(HbaseClusterKind)
)
