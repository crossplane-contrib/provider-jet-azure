...
type HdinsightRserverClusterParameters struct {
	...
	// +kubebuilder:validation:Required
	Gateway []HdinsightRserverClusterGatewayParameters `json:"gateway" tf:"gateway,omitempty"`
	...
	// +kubebuilder:validation:Required
	Roles []HdinsightRserverClusterRolesParameters `json:"roles" tf:"roles,omitempty"`

	// +kubebuilder:validation:Required
	Rstudio *bool `json:"rstudio" tf:"rstudio,omitempty"`

	// +kubebuilder:validation:Optional
	StorageAccount []HdinsightRserverClusterStorageAccountParameters `json:"storageAccount,omitempty" tf:"storage_account,omitempty"`
...
type HdinsightRserverClusterRolesParameters struct {
	...
	// +kubebuilder:validation:Required
	EdgeNode []HdinsightRserverClusterRolesEdgeNodeParameters `json:"edgeNode" tf:"edge_node,omitempty"`

	// +kubebuilder:validation:Required
	HeadNode []HdinsightRserverClusterRolesHeadNodeParameters `json:"headNode" tf:"head_node,omitempty"`

	// +kubebuilder:validation:Required
	WorkerNode []HdinsightRserverClusterRolesWorkerNodeParameters `json:"workerNode" tf:"worker_node,omitempty"`

	// +kubebuilder:validation:Required
	ZookeeperNode []HdinsightRserverClusterRolesZookeeperNodeParameters `json:"zookeeperNode" tf:"zookeeper_node,omitempty"`
}
