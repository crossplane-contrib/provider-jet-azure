...
// GetTerraformResourceIDField returns Terraform identifier field for this UserAssignedIdentity
func (tr *UserAssignedIdentity) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *UserAssignedIdentity) GetObservation() (map[string]interface{}, error) {
...
func (tr *UserAssignedIdentity) SetObservation(obs map[string]interface{}) error {
...
func (tr *UserAssignedIdentity) GetParameters() (map[string]interface{}, error) {
...
func (tr *UserAssignedIdentity) SetParameters(params map[string]interface{}) error {
