...
func (tr *UserAssignedIdentity) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this UserAssignedIdentity
func (tr *UserAssignedIdentity) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this UserAssignedIdentity
func (tr *UserAssignedIdentity) GetParameters() ([]byte, error) {
...
func (tr *UserAssignedIdentity) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &UserAssignedIdentityParameters{}
