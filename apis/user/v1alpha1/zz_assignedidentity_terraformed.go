...
// GetTerraformResourceIDField returns Terraform identifier field for this AssignedIdentity
func (tr *AssignedIdentity) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AssignedIdentity using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AssignedIdentity) LateInitialize(attrs []byte) (bool, error) {
	params := &AssignedIdentityParameters{}
