...
var (
	AssignedIdentityKind             = "AssignedIdentity"
	AssignedIdentityGroupKind        = schema.GroupKind{Group: Group, Kind: AssignedIdentityKind}.String()
	AssignedIdentityKindAPIVersion   = AssignedIdentityKind + "." + GroupVersion.String()
	AssignedIdentityGroupVersionKind = GroupVersion.WithKind(AssignedIdentityKind)
)
