...
// GetTerraformResourceIdField returns Terraform identifier field for this LighthouseAssignment
func (tr *LighthouseAssignment) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LighthouseAssignment
func (tr *LighthouseAssignment) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LighthouseAssignment
func (tr *LighthouseAssignment) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LighthouseAssignment
func (tr *LighthouseAssignment) GetParameters() ([]byte, error) {
...
// LateInitialize this LighthouseAssignment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LighthouseAssignment) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LighthouseAssignmentParameters{}
