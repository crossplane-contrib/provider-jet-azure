...
// GetTerraformResourceIdField returns Terraform identifier field for this LighthouseDefinition
func (tr *LighthouseDefinition) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this LighthouseDefinition
func (tr *LighthouseDefinition) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this LighthouseDefinition
func (tr *LighthouseDefinition) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this LighthouseDefinition
func (tr *LighthouseDefinition) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this LighthouseDefinition
func (tr *LighthouseDefinition) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this LighthouseDefinition using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LighthouseDefinition) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &LighthouseDefinitionParameters{}
