...
func (tr *AdvancedThreatProtection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this AdvancedThreatProtection
func (tr *AdvancedThreatProtection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this AdvancedThreatProtection
func (tr *AdvancedThreatProtection) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this AdvancedThreatProtection
func (tr *AdvancedThreatProtection) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this AdvancedThreatProtection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdvancedThreatProtection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &AdvancedThreatProtectionParameters{}
