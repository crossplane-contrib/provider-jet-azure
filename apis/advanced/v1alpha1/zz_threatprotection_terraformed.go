...
// GetTerraformResourceIDField returns Terraform identifier field for this ThreatProtection
func (tr *ThreatProtection) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this ThreatProtection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ThreatProtection) LateInitialize(attrs []byte) (bool, error) {
	params := &ThreatProtectionParameters{}
