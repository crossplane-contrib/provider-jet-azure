...
var (
	ThreatProtectionKind             = "ThreatProtection"
	ThreatProtectionGroupKind        = schema.GroupKind{Group: Group, Kind: ThreatProtectionKind}.String()
	ThreatProtectionKindAPIVersion   = ThreatProtectionKind + "." + GroupVersion.String()
	ThreatProtectionGroupVersionKind = GroupVersion.WithKind(ThreatProtectionKind)
)
