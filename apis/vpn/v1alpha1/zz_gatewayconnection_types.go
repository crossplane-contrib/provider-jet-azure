...
var (
	GatewayConnection_Kind             = "GatewayConnection"
	GatewayConnection_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayConnection_Kind}.String()
	GatewayConnection_KindAPIVersion   = GatewayConnection_Kind + "." + CRDGroupVersion.String()
	GatewayConnection_GroupVersionKind = CRDGroupVersion.WithKind(GatewayConnection_Kind)
)
