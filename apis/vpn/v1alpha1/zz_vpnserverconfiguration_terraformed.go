...
// GetTerraformResourceIdField returns Terraform identifier field for this VpnServerConfiguration
func (tr *VpnServerConfiguration) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this VpnServerConfiguration
func (tr *VpnServerConfiguration) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this VpnServerConfiguration
func (tr *VpnServerConfiguration) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this VpnServerConfiguration
func (tr *VpnServerConfiguration) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this VpnServerConfiguration
func (tr *VpnServerConfiguration) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this VpnServerConfiguration using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VpnServerConfiguration) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VpnServerConfigurationParameters{}
