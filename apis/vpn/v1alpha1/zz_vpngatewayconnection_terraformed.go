...
func (tr *VpnGatewayConnection) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this VpnGatewayConnection
func (tr *VpnGatewayConnection) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this VpnGatewayConnection
func (tr *VpnGatewayConnection) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this VpnGatewayConnection
func (tr *VpnGatewayConnection) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this VpnGatewayConnection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VpnGatewayConnection) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VpnGatewayConnectionParameters{}
