...
var (
	ServerConfigurationKind             = "ServerConfiguration"
	ServerConfigurationGroupKind        = schema.GroupKind{Group: Group, Kind: ServerConfigurationKind}.String()
	ServerConfigurationKindAPIVersion   = ServerConfigurationKind + "." + GroupVersion.String()
	ServerConfigurationGroupVersionKind = GroupVersion.WithKind(ServerConfigurationKind)
)
