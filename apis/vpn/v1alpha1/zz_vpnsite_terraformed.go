...
// GetTerraformResourceIdField returns Terraform identifier field for this VpnSite
func (tr *VpnSite) GetTerraformResourceIdField() string {
	return "id"
}

// GetObservation of this VpnSite
func (tr *VpnSite) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this VpnSite
func (tr *VpnSite) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this VpnSite
func (tr *VpnSite) GetParameters() ([]byte, error) {
...
func (tr *VpnSite) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &VpnSiteParameters{}
