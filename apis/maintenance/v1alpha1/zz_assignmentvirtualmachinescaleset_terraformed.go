...
// GetTerraformResourceIDField returns Terraform identifier field for this AssignmentVirtualMachineScaleSet
func (tr *AssignmentVirtualMachineScaleSet) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AssignmentVirtualMachineScaleSet using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AssignmentVirtualMachineScaleSet) LateInitialize(attrs []byte) (bool, error) {
	params := &AssignmentVirtualMachineScaleSetParameters{}
