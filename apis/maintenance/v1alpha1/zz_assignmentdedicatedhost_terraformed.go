...
// GetTerraformResourceIDField returns Terraform identifier field for this AssignmentDedicatedHost
func (tr *AssignmentDedicatedHost) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AssignmentDedicatedHost using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AssignmentDedicatedHost) LateInitialize(attrs []byte) (bool, error) {
	params := &AssignmentDedicatedHostParameters{}
