...
// GetTerraformResourceIDField returns Terraform identifier field for this AssignmentVirtualMachine
func (tr *AssignmentVirtualMachine) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AssignmentVirtualMachine using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AssignmentVirtualMachine) LateInitialize(attrs []byte) (bool, error) {
	params := &AssignmentVirtualMachineParameters{}
