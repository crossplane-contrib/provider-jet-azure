...
var (
	AssignmentVirtualMachineScaleSetKind             = "AssignmentVirtualMachineScaleSet"
	AssignmentVirtualMachineScaleSetGroupKind        = schema.GroupKind{Group: Group, Kind: AssignmentVirtualMachineScaleSetKind}.String()
	AssignmentVirtualMachineScaleSetKindAPIVersion   = AssignmentVirtualMachineScaleSetKind + "." + GroupVersion.String()
	AssignmentVirtualMachineScaleSetGroupVersionKind = GroupVersion.WithKind(AssignmentVirtualMachineScaleSetKind)
)
