...
var (
	AssignmentDedicatedHostKind             = "AssignmentDedicatedHost"
	AssignmentDedicatedHostGroupKind        = schema.GroupKind{Group: Group, Kind: AssignmentDedicatedHostKind}.String()
	AssignmentDedicatedHostKindAPIVersion   = AssignmentDedicatedHostKind + "." + GroupVersion.String()
	AssignmentDedicatedHostGroupVersionKind = GroupVersion.WithKind(AssignmentDedicatedHostKind)
)
