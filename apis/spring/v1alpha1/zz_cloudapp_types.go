...
var (
	...
	CloudAppGroupKind        = schema.GroupKind{Group: Group, Kind: CloudAppKind}.String()
	CloudAppKindAPIVersion   = CloudAppKind + "." + GroupVersion.String()
	CloudAppGroupVersionKind = GroupVersion.WithKind(CloudAppKind)
)
