...
// GetTerraformResourceIDField returns Terraform identifier field for this CloudApp
func (tr *CloudApp) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CloudApp using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CloudApp) LateInitialize(attrs []byte) (bool, error) {
	params := &CloudAppParameters{}
