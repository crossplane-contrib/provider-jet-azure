...
// GetTerraformResourceIDField returns Terraform identifier field for this CloudActiveDeployment
func (tr *CloudActiveDeployment) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CloudActiveDeployment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CloudActiveDeployment) LateInitialize(attrs []byte) (bool, error) {
	params := &CloudActiveDeploymentParameters{}
