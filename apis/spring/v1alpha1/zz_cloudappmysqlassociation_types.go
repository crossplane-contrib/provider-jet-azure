...
var (
	CloudAppMysqlAssociationKind             = "CloudAppMysqlAssociation"
	CloudAppMysqlAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: CloudAppMysqlAssociationKind}.String()
	CloudAppMysqlAssociationKindAPIVersion   = CloudAppMysqlAssociationKind + "." + GroupVersion.String()
	CloudAppMysqlAssociationGroupVersionKind = GroupVersion.WithKind(CloudAppMysqlAssociationKind)
)
