...
// GetTerraformResourceIDField returns Terraform identifier field for this CloudJavaDeployment
func (tr *CloudJavaDeployment) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CloudJavaDeployment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CloudJavaDeployment) LateInitialize(attrs []byte) (bool, error) {
	params := &CloudJavaDeploymentParameters{}
