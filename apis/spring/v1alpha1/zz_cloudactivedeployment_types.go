...
var (
	CloudActiveDeploymentKind             = "CloudActiveDeployment"
	CloudActiveDeploymentGroupKind        = schema.GroupKind{Group: Group, Kind: CloudActiveDeploymentKind}.String()
	CloudActiveDeploymentKindAPIVersion   = CloudActiveDeploymentKind + "." + GroupVersion.String()
	CloudActiveDeploymentGroupVersionKind = GroupVersion.WithKind(CloudActiveDeploymentKind)
)
