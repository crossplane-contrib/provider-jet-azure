...
var (
	CloudAppRedisAssociationKind             = "CloudAppRedisAssociation"
	CloudAppRedisAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: CloudAppRedisAssociationKind}.String()
	CloudAppRedisAssociationKindAPIVersion   = CloudAppRedisAssociationKind + "." + GroupVersion.String()
	CloudAppRedisAssociationGroupVersionKind = GroupVersion.WithKind(CloudAppRedisAssociationKind)
)
