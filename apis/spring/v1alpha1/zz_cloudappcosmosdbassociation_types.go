...
var (
	CloudAppCosmosdbAssociationKind             = "CloudAppCosmosdbAssociation"
	CloudAppCosmosdbAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: CloudAppCosmosdbAssociationKind}.String()
	CloudAppCosmosdbAssociationKindAPIVersion   = CloudAppCosmosdbAssociationKind + "." + GroupVersion.String()
	CloudAppCosmosdbAssociationGroupVersionKind = GroupVersion.WithKind(CloudAppCosmosdbAssociationKind)
)
