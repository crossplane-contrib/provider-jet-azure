...
var (
	CloudJavaDeploymentKind             = "CloudJavaDeployment"
	CloudJavaDeploymentGroupKind        = schema.GroupKind{Group: Group, Kind: CloudJavaDeploymentKind}.String()
	CloudJavaDeploymentKindAPIVersion   = CloudJavaDeploymentKind + "." + GroupVersion.String()
	CloudJavaDeploymentGroupVersionKind = GroupVersion.WithKind(CloudJavaDeploymentKind)
)
