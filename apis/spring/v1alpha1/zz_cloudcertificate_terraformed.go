...
// GetTerraformResourceIDField returns Terraform identifier field for this CloudCertificate
func (tr *CloudCertificate) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this CloudCertificate using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CloudCertificate) LateInitialize(attrs []byte) (bool, error) {
	params := &CloudCertificateParameters{}
