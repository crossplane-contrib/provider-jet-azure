...
var (
	CloudCustomDomainKind             = "CloudCustomDomain"
	CloudCustomDomainGroupKind        = schema.GroupKind{Group: Group, Kind: CloudCustomDomainKind}.String()
	CloudCustomDomainKindAPIVersion   = CloudCustomDomainKind + "." + GroupVersion.String()
	CloudCustomDomainGroupVersionKind = GroupVersion.WithKind(CloudCustomDomainKind)
)
