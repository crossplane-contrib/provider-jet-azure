...
type MediaStreamingEndpointParameters struct {
	...
	// +kubebuilder:validation:Optional
	CrossSiteAccessPolicy []MediaStreamingEndpointCrossSiteAccessPolicyParameters `json:"crossSiteAccessPolicy,omitempty" tf:"cross_site_access_policy,omitempty"`
