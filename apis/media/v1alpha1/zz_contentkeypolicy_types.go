...
var (
	ContentKeyPolicyKind             = "ContentKeyPolicy"
	ContentKeyPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ContentKeyPolicyKind}.String()
	ContentKeyPolicyKindAPIVersion   = ContentKeyPolicyKind + "." + GroupVersion.String()
	ContentKeyPolicyGroupVersionKind = GroupVersion.WithKind(ContentKeyPolicyKind)
)
