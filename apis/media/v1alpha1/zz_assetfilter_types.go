...
type AssetFilterParameters struct {
	...
	FirstQualityBitrate *int64 `json:"firstQualityBitrate,omitempty" tf:"first_quality_bitrate,omitempty"`
...
type PresentationTimeRangeParameters struct {
	...
	// +kubebuilder:validation:Optional
	EndInUnits *int64 `json:"endInUnits,omitempty" tf:"end_in_units,omitempty"`

	// +kubebuilder:validation:Optional
	ForceEnd *bool `json:"forceEnd,omitempty" tf:"force_end,omitempty"`

	// +kubebuilder:validation:Optional
	LiveBackoffInUnits *int64 `json:"liveBackoffInUnits,omitempty" tf:"live_backoff_in_units,omitempty"`

	// +kubebuilder:validation:Optional
	PresentationWindowInUnits *int64 `json:"presentationWindowInUnits,omitempty" tf:"presentation_window_in_units,omitempty"`

	// +kubebuilder:validation:Optional
	StartInUnits *int64 `json:"startInUnits,omitempty" tf:"start_in_units,omitempty"`

	// +kubebuilder:validation:Optional
	UnitTimescaleInMiliseconds *int64 `json:"unitTimescaleInMiliseconds,omitempty" tf:"unit_timescale_in_miliseconds,omitempty"`
}
...
var (
	AssetFilterKind             = "AssetFilter"
	AssetFilterGroupKind        = schema.GroupKind{Group: Group, Kind: AssetFilterKind}.String()
	AssetFilterKindAPIVersion   = AssetFilterKind + "." + GroupVersion.String()
	AssetFilterGroupVersionKind = GroupVersion.WithKind(AssetFilterKind)
)
