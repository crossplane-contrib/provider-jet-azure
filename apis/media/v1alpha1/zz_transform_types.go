...
var (
	...
	TransformGroupKind        = schema.GroupKind{Group: Group, Kind: TransformKind}.String()
	TransformKindAPIVersion   = TransformKind + "." + GroupVersion.String()
	TransformGroupVersionKind = GroupVersion.WithKind(TransformKind)
)
