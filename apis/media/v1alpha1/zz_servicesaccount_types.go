...
var (
	ServicesAccountKind             = "ServicesAccount"
	ServicesAccountGroupKind        = schema.GroupKind{Group: Group, Kind: ServicesAccountKind}.String()
	ServicesAccountKindAPIVersion   = ServicesAccountKind + "." + GroupVersion.String()
	ServicesAccountGroupVersionKind = GroupVersion.WithKind(ServicesAccountKind)
)
