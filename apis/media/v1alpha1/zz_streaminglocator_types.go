...
var (
	StreamingLocatorKind             = "StreamingLocator"
	StreamingLocatorGroupKind        = schema.GroupKind{Group: Group, Kind: StreamingLocatorKind}.String()
	StreamingLocatorKindAPIVersion   = StreamingLocatorKind + "." + GroupVersion.String()
	StreamingLocatorGroupVersionKind = GroupVersion.WithKind(StreamingLocatorKind)
)
