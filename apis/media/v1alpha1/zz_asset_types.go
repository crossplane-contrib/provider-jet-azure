...
var (
	AssetKind             = "Asset"
	AssetGroupKind        = schema.GroupKind{Group: Group, Kind: AssetKind}.String()
	AssetKindAPIVersion   = AssetKind + "." + GroupVersion.String()
	AssetGroupVersionKind = GroupVersion.WithKind(AssetKind)
)
