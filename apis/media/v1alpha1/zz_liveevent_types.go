...
var (
	LiveEventKind             = "LiveEvent"
	LiveEventGroupKind        = schema.GroupKind{Group: Group, Kind: LiveEventKind}.String()
	LiveEventKindAPIVersion   = LiveEventKind + "." + GroupVersion.String()
	LiveEventGroupVersionKind = GroupVersion.WithKind(LiveEventKind)
)
