...
func (tr *MediaLiveEvent) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this MediaLiveEvent
func (tr *MediaLiveEvent) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this MediaLiveEvent
func (tr *MediaLiveEvent) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this MediaLiveEvent
func (tr *MediaLiveEvent) SetParameters(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Spec.ForProvider)
}

// LateInitialize this MediaLiveEvent using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MediaLiveEvent) LateInitialize(tfState []byte) (bool, error) {
	stateObject := &MediaLiveEventParameters{}
