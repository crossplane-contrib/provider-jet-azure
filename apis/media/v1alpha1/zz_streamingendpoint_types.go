...
var (
	StreamingEndpointKind             = "StreamingEndpoint"
	StreamingEndpointGroupKind        = schema.GroupKind{Group: Group, Kind: StreamingEndpointKind}.String()
	StreamingEndpointKindAPIVersion   = StreamingEndpointKind + "." + GroupVersion.String()
	StreamingEndpointGroupVersionKind = GroupVersion.WithKind(StreamingEndpointKind)
)
