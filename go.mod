...
require (
	github.com/crossplane-contrib/terrajet v0.2.1-0.20211202125906-6819c3a2f9e0
...
replace github.com/crossplane-contrib/terrajet => github.com/ulucinar/terrajet v0.0.0-20211216224340-925f3e826427
